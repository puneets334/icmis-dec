...
<section class="content">
    <div class="container-fluid">
        <div class="card-header heading">
            <div class="row">
                <div class="col-sm-9">
                    <h3 class="card-title">Caveat->Earlier Court</h3>
                </div>
                <div class="col-sm-3">
                    ...
                    <a href="<?= base_url('Caveat/Search'); ?>"><button class="btn btn-primary btn-sm" type="button"><i class="fa fa-search-plus" aria-hidden="true"></i></button></a>
                </div>
            </div>
        </div>
        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header p-2" style="background-color: #fff;">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-9">
                                                <?php if (!empty($action_status) && $action_status == 'N') {
                                                    $success = 'text-danger';
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <?php $caveat_details = session()->get('caveat_details');
                                    ...
                                    <div class="card-body">
                                        ...
                                        $is_controller = $uri->getSegment(3);
                                        $attribute = array('name' => 'earlier_insert', 'id' => 'earlier_insert', 'autocomplete' => 'off');
                                        echo form_open(base_url('Caveat/Earlier_court/save'), $attribute);
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="form-group row ">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="radio" name="radio_selected_court" id="rd_sc" onClick="display_form(this.value)" <?php if ($ct_code == 4) { ?> checked="checked" <?php } else {
                                                                                                                                                                                                                if ($ct_code != 4) ?> disabled<?php } ?> class="cl_hc_dc" value="4" /> Supreme Court
                                                                <input type="radio" name="radio_selected_court" id="rd_hc" onClick="display_form(this.value)" <?php if ($ct_code == 1) { ?> checked="checked" <?php } else {
                                                                                                                                                                                                                if ($ct_code != 1) ?> disabled<?php } ?> class="cl_hc_dc" value="1" /> High Court
                                                                <input type="radio" name="radio_selected_court" id="rd_dc" onClick="display_form(this.value)" <?php if ($ct_code == 3) { ?> checked="checked" <?php } else {
                                                                                                                                                                                                                if ($ct_code != 3)  ?> disabled<?php } ?> class="cl_hc_dc" value="3" /> District Court
                                                                <input type="radio" name="radio_selected_court" id="rd_sa" onClick="display_form(this.value)" <?php if ($ct_code == 5) { ?> checked="checked" <?php } else {
                                                                                                                                                                                                                if ($ct_code != 5 && $ct_code != 2) ?> disabled<?php } ?> class="cl_hc_dc" value="5" /> State Agency
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="input-group date" id="impugned_date1_" data-target-input="nearest">
                                                        <input type="text" class="form-control datetimepicker-input_" data-target="#impugned_date1_" id="impugned_date_1" name="impugned_date_1" value="<?php if ($ct_code == '1') {
                                                                                                                                                                                                            echo $lct_dec_dt;
                                                                                                                                                                                                        } ?>" />
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <select name="state_agency_s" id="state_agency_s" class="form-control">
                                                                ...
                                                                if (!empty($states)) {
                                                                    foreach ($states as $state) :
                                                                        $selected_state_ag = ($ct_code == '5' && $l_state == $state['id_no']) ? "selected" : "";
                                                                ?>
                                                    ...
                                                    <table id="lowercourtdata" class="table table-bordered table-striped">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            foreach ($result as $lower_court_details) {
                                                                ...
                                                                $editURL = base_url('Caveat/Earlier_court/update/' . $lower_court_details['lower_court_id']);
