                                    ...
                                    foreach ($row['caveat_diary_matching'] as $row1){
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if($row1['caveat_no']==$caveat_number) {?>
                                                        <input type="hidden" class="btn btn-primary" name="hd_linked_no<?php echo $s_no; ?>" id="hd_linked_no<?php echo $s_no; ?>" value="<?php echo $row1['caveat_no']; ?>"/>
                                                        <input type="button" class="btn btn-primary" name="hd_unlink<?php echo $s_no; ?>" id="hd_unlink<?php echo $s_no; ?>" value="Unlink" class="cl_unlink"/>
                                                    <?php } ?>
                                                </td>
                                            </tr>
                                        </table>
