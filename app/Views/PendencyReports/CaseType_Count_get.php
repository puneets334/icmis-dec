<div id="printable">
<?php if(!empty($case_type_count)){ ?>
<span><h3 style="text-align: center;"> SECTION <b><?php echo $section;?> REGISTERED</b> CASE TYPE PENDENCY</b></h3></span>
 ...
 <table class="table table-striped custom-table" id="example1">
    <thead>
       <tr>
		...
		<tbody>
				<?php $i=0; $pendency=0;
				foreach ($case_type_count as $result){ $i++;?>
					<tr>
                        <td><?php echo $i;?></td>
...
<?php if(!empty($unReg_count)){ ?>
<span><h3 style="text-align: center; margin-top: 40px;"> SECTION <b><?php echo $section;?> UN-REGISTERED</b> CASES PENDENCY</b></h3></span>
<div class="table-responsive">
 <table class="table table-striped custom-table" id="example2">
    <thead>
       <tr>
		...
		<tbody>
				<?php  $i=0; $pendency=0;
				   foreach ($unReg_count as $result){  $i++;?>
						<tr>
							<td><?php echo $i;?></td>
							<td><?php echo $result['short_description'];?></td>
							<td><a style="color: #0d48be;" href="<?=base_url();?>/PendencyReports/Physical_verify/CaseType_YearWise_Count?casetype=<?php echo $result['active_casetype_id'];?>&sect=<?php echo $section;?>" target="_blank"><?php echo $result['total_pendency'];?></td>
 ...
 <?php if(!empty($misc_reg_count)){ ?>
<span><h3 style="text-align: center; margin-top: 40px;">SECTION <b><?php echo $section;?> MISC AND REGULAR</b> CASES PENDENCY</b></h3></span>
<div class="table-responsive">
 <table class="table table-striped custom-table" id="example3">
    <thead>
       <tr>
			 <tr>
				<th>S.No.</th>
