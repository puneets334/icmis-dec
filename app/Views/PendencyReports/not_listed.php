            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header heading">
                        <div class="row">
                            <div class="col-sm-10">
                                <h3 class="card-title">Report Type: List of Matters not listed after registration II</h3>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
...
<script type="text/javascript">
    ...
    $("#btnGetDiaryList").click(function() {
		...
		$("#dv_res1").html('');
        $.ajax({
            url: '<?php echo base_url('/PendencyReports/Physical_verify/not_listed_get') ?>',
            type: "POST",
            cache: false,
            async: true,
			beforeSend: function() {
