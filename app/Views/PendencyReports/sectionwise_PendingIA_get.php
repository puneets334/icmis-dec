...
<span><h3 style="text-align: center;">SECTION <b><?php echo $section;?></b> PENDING IA'S REPORT</h3></span>
    ...
    <tbody>
			...
			foreach ($result_array as $result){
				...
				<tr>
					...
					<td><?php echo $result['alloted_to_da'].'@SEC '.$result['user_section'];?></td>
					<td><?php echo $result['pet_name'].' vs. '.$result['res_name'];?></td>
					<td><?php echo $result['ia_name'] ?></td>
				</tr>
				<?php
			}
			?>
       ...
       var t= $('#example1').DataTable( {
           "bProcessing"   :   true,
            ...
            buttons: [
                {
                    extend: 'excel',
                    title: "SECTION <?php echo $section;?> PENDING IA'S REPORT",
                    exportOptions: {
                        columns: [0,1,2,3,4],
                        stripHtml: true
                    }
