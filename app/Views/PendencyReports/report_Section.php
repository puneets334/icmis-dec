...
<section class="content">
	...
	<div class="card-body">
		<center><h3 class="page-header">Section wise Statistics of matters Pending for Physical Verification</h2></center>
		<?php if(!empty($report_Section)){ ?>
				<div class="table-responsive">
					<table class="table table-striped custom-table" id="example1">
						...
						<tbody>
							<?php
								$i = 1;
								foreach($report_Section as $value): ?>
										<tr>
											<td><?=$i?></td>
											<td><?=($value['section_name'])==''?'No Section':$value['section_name']?></td>
