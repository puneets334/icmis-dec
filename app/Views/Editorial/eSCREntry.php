                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="date" id="judgmentDate" name="judgmentDate" class="form-control" value="<?php if (isset($_POST['judgmentDate'])) {
                                                                                                                                                echo $_POST['judgmentDate'];
                                                                                                                                            } ?>" placeholder="Judgment Date" required="required">
...
<script>
    document.getElementById('view').addEventListener('click', function() {
        ...
        var judgmentDate = document.getElementById('judgmentDate').value.trim();
        var optradio = $('input[name="optradio"]:checked').val();
        var caseType = document.getElementById('caseType').value.trim();
        var caseNo = document.getElementById('caseNo').value.trim();
        var caseYear = document.getElementById('caseYear').value.trim();

        if (optradio == 1) {
            //document.getElementById('mySelect').required = true;
            $('#caseType').attr('required', 'required');
            $('#caseNo').attr('required', 'required');
            $('#caseYear').attr('required', 'required');

            $('#diaryNumber').removeAttr('required');
            $('#diaryYear').removeAttr('required');

            if(judgmentDate !== '' && judgmentDate !== null && caseType !== '' && caseType !== null && caseNo !== '' && caseNo !== null && caseYear !== '0' && caseYear !== null){
        ...
        if(optradio == 2){
            var diaryNumber = document.getElementById('diaryNumber').value.trim();
            var diaryYear = document.getElementById('diaryYear').value.trim();
                $('#diaryNumber').attr('required', 'required');
                $('#diaryYear').attr('required', 'required');

                $('#caseType').removeAttr('required');
                $('#caseNo').removeAttr('required');
                $('#caseYear').removeAttr('required');
            if(judgmentDate !== '' && judgmentDate !== null && diaryYear !== '' && diaryYear !== null && diaryNumber !== '' && diaryNumber !== null){
