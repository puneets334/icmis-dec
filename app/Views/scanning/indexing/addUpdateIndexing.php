            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header heading">
                        <div class="row">
                            <div class="col-sm-10">
                                <h3 class="card-title">Scannig >> indexing >> Add/Update</h3>
                            </div>
                            <div class="col-sm-2">
                            </div>
                        </div>
                                                        ...
                                                        <form id="indexingSaveFrm" method="POST" action="">
                                                            ...
                                                            <table class="table table-bordered">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="text" id="other_desc" style="width: 290px;text-transform:uppercase;" disabled class="form-control">
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <?php
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        &nbsp;&nbsp;
                                                                        <span id="sp_up_nu" style="color:red"></span>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                                    ...
                                                                                    <tr class="with_border" id="r1w<?php echo $sno ?>">
                                                                                        ...
                                                                                        <td>
                                                                                            ...
                                                                                            <input type="hidden" name="hdpdf_name_<?php echo $sno; ?>" id="hdpdf_name_<?php echo $sno; ?>"
                                                                                                value="<?php if ($indoc->pdf_name != '') {
                                                                                                            echo "../index_pdf/" . $diary_year . '/' . $diary_number . '/' . str_replace('+', ' ', urlencode($indoc->pdf_name));
                                                                                                        } ?>" />
                                                                                        </td>
...
<script>
    ...
    $(document).on('click', '.cl_rdn_dco_type', function() {
        ...
        var CSRF_TOKEN_VALUE = $('[name="CSRF_TOKEN"]').val();
        $.ajax({
            url: "<?php echo base_url('scanning/SaccaningController/addUpdateScanningDoc'); ?>",
            cache: false,
            async: true,
            data: {
                diary_number: diary_number,
    ...
    function get_state(str, ct_code, l_state, l_dist, lower_court_id) {
        ...
        $.ajax({
            url: "<?php echo base_url('scanning/SaccaningController/getStateName'); ?>",
            type: 'POST',
            cache: false,
            async: true,
            data: {
    ...
    function getSubDoc(val, upd, sp_idd) {
        if (val == 8 || val == 9 || val == 16 || val == 5 || val == 3 || val == 98) {
            $.ajax({
                ...
                url: "<?php echo base_url('scanning/SaccaningController/getSubDocuments'); ?>",
    ...
    function saveIT(handle) {
        ...
        // alert(document.getElementById('m_doc').value);
        ...
        if (!isValid && $('#upd_file').val() != '') {
            ...
            // alert (data);
            $.ajax({
                url: "<?php echo base_url('scanning/SaccaningController/saveIndexingData'); ?>",
                cache: false,
                async: true,
                processData: false,
                contentType: false,
    ...
    function get_benches(str, ct_code, l_state, l_dist, lower_court_id) {
        ...
        if (ddl_st_agncy != '' && ddl_court != '') {
            $.ajax({
                url: "<?php echo base_url('scanning/IndexBenchController/fetchAgencies'); ?>",
    ...
    function get_tot_cases(str, ct_code, l_state, l_dist, lower_court_id) {
        ...
        $.ajax({
            url: "<?php echo base_url('scanning/IndexBenchController/getTotalCases'); ?>",
