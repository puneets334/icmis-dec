                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select-box" name="ddl_court" id="ddl_court">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select-box" name="ddl_st_agncy" id="ddl_st_agncy">
                                            <option value="">Select</option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select-box" name="ddl_bench" id="ddl_bench">
                                            <option value="">Select</option>
                                        </select>
                                    </div>
                                </div>
