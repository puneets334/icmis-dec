...
<div class="row table-responsive">
    ...
    ?>
        <table align="center" style="margin-top: 10px;width:98% !important" class="table table-bordered table-sm">
            <thead>
                <tr>
                    <th>SNo.</th>
                    <th>Diary No.</th>
                        ...
                        ?>
                            <td rowspan="<?php echo $row['s'] ?>">
                                <input type="button" name="btn_generate<?php echo $sno; ?>" id="btn_generate<?php echo $sno; ?>"
                                    value="Generate" class="cl_generate  btn btn-sm" />
                            </td>
                        <?php
                    ...
                    if ($cnt_diary != $row['diary_no'] || $file_name != $row['notice_path']) {
                        ...
                        <td rowspan="<?php echo $row['s'] ?>">
                            <input type="button" name="btn_back<?php echo $sno; ?>" id="btn_back<?php echo $sno; ?>"
                                value="Discard Notice" class="cl_back btn btn-sm" />
                        </td>
                    <?php
                    }
                    if ($cnt_diary != $row['diary_no'] || $file_name != $row['notice_path']) {
