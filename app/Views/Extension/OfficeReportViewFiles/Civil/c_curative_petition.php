...
<div contenteditable="true" style="width: auto;margin-left: 40px;margin-right: 40px;margin-bottom: 25px;margin-top: 10px;padding-left: 10px;padding-right: 10px;word-wrap: break-word;border: 1px solid black" width="100%" id="ggg" onkeypress="return  nb(event)" onmouseup="checkStat()">
    ...
    <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face="Times New Roman">
            ...
            if(isset($civilData['get_petitioner_advocate'])){
                if(!empty($civilData['get_petitioner_advocate']) ){
                    $get_petitioner_advocate = $civilData['get_petitioner_advocate'];
                    foreach ($get_petitioner_advocate as $row) {
                        $pet_adv_title = $row['title'];
                        $pet_adv_name = $row['name'];
                        $petitioner_advocate_name .= $pet_adv_title . ' ' . $pet_adv_name;
                    }
                }
            }
            // echo $petitioner_advocate_name; die;
            ?>
            It is submitted that <b style="font-size: 13pt"  face="Times New Roman"><?= $petitioner_advocate_name != '' ? $petitioner_advocate_name : '' ?></b>,
            Advocate for the petitioner has on <b style="font-size: 13pt"  face="Times New Roman"><?= $petitioner_advocate_name != '' ? $petitioner_advocate_name : '' ?></b>
            filed the Curative Petition against the order dated <b style="font-size: 13pt"  face="Times New Roman"><?= isset($civilData['caseinof'][0]['judgement_dt_lw']) ? $civilData['caseinof'][0]['judgement_dt_lw'] : ''  ?></b> passed in
            <b style="font-size: 13pt"  face="Times New Roman"><?= isset($civilData['caseinof'][0]['lw_cur_lw']) ? $civilData['caseinof'][0]['lw_cur_lw'] : '' ?> </b>
            <b style="font-size: 13pt"  face="Times New Roman"><?= isset($civilData['caseinof'][0]['lw_cur_no']) ? $civilData['caseinof'][0]['lw_cur_no'] : '' ?> </b>  of
            <b style="font-size: 13pt"  face="Times New Roman"><?= isset($civilData['caseinof'][0]['lw_cur_yr']) ? $civilData['caseinof'][0]['lw_cur_yr'] : '' ?> </b> in <b style="font-size: 13pt"  face="Times New Roman"><?= isset($civilData['caseinof'][0]['lw_cur_lw_s']) ? $civilData['caseinof'][0]['lw_cur_lw_s'] : '' ?> </b>
            <b style="font-size: 13pt"  face="Times New Roman"><?= isset($civilData['caseinof'][0]['lw_cur_no_s']) ?$civilData['caseinof'][0]['lw_cur_no_s'] : '' ?> </b>  of
            <b style="font-size: 13pt"  face="Times New Roman"><?= isset($civilData['caseinof'][0]['lw_cur_yr_s']) ? $civilData['caseinof'][0]['lw_cur_yr_s'] : '' ?> </b>
            which was dismissed on <b style="font-size: 13pt"  face="Times New Roman"><?= isset($civilData['caseinof'][0]['judgement_dt_lw_s']) ? $civilData['caseinof'][0]['judgement_dt_lw_s'] : '' ?></b>
            <?php
            $get_application_registration= $civilData['get_application_registration'];
            $doc_name='';
            ...
            ?>
            <?php if($doc_name!='') { ?>
                with application for  <b style="font-size: 13pt"  face="Times New Roman"><?= $doc_name; ?></b> to take additional pleas.
            <?php  } ?>
    ...
    <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
        <font  style="font-size: 13pt"  face="Times New Roman">As per law laid down by this Hon'ble Court in the judgment of the case titled Rupa Ashok Hurra versus Ashok Hurra & Anr., 2002(4)SCC 388, the petitioner has obtained the requisite certificate from Mr. S.C. Maheshwari, Senior Advocate.
        </font>
    </p>
    <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
        <font  style="font-size: 13pt"  face="Times New Roman">
            The Curative Petition  <?php if($doc_name!='') { ?> with application <?php } ?> above mentioned is circulated before the Hon'ble Judges in Chambers with this office report.
        </font>
    </p>

    <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
        <font style="font-size: 13pt"  face="Times New Roman" >
            Dated :<b style="font-size: 13pt"  face="Times New Roman"><?php echo date('F d, Y'); ?></b>
        </font>
    </p>
    ...
    <p style="padding: 4px 0px 0px 2px;margin: 0px;" align="justify">
        <font style="font-size: 13pt"  face="Times New Roman" >Copy to :- </font>
    </p>
