...
//                }
            ...
            <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
                <font style="font-size: 13pt" face="Times New Roman">
                    ...
                    consequent upon the dismissal of the <b style="font-size: 13pt" face="Times New Roman"><?php echo $lw_cur_lw; ?></b> on <b style="font-size: 13pt" face="Times New Roman"><?php echo $judgement_dt_lw; ?></b>.
