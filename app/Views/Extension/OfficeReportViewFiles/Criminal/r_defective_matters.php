...
//                echo $judgement_dt.">>>";die;
        ...
        <p style="color: #000000;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both;text-align: center" align="justify">
            <font>
                <u><b style="font-size: 14.5px">OFFICE REPORT ON DEFAULT</b></u>
            </font>
        </p>
        <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
            <font style="font-size: 13pt" face="Times New Roman">

                The Hon'ble Judge in Chambers, on <b style="font-size: 14.5px"><?php if(!empty($listed_dt)) echo $listed_dt; ?></b>, was pleased to pass the following order, upon perusal
                of the office report on default dated <b style="font-size: 14.5px"><?php if(!empty($defect_ent_dt_fmt)) echo $defect_ent_dt_fmt; ?></b>,
                the appellant/petitioner having failed to remove the defects and refile the matter in terms of Order III Rule 8(vii) proviso of the Supreme Court Rules, 2013:
        ...
        <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
            <font style="font-size: 13pt" face="Times New Roman">
                DATED this the <b style="font-size: 13pt"><?php echo date('dS F, Y'); ?></b>
            </font>
        </p>
