...
//                  print_r(count($lower_court));die;
        ...
        <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
            <font style="font-size: 13pt" face="Times New Roman">
                ...
                seeking review of this Honble Court's Order dated <b style="font-size: 13pt" face="Times New Roman"><?php echo $judgement_dt; ?></b>
        ...
        <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
            <font  style="font-size: 13pt" face="Times New Roman">
                The paper books of the appeal/special leave petition, having been destroyed after due preservation
                in accordance with the procedure, the advocate for the appellant/petitioner/respondent has,
                therefore, furnished fresh paper books for kind consideration of the Hon'ble Court.
            </font>
        </p>
        ...
        <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
            <font  style="font-size: 13pt" face="Times New Roman">
                The review petition along with paper books is circulated for kind consideration.
            </font>
        </p>
        <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
            <font  style="font-size: 13pt" face="Times New Roman">
