...
//                echo $judgement_dt.">>>";die;
        ...
        <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
            <font style="font-size: 13pt" face="Times New Roman">
                ...
                advocate for the appellant/petitioner/respondent/party
                in-person has filed the above-mentioned contempt petition for non-compliance/willful
                disobedience of the judgement/order passed by this Hon'ble Court on <b style="font-size: 13pt" face="Times New Roman"><?php echo $judgement_dt; ?></b>, a copy whereof
                is placed at Page Nos. ___ of the contempt petition.
        ...
        <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
            <font  style="font-size: 13pt" face="Times New Roman">
                The Contempt Petition is listed before the Hon'ble Court with this office report.
            </font>
        </p>
