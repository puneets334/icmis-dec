...
<div contenteditable="true" style="width: auto;margin-left: 40px;margin-right: 40px;margin-bottom: 25px;margin-top: 10px;padding-left: 10px;padding-right: 10px;word-wrap: break-word;border: 1px solid black" id="ggg" onkeypress="return  nb(event)" onmouseup="checkStat()">
    ...
    <div style="padding-left: 2px;padding-right: 2px;margin-left: 48px" width="100%">
        ...
        <p align="center" style="margin: 0px;padding: 10px 0px 0px 0px;">
            ...
            <u><b><font style="font-size: 13pt" face="Times New Roman" >PETITION FOR <?php if(!empty($pet_line_casename))echo $pet_line_casename;else echo ''; ?> <?php if(!empty($pet_line_case_range))echo " No. ".$pet_line_case_range;else echo '';  ?> <?php if(!empty($pet_line_year))echo "OF ".$pet_line_year;else echo '';  ?></font></b></u>
...
//                  print_r(count($lower_court));die;
        ...
        <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
            <font  style="font-size: 13pt" face="Times New Roman">
               The Instant Special Leave Petition has been received from the Petitioner above named, who is confined in ,
                against the Judgment and Order dated <b><?php echo $judgement_dt; ?></b> of the   <b><?php echo $agency_name; ?>
                in  <?php echo $skey.'-'.$lct_caseno.' of '.$lct_caseyear; ?> </b>through Jail Superintendent, &nbsp; . Mr. &nbsp; ,
                Advocate, has been appointed as Amicus Curiae to assist the Hon'ble Court on behalf of the Petitioner in the instant matter
                as the petitioner is undefended and confined in Jail.  </span>

                <b style="font-size: 13pt" face="Times New Roman">
                    <?php echo !empty($ia_name)? $ia_name: ''; ?></b>.
            </font>
        </p>
        ...
        <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
            <font  style="font-size: 13pt" face="Times New Roman">
                ...
                It is submitted that the instant petition is barred by time by <b><?php echo !empty($dd)? $dd: ''; ?></b> days and Petitioner
                has sent an application for condonation of delay in this matter. the application for condonation of delay in filing Special Leave Petition
                is registered as . <b style="font-size: 13pt" face="Times New Roman"><?php echo !empty($get_respondent_advocate)?$get_respondent_advocate:''; ?></b>, advocate.
            </font>
        </p>
        ...
        <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
            <font  style="font-size: 13pt" face="Times New Roman">
                The application for condonation of delay in filing Special Leave Petition in the matter above mentioned, is therefore ,
