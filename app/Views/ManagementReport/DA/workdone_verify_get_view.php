...
<div id="dv_fixedFor_P" style="display: none;position: fixed;top: 0;left: 0;width: 100%;height: 100%;z-index: 105">
    <div id="sar1" style="background-color: white;overflow: auto;margin: 60px 50px 30px 50px;height: 90%;">
        <div id="sp_close" style="text-align: right;cursor: pointer;float: right">
        <img src="<?php echo base_url('images/close_btn.png') ?>" style="width: 20px;height: 20px;">
        </div>
