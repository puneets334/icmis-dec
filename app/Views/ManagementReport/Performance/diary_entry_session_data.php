...
<section class="content">
    <div class="container-fluid">
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                ...
                                <input type="text" id="fromDate" class="dtp form-control" name="fromDate"
                            ...
                            <div class="col-md-1 mt-4 pt-2">
                                <a
                                    href="<?php echo base_url('ManagementReports/Performance/diary_entry_session_data'); ?>">Clear
                                    Search</a>
                            </div>
                        </div>
                        <?php echo  form_close(); ?>
            ...
            <td>' . $regNo . '</td>
            <td>' . $causeTitle . '</td>
            <td>' . date('d-m-Y H:i:s', strtotime($record['entry_time'])) . '</td>
            <td>' . date('d-m-Y H:i:s', strtotime($record['diary_no_rec_date'])) . '</td>
            <td>' . (strtotime($record['diary_no_rec_date']) - strtotime($record['entry_time'])) . '</td>
        </tr>';
                                    $i++;
                                }
                                echo ' </tbody></table>';
