...
<div id="prnnt" style="font-size:11px;">
        <?php if (empty($uploadedOrdersJudgmentsList)): ?>
        ...
        <?php else: ?>
		   <div style="page-break-after:always;">
					<h3 style="text-align: center; line-height: 1.5;">
					     <?= $string1; ?> BETWEEN &nbsp;<?= date('d-m-Y', strtotime($param[1])); ?> and <?= date('d-m-Y', strtotime($param[2])); ?>
					</h3>
											...
											<tr>
												...
												<td>
													<a href="#" type="button" class="" data-toggle="modal" data-target="#myModal" id="<?= $result['diary_no']; ?>">
														<strong style="color: #004acb;"><?= $result['case_no']; ?></strong>
													</a>
													<br>
															<?= $result['cause_title']; ?>
												...
												<td> <a href="<?= $result['disp_path']; ?>" target="_blank" style="color: #004acb;">View</a> </td>
												<td><?= $noOfPages; ?></td>
			 ...
			 buttons: [
			    {
                    ...
                    filename: "'<?= $string1; ?> BETWEEN <?= date('d-m-Y', strtotime($param[1])); ?> and <?= date('d-m-Y', strtotime($param[2])); ?>",
                    title: "<?= $string1; ?> BETWEEN <?= date('d-m-Y', strtotime($param[1])); ?> and <?= date('d-m-Y', strtotime($param[2])); ?>",
