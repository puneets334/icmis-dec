                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header p-2" style="background-color: #fff; border-bottom:none;">
                                    <h4 class="basic_heading">Main Subject Categorywise Pendency AS ON <?php echo date("d-m-Y"); ?></h4>
                                </div>
                                <div class="card-body">
                                    <table id="reportTable" class="table table-striped custom-table">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td><?= $sno; ?></td>
                                                    <td><?= $result['subcode1']; ?></td>
                                                    <td><?= $result['sub_name1']; ?></td>
                                                    <td><?= $result['misc_sub_cat_pendency']; ?></td>
                                                    <td><?= $result['regular_sub_cat_pendency']; ?></td>
                                                    <td><?= $result['not_misc_not_regular']; ?></td>
                                                    <td><?= $result['total_sub_cat_pendency']; ?></td>
                                                </tr>
                                            <?php
                                                $sno++;
                                            }
...
<script>
    $(document).ready(function() {
        ...
        var reportTitle = "Main Subject Categorywise Pendency AS ON " + day + "-" + month + "-" + year;
