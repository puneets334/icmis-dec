...
?>
    ...
    <h3 style="text-align:center;">BACK DATE MATTERS</h3>
    <table id="tab" class="table table-striped custom-table">
        <thead>
                <tr>
                    <td rowspan="2" width="5%" style="text-align: center; font-weight: bold;">SNo</td>
                    <td rowspan="2" width="15%" style="text-align: center; font-weight: bold;">Date</td>
                    <td colspan="3" width="20%" style="text-align: center; font-weight: bold;">Court</td>
                    <td colspan="3" width="20%" style="text-align: center; font-weight: bold;">Chamber</td>
                    <td colspan="3" width="20%" style="text-align: center; font-weight: bold;">Registrar</td>
                    <td colspan="3" width="20%" style="text-align: center; font-weight: bold;">Total</td>
                </tr>
                <tr>
                    <td style="text-align: center; font-weight: bold;">R</td>
                    <td style="text-align: center; font-weight: bold;">NR</td>
        ...
        <tbody>
            ...
            foreach ($back_date as $row) {
                ...
                <tr style="background: #918788;"><td colspan="2" align="right"> TOTAL </td>
                    <td align="center" style='vertical-align: top;'>
                            <a href='<?php echo "not_ready_get_detail?list_dt=0&flag=b&ltype=court_r&ct=$connt'";?> target='_blank'>
                            <?php  echo $bk_tot_court_r; ?>
                            </a>
                        </td>
                        <td align="center" style='vertical-align: top;'>
                            <a href='<?php echo "not_ready_get_detail?list_dt=0&flag=b&ltype=court_nr&ct=$connt'";?> target='_blank'>
                            <?php  echo $bk_tot_court_nr; ?>
                            </a>
                        </td>
                        <td align="center" style='vertical-align: top;'>
                            <a href='<?php echo "not_ready_get_detailp?list_dt=0&flag=b&ltype=court&ct=$connt'";?> target='_blank'>
                            <?php  echo $bk_tot_court_tot; ?>
                            </a>
                        </td>
                        <td align="center" style='vertical-align: top;'>
                            <a href='<?php echo "not_ready_get_detail?list_dt=0&flag=b&ltype=chamber_r&ct=$connt'";?> target='_blank'>
                            <?php  echo $bk_tot_chamber_r; ?>
                            </a>

                        </td>
                        <td align="center" style='vertical-align: top;'>
                            <a href='<?php echo "not_ready_get_detail?list_dt=0&flag=b&ltype=chamber_nr&ct=$connt'";?> target='_blank'>
                            <?php  echo $bk_tot_chamber_nr; ?>
                            </a>

                        </td>
                        <td align="center" style='vertical-align: top;'>
                            <a href='<?php echo "not_ready_get_detail?list_dt=0&flag=b&ltype=chamber&ct=$connt'";?> target='_blank'>
                            <?php  echo $bk_tot_chamber_tot; ?>
                            </a>

                        </td>
                        <td align="center" style='vertical-align: top;'>
                            <a href='<?php echo "not_ready_get_detail?list_dt=0&flag=b&ltype=reg_r&ct=$connt'";?> target='_blank'>
                            <?php  echo $bk_tot_registrar_r; ?>
                            </a>

                        </td>
                        <td align="center" style='vertical-align: top;'>
                            <a href='<?php echo "not_ready_get_detail?list_dt=0&flag=b&ltype=reg_nr&ct=$connt'";?> target='_blank'>
                            <?php  echo $bk_tot_registrar_nr; ?>
                            </a>

                        </td>
                        <td align="center" style='vertical-align: top;'>
                            <a href='<?php echo "not_ready_get_detail?list_dt=0&flag=b&ltype=reg&ct=$connt'";?> target='_blank'>
                            <?php  echo $bk_tot_registrar_tot; ?>
                            </a>

                        </td>
                        <td align="center" style='vertical-align: top;'>
                            <a href='<?php echo "not_ready_get_detail?list_dt=0&flag=b&ltype=ready&ct=$connt'";?> target='_blank'>
                            <?php  echo  $bk_tot_ready_r; ?>
                            </a>

                        </td>
                        <td align="center" style='vertical-align: top;'>
                            <a href='<?php echo "not_ready_get_detail?list_dt=0&flag=b&ltype=not_ready&ct=$connt'";?> target='_blank'>
                            <?php  echo $bk_tot_ready_nr; ?>
                            </a>

                        </td>
                        <td align="center" style='vertical-align: top;'>
                            <a href='<?php echo "not_ready_get_detail?list_dt=0&flag=b&ltype=Total&ct=$connt'";?> target='_blank'>
        ...
        <tbody>
            ...
            foreach ($future_date as $row) {
               ...
               // else{
                    ...
                    <tr style="background: #918788;"><td colspan="2" align="right"> TOTAL </td>
                    <td align="center" style='vertical-align: top;'>
                            <a href='<?php echo "not_ready_get_detail?list_dt=0&flag=f&ltype=court_r&ct=$connt'";?> target='_blank'>
                        ...
                        <td align="center" style='vertical-align: top;'>
                            <a href='<?php echo "not_ready_get_detail?list_dt=0&flag=f&ltype=court&ct=$connt'";?> target='_blank'>
                            <?php  echo $fr_tot_court_tot; ?>
                            </a>
                        </td>
                        <td align="center" style='vertical-align: top;'>
                            <a href='<?php echo "not_ready_get_detail?list_dt=0&flag=f&ltype=chamber_r&ct=$connt'";?> target='_blank'>
                            <?php  echo $fr_tot_chamber_r; ?>
                            </a>

                        </td>
                        <td align="center" style='vertical-align: top;'>
                            <a href='<?php echo "not_ready_get_detail?list_dt=0&flag=f&ltype=chamber_nr&ct=$connt'";?> target='_blank'>
                            <?php  echo $fr_tot_chamber_nr; ?>
                            </a>

                        </td>
                        <td align="center" style='vertical-align: top;'>
                            <a href='<?php echo "not_ready_get_detail?list_dt=0&flag=f&ltype=chamber&ct=$connt'";?> target='_blank'>
                            <?php  echo $fr_tot_chamber_tot; ?>
                            </a>

                        </td>
                        <td align="center" style='vertical-align: top;'>
                            <a href='<?php echo "not_ready_get_detail?list_dt=0&flag=f&ltype=reg_r&ct=$connt'";?> target='_blank'>
                            <?php  echo $fr_tot_registrar_r; ?>
                            </a>

                        </td>
                        <td align="center" style='vertical-align: top;'>
                            <a href='<?php echo "not_ready_get_detail?list_dt=0&flag=f&ltype=reg_nr&ct=$connt'";?> target='_blank'>
                            <?php  echo $fr_tot_registrar_nr; ?>
                            </a>

                        </td>
                        <td align="center" style='vertical-align: top;'>
                            <a href='<?php echo "not_ready_get_detail?list_dt=0&flag=f&ltype=reg&ct=$connt'";?> target='_blank'>
                            <?php  echo $fr_tot_registrar_tot; ?>
                            </a>

                        </td>
                        <td align="center" style='vertical-align: top;'>
                            <a href='<?php echo "not_ready_get_detail?list_dt=0&flag=f&ltype=ready&ct=$connt'";?> target='_blank'>
                            <?php  echo  $fr_tot_ready_r; ?>
                            </a>

                        </td>
                        <td align="center" style='vertical-align: top;'>
                            <a href='<?php echo "not_ready_get_detail?list_dt=0&flag=f&ltype=not_ready&ct=$connt'";?> target='_blank'>
                            <?php  echo $fr_tot_ready_nr; ?>
                            </a>

                        </td>
                        <td align="center" style='vertical-align: top;'>
                            <a href='<?php echo "not_ready_get_detail?list_dt=0&flag=f&ltype=Total&ct=$connt'";?> target='_blank'>
