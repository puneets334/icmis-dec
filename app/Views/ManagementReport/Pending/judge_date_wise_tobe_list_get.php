        ...
        <div style="page-break-before:always;">
             ...
             //} //END OF WHILE LOOP
                    ...
                    <tr style="font-weight: bold; background: #918788;">
                        ...
                        <td align="center" style='font-weight: bold; vertical-align: top;'><?php  echo $t_fd_not_listed; 
                                                                                            ?></td>
                        <td align="center" style='font-weight: bold; vertical-align: top;'><?php echo $t_aw_not_listed; 
                                                                                            ?></td>
                        <td align="center" style='font-weight: bold; vertical-align: top;'><?php  echo $t_imp_ia_not_listed; 
                                                                                            ?></td>
                        <td align="center" style='font-weight: bold; vertical-align: top;'><?php  echo $t_oth_not_listed; 
                                                                                            ?></td>
                        <td align="center" style='font-weight: bold; vertical-align: top;'><?php echo $t_not_listed; 
                                                                                            ?></td>
                    </tr>
                    </tbody>
                </table>
