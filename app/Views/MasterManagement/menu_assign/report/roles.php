                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12"> <!-- Right Part -->
                                <div class="form-div">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 text-center">
                                            <h2>Role Report <span class="text-danger font-weight-bold">&#8628;</span></h2>
                                        </div>
                                    </div>
                                     
                                        <form action="<?=base_url()?>/MasterManagement/Menu_assign/Reportroles" method="POST"> 
                                        <input type="hidden" name="<?= csrf_token(); ?>" value="<?= csrf_hash(); ?>">
                                ...
                                <?php if (isset($role_array)): ?>
                                <h2>Roles Details Url</h2>
                                <div id="example_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                    ...
                                    $dbo = db_connect();                                  
                                    $count = 0;
                                    foreach ($role_array as $key => $rows) {
                                       $count++;
                                        $parentIds = array(); 
                                        echo '<tr>
