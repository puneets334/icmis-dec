            ...
            <div class="col-12">
                                ...
                                <?= csrf_field() ?>
                                    <div class="box-body">
                                        ...
                                        <div class="form-group mt-3">
                                            <label for="reportType" class="col-sm-2 col-md-8 col-lg-12 " style="text-align:center;"><h2>Insert Judges Information </h2></label>
                                        </div>
                                        <div id="row1" class="row required mt-5">
                                            <div class="control-label col-md-4  requiredField">
                                                <label class="col-sm-6">JTYPE:</label>
                                                <select class="form-control" id="jtype" name="jtype" required="required" onChange="">
                ...
                <!--                            </div>-->
                                        ...
                                        <div id="row2" class="row required mt-5">
                                            ...
                                            <div class="control-label col-md-4  requiredField">
                                            <div id="gen" >
                                                <label class="col-sm-6">Sh./Smt.</label>
                                        ...
                                        <div id="row3" class="row required mt-5">
                                            ...
                                            <select class="form-control" id="jcourt" name="jcourt"><option value="0">---select---</option>
                                                <?php
                                            for ($x = 1; $x <= 15; $x++) {
                                    ...
                                    <!--  <input type="text" id="to_date" value="--><?php //if(isset($_POST['to_date']))?><!--" name="to_date" class="form-control datepick"  placeholder="to Date" required="required" readonly>-->
                                    <!--  </div>-->
