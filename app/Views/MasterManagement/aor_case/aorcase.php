                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <form method="POST" action="<?=base_url();?>/MasterManagement/AORCase/aor_detail">
                                    <?= csrf_field() ?>
                                <div class="form-row">
                            ...
                            {
                                ?>
                                <div id="printable" class="box box-danger table-responsive">
                                        ...
                                        <table id="reportTable1" class="table table-striped table-hover">
                                            ...
                                            foreach ($reports as $result)
                                            {
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <?php if(isset($result['reg_date']) && $result['reg_date'] !='0') { ?><?php echo date('d-m-Y',strtotime($result['reg_date']));?> <?php } ?></td>
                                                    ...
                                                    <td><?php echo date('d-m-Y',strtotime($result['adv_date']));?></td>
                                                </tr>
                                                <?php
                                                $s_no++;
                                            }   //for each
