 ...
 $lct_caseno=$lower_court[$index1][4];
  ...
  $first_listed_date=date('dS F, Y', strtotime($get_first_listed_date));
   $diary_rec_dt=$new_date = date('dS F, Y', strtotime(get_diary_rec_date($dairy_no)));
        ?>
With reference to your letter/Petition <b style="font-size: 13pt"  face= "Times New Roman">dated &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b> , sent by post forwarded in this Registry by Section Officer, Ministry of Law and Justice, Government of India vide letter <b style="font-size: 13pt"  face= "Times New Roman">dated &nbsp;&nbsp;&nbsp;</b>, I am to inform you that no action can be taken on the same as the same has been received by post in contravention of the provision of Order VIII, Rule 5 and 6(1) of the Supreme Court Rules, 2013.
</font>

      <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
         <font  style="font-size: 13pt"  face= "Times New Roman">
Please also note that no further correspondence in this regard will be entertained in future.
             </font>
    </p>
