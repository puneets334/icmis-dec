...
<!--   </p>-->
  ...
  <b style="font-size: 13pt"  face= "Times New Roman"><?php echo $row[p_sno]; ?></b></font></b>
   ...
   ?>
    ...
    has expired/ deregistered/ designated as senior advocate. You are, therefore, required to 
    make fresh arrangements for you representation before this Court in the matter either through 
    another advocate on record or by filing fresh memo of appearance as prescribed in rules, if so 
    advised, within 30 days of the receipt of this notice, failing which it will be presumed that 
    you do not wish to either engage another advocate on record or appear in person and the matter 
    will be proceeded with and determined in your absence and no further notice will be given to you 
    in this behalf.
</font>
     </p>
