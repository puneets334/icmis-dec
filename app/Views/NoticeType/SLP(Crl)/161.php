...
<!--    <p align="center" style='margin: 0px;padding: 2px 0px 0px 0px;'>
    ...
    <p align="center" style='margin: 0px;padding: 2px 0px 0px 0px;'>
           ...
           <font><b style="font-size: 13pt">CRIMINAL APPELLATE JURISDICTION</b></font>
 ...
 $get_order_date= get_order_date($dairy_no);
           ?>
         <div style="font-size: 13pt;margin-bottom: 10px;text-align: justify">(Appeal from the Judgment and Order dated <b style="font-size: 13pt"  face= "Times New Roman"><?php echo $judgement_dt; ?></b>
   ...
   ?>
     ...
     $remark_dt=date('dS F, Y', strtotime($get_date_by_remark));
        ?>
        In pursuance of rule 8, Order XX, Supreme Court Rules, 2013 (as amended) and directions contained in Supreme Court Rules,2013 and Handbook on Practice and Procedure, 2017, all Criminal Appeals are to be listed for hearing on the Special Leave Petition/Petition of Appeal paper books and the paper books of the Court below(in English), if available and the additional documents to be filed by the parties, if the paper books of the Court below are not available.
  </font>
     </p>
    <p style="color: #000000;text-indent: 40px;" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman">
            TAKE NOTICE THAT the records in electronic form have been received from the High Court as well as from the Trial Court. You are, therefore, required to inspect the records and in case High Court Paper Books containing all the documents are available, sufficient number of paper books may be made available for the use of the Hon'ble Court. In case complete set of High Court paper books is not available you are required to file the Additional documents, including the F.I.R., Charges, evidence / depositions etc., within six weeks from the date of receipt of this notice, duly bound and supported by an affidavit.
        </font>
    </p>
   <?php
...
<div style="margin-left: 30px"><?php
  ...
  ?>
   ...
   ?>
    ...
    <p align="center" style="padding: 16px 2px 0px 0px;margin: 0px"><font style="font-size: 13pt"  face= "Times New Roman" >
                He may file such further documents as are not included in the record by the appellant within two weeks from the service of the appellant record on him.
            </font></p>
</div>
 </font></p><br><br>
 <p align="right" style="padding: 16px 2px 0px 0px;margin: 0px"><b><font style="font-size: 13pt"  face= "Times New Roman" >ASSISTANT REGISTRAR</font></b></p>
