<div  style="padding-left: 2px;padding-right: 2px;margin-left: 48px" width="100%">
  ...
  <p style="color: #000000;margin: 10px;padding: 0px 2px 0px 42px;width: 50%;text-transform: uppercase;" >
    ...
    <?php } ?>
     <p style="color: #000000;margin: 0px;padding: 0px 2px 0px 42px;width: 50%;float: lefttext-transform: uppercase;">
        <b> <font  style="font-size: 13pt"  face= "Times New Roman" >
   ...
   <div align="center" style="width: 100%;clear: both">
     ...
     <p style="margin: 0px;padding: 0px 0px 0px 2px;clear: both"><b><font style="font-size: 13pt"  face= "Times New Roman"  >Sir,</font></b></p>  
      ...
      <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman" >
        I am directed to forward herewith Bailable Warrants dated ... (in duplicate) issued in pursuance of this Hon'ble Court's Record of
        Proceedings/order dated <b style="font-size: 13pt"  face= "Times New Roman" ><?php echo $listed_dt ?></b> in the matter above-mentioned to be executed against the alleged contemnor/respondent at the following address:-
        <br></font></p>
...
<font  style="font-size: 13pt"  face= "Times New Roman" >
    ...
    $parties='';
    $party_no='';
    for ($index1 = 0; $index1 < count($get_respondents); $index1++) {
        if($parties=='')
        {
            $parties=$get_respondents[$index1][2];
            $party_no=$get_respondents[$index1][0];
        }
        else
        {
            $parties=$parties.', '.$get_respondents[$index1][2];
            $party_no=$party_no.', '.$get_respondents[$index1][0];
        }
    } ?>
    <b style="font-size: 13pt"  face= "Times New Roman" ><?php echo  $parties; ?></b><b style="font-size: 13pt"  face= "Times New Roman" ></b>
<b style="font-size: 13pt"  face= "Times New Roman" >
      ...
      <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
         <font  style="font-size: 13pt"  face= "Times New Roman" >
You are, therefore, required to execute the bailable Warrants against the above Bailable Warrants against the above alleged contemnor/respondent
             and to produce him before this Hon'ble Court on the <b style="font-size: 13pt"  face= "Times New Roman" ><?php echo $tentative_dt; ?> at 10:30 O'Clock in the forenoon. </b> .
         </font>
      </p>
<?php
$get_respondents=get_respondents($dairy_no);
...
for ($index1 = 0; $index1 < count($get_respondents); $index1++) {
    ...
    else 
    {
        $parties=$parties.', '.$get_respondents[$index1][2];
         ...
         <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman" >
       You are also requested to send the compliance report at the earliest.
        </font></p>
