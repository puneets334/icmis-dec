 ...
 $get_order_date= get_order_date($dairy_no);
   ...
   ?>
     ...
     $remark_dt=date('dS F, Y', strtotime($get_date_by_remark));
        ?>
        In pursuance of rule 8, Order XX, Supreme Court Rules, 2013 (as amended) and practice directions contained in the circular No.<b>1/SCR/SC Rules/2014</b> dated <b>21st July, 2012</b>, all Criminal Appeals are to be listed for hearing on the Special Leave Petition/Petition of Appeal paper books and the paper books of the Court below(in English), if available and the additional documents to be filed by the parties, if the paper books of the Court below are not available.
  </font>
     </p>
    <p style="color: #000000;text-indent: 40px;" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman">
            TAKE NOTICE THAT the Original record has been received from the High Court as well as from the Trial Court. You are, therefore, required to inspect the records and in case High Court Paper Books containing all the documents are available sufficient number of paper books may be mmade available for the use of the Court. In case complete set of High Court paper books is not available you are required to file the Additional documents, including the F.I.R., Charges, evidence / depositions etc., within six weeks from the date of receipt of this notice, duly bound and supported by an affidavit.
        </font>
    </p>
   <?php
