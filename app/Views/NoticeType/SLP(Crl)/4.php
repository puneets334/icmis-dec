 ...
 ?>
   ...
   ?>
     ...
     $get_last_listed_date=  get_notice_dt($dairy_no);
       ...
       ?>
       Whereas the Petition for <?php echo $res_fil_det['casename'] ?> 
       above-mentioned (copy enclosed) filed in the Registry by 
       <b style="font-size: 13pt"  face= "Times New Roman" ><?php
       $name='';
     
           echo $get_pet_adv[0].' '.$get_pet_adv[1];
      
           ?></b>, advocate on-record, on behalf of the Petitioner(s) above named, 
