<div  style="padding-left: 2px;padding-right: 2px;margin-left: 48px" width="100%">
    ...
    <div style="width: 40%;border-collapse: collapse;border: 1px solid black;float: left;font-size: 13pt;"  face= "Times New Romanpadding: 5px" border="1" >
       <?php echo get_text_msg();?>
     </div>
    <div style="width: 40%;float: right;font-size: 13pt;"  face= "Times New Romantext-align: center">
...
//       }
   ...
   <div align="center" style="width: 100%;clear: both">
     ...
     <p style="margin: 0px;padding: 0px 0px 0px 2px;clear: both"><b><font style="font-size: 13pt"  face= "Times New Roman"  >Sir,</font></b></p>  
      ...
      <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman" >
        The Competent Authority has, in the matter above mentioned received through Jail Authorities, 
        has appointed you as amicus curiae at the State expense to prepare and argue the case on behalf of 
        the petitioner. You may collect the documents immediately and draft the Special Leave Petition, 
        prepare the Paper-Books and provide four sets (1+3) of Paper-Books to the undersigned within fifteen 
        days.  The Registry will list the matter after two weeks before the Hon'ble Court.
        </font>
     </p>
  ...
  <p align="left" style="padding: 16px 2px 0px 0px;margin: 0px"><b><font style="font-size: 13pt"  face= "Times New Roman"  >Encl:</font></b></p>
   <p align="left" style="padding: 16px 2px 0px 0px;margin: 0px"><b><font style="font-size: 13pt"  face= "Times New Roman"  >(1)Photo copy of Jail Petition</font></b></p>
   <p align="left" style="padding: 16px 2px 0px 0px;margin: 0px"><b><font style="font-size: 13pt"  face= "Times New Roman"  >(2)Five sets of impugned Judgment of the High Court</font></b></p>
   <p align="left" style="padding: 16px 2px 0px 0px;margin: 0px"><b><font style="font-size: 13pt"  face= "Times New Roman"  >(3)Five sets of Trial Court Judgment</font></b></p>  
    
   <p style="padding: 4px 0px 0px 2px;margin-top: 10px;" align="justify"><font style="font-size: 13pt"  face= "Times New Roman"  >
    Copy to :-
   </font></p>
   
    <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman" >
      You are requested to make necessary arrangements for the payment of fee of 
          <b><font style="font-size: 13pt"  face= "Times New Roman"  ><?php 
          $ex_tw_sn_to= explode('<br/>',$tw_sn_to);
          echo $ex_tw_sn_to[0];
          ?></b>, 
      advocate, [A.C.], Supreme Court of India, New Delhi, in terms of Rules 7(2) & 7(4) of Order XXII, 
