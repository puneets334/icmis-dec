 ...
 $lct_caseno=$lower_court[$index1][4];
  ...
  $first_listed_date=date('dS F, Y', strtotime($get_first_listed_date));
   $diary_rec_dt=$new_date = date('dS F, Y', strtotime(get_diary_rec_date($dairy_no)));
        ?>
With reference to the document <b style="font-size: 13pt"  face= "Times New Roman"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  </b> filed by you on <b style="font-size: 13pt"  face= "Times New Roman"><?php //echo $diary_rec_dt;?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </b>, I am to inform you that the same is defective for the following reason(s):
</font>
     </p>
             <p align="center" style='margin: 0px;padding: 10px 0px 0px 0px;' >
<u style="font-size: 13pt"  face= "Times New Roman">&nbsp;</u>
...
<u style="font-size: 13pt"  face= "Times New Roman">&nbsp;</u>
      ...
      <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
         <font  style="font-size: 13pt"  face= "Times New Roman">
You are, therefore, required to cure the defects within 28 days of receipt of this letter failing which the applications will be placed before Ld. Registrar for orders under Order VIII Rule 6(3) & (4) of Supreme Court Rules, 2013.
             </font>
    </p>
