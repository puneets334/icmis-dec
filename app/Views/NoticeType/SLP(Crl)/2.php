...
<!--   </p>-->
   ...
   $cnt_con_case=0;
    for ($index3 = 0; $index3 < count($connected_cases); $index3++) {
        ...
        ?>
      WHEREAS the Petition for Special Leave to Appeal <?php if($doc_names!='') { ?> with application for   <b style="font-size: 13pt"  face= "Times New Roman" ><?php echo $doc_names; ?></b><?php } ?>
   ...
   <?php
     ...
     ?>
      ...
      <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
         ...
         ?>
NOW, THEREFORE, TAKE NOTICE that the above matter(s) <?php   if($conn_cases!='') { ?> along with <?php } ?> <b style="font-size: 13pt"  face= "Times New Roman" ><?php echo $con_nm; ?></b> 
 ...
 convenient to the Court when you may appear before the court either in person or through Counsel and 
 show cause to the Court as to why Special Leave and interim relief as prayed for be not granted and the 
 resultant appeal be not allowed. 
      ...
      <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
         <font  style="font-size: 13pt"  face= "Times New Roman" >
     Take Further Notice that this Court has passed an interim order pending disposal 
     ...
     the Court on the aforesaid date. 
       ...
       <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
         <font  style="font-size: 13pt"  face= "Times New Roman" >
    You may file your affidavit in opposition to the petition as provided under Rule 6 of 
    Order XXII, S.C.R.2013 within 30 days from the date of receipt of notice or not later than 2 
    weeks before the date appointed for hearing, whichever be earlier, but shall do so only by setting 
    out the grounds in opposition to the questions of law or grounds set out in the SLPs and may produce 
    such pleadings and documents filed before the Court/Tribunal against whose order the SLP is filed and 
...
<div style="margin-left: 30px"><?php
  ...
  ?>
   ...
   ?>
    ...
    <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman" >
            *A copy of dasti notice is enclosed herewith for effecting service on sole respondent/state of <?php echo $state_name; ?> and filed proof of service with affidavit.;
        </font>
    </p>

    <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
         <font  style="font-size: 13pt"  face= "Times New Roman" >
   *You are requested to file Vakalatnama/appearance on behalf of STATE OF <?php echo $state_name; ?>
             </font>
    </p>
  <p align="right" style="padding: 16px 2px 0px 0px;margin: 0px"><b><font style="font-size: 13pt"  face= "Times New Roman"  >ASSISTANT REGISTRAR</font></b></p>  
