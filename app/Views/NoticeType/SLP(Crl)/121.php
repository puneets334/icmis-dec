<div  style="padding-left: 2px;padding-right: 2px;margin-left: 48px" width="100%">
    ...
    <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman" >
            I am directed to forward herewith for your information and necessary action a certified copy of this Court's Record of Proceeding dated <?php echo $listed_dt;?>
            passed in the matter above mentioned.
        </font>
    </p>

    <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman" >
            You are, therefore, requested to send the Original record <B> WITH ENGLISH VERSION OF ALL DEPOSITIONS IF THE SAME ARE IN VERNACULAR </B> well before next day of hearing viz.<?php echo $tentative_dt; ?>, so as to enable the Registry to place the same before the Hon'ble Court.
        </font>
    </p>
    <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman" >
