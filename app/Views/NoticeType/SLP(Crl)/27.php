...
<!--    <p align="center" style='margin: 0px;padding: 2px 0px 0px 0px;'>
 ...
 $lct_caseno=$lower_court[$index1][4];
  $lct_caseyear=$lower_court[$index1][5];
           ?>
         <div style="font-size: 13pt;"  face= "Times New Roman" margin-bottom: 10px">(Appeal from the Judgment and Order dated the <b style="font-size: 13pt"  face= "Times New Roman" ><?php echo $judgement_dt; ?></b> 
   ...
   ?>
     <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 40px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman" >
       TAKE NOTICE that the Original Records have been received from the High Court and Court(s) below. 
       Since the paper books of the Court(s) below are not available, you are required to inspect the 
       records and file additional documents, including FIR, Charges, evidence/depositions, etc. within 
       six weeks from the day of receipt of this notice, duly bound and supported by an affidavit.
</font>
     </p>
...
<div style="margin-left: 30px"><?php
 ...
 <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 40px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman" >
      He may file such further documents as are not included in the record by the Appellant within 
      two weeks from the date of service of the additional documents filed on behalf of the appellant 
      on him/her.
</font>
     </p>
 <p align="right" style="padding: 16px 2px 0px 0px;margin: 50px"><b><font style="font-size: 13pt"  face= "Times New Roman"  >ASSISTANT REGISTRAR</font></b></p>
</div>
