...
<div  style="padding-left: 2px;padding-right: 2px;margin-left: 48px" width="100%">
 ...
 $get_order_date= get_order_date($dairy_no);
           ?>
         <div style="font-size: 13pt;margin-bottom: 10px;text-align: center ">
       ( <b style="font-size: 13pt"  face= "Times New Roman"><?php echo $agency_name;  ?></b>, <?php echo $lower_court[$index1][1] ?> in
       <?php
...
?>
      <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt" face= "Times New Roman">
        I am directed to acknowledge the receipt of the Original Record of the High Court and Trial Court in the above mentioned matter sent with your letter No.<b>...</b> dated <b>...</b>.

</font></p>

    <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt" face= "Times New Roman">
        I am, however, to point out that on checking the Original Record, it has been found that most of the pages of the Trial Court original record is in vernacular language and in torn condition.
...
<p align="right" style="padding: 16px 2px 0px 0px;margin: 0px" face= "Times New Roman"><b><font style="font-size: 13pt" face= "Times New Roman" ></font></b></p>
    <p style="padding: 4px 0px 0px 2px;margin: 0px;" align="justify"><font style="font-size: 13pt"  face= "Times New Roman " >
            Copy to :-
        </font></p>
    <?php
    ...
    <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt" face= "Times New Roman">
            They/You are requested to indicate well in advance as to which documents they may like to refer from the Original Records at the time of hearing of the Appeal so as to avoid inconvenience to the Court.
        </font></p>
