<div  style="padding-left: 2px;padding-right: 2px;margin-left: 48px" width="100%">
    ...
    <div align="center" style="width: 100%;clear: both">
        ...
        <b><font  style="font-size: 13pt"  face= "Times New Roman">(Under Rule 7(3) of Order XXII of the Supreme Court Rules 2013)</font></b>
    </div>
    <?php
   ...
   ?>
    ...
    <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman">
            ...
            Certified that, &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; (Amicus Curiae) was engaged at the cost of the State in the above matter which was dismissed on <?php $rs=dispose_detail($dairy_no); echo $dispose_dt=date('d-m-Y', strtotime($rs));?>   and that Rs. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; are payable to him/her as his/her fee by the  <?php echo $res_fil_det['res_name'] ?>.
