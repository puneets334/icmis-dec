<div  style="padding-left: 2px;padding-right: 2px;margin-left: 48px" width="100%">
    ...
    <div style="font-size: 13pt;"  face= "Times New Roman" padding: 5px;text-align: right;margin-right: 60px">
        <u><b>THROUGH SPECIAL MESSENGER</b></u>
     </div>
...
<b><i><u>Delivery Mode:
  ...
  for ($index = 0; $index < count($get_ma_info); $index++) {
    ...
    <u><b><font style="font-size: 13pt"  face= "Times New Roman"  id="append_data"><?php echo $get_misc_re[0] ?> No. <?php echo $get_misc_re[1]; ?> OF <?php echo  $get_misc_re[2]; ?></font></b></u>
      ...
      <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman" >
         <?php
          ...
          ?>
The Registrar, in exercise of powers under Order VIII Rules 6(3) and 6(4) of the Supreme Court Rules, 2013, 
has on <b style="font-size: 13pt"  face= "Times New Roman" ><?php echo $last_listed_dts ?></b>, declined to register the interlocutory application in the above-mentioned matter filed 
by you on <b style="font-size: 13pt"  face= "Times New Roman" ><?php echo $ia_date_fmt ?></b>.</font>
     </p>
