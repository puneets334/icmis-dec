<div  style="padding-left: 2px;padding-right: 2px;margin-left: 48px" width="100%">
    ...
    <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman">
           The matter above mentioned was listed before Hon'ble Court/ Hon'ble Chamber Judge/ Court of Registrar on &nbsp;&nbsp;&nbsp;&nbsp;.

        </font>
    </p>
    <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman">
            You are therefore required to file following documents in compliance of order date &nbsp;&nbsp;&nbsp;&nbsp;.<br>
        </font>
    </p>
    <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman"><br>
            1. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; sets of spare copy/copies to issue Show Cause Notice.<br>
            2. Fresh particulars of respondent No. &nbsp;&nbsp;&nbsp;&nbsp;.<br>
            3. Particulars of Trial Court of issuance of Notice in respect of Respondent No. &nbsp;&nbsp;&nbsp;&nbsp;.<br>
            4.
