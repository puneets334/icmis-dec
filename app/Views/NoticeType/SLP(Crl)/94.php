<div  style="padding-left: 2px;padding-right: 2px;margin-left: 48px" width="100%">
    ...
    <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman">
            ...
            ?>
           I am request you to file &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;spare copy of mentioned Special Leave Petition cum Petition of Appeal the record of the High Court and for Notice of Lodgment Petition of Appeal in the above-mentioned matter within week from the date of receipt of this letter failing which the default will be reported to the Hon'ble Court.
