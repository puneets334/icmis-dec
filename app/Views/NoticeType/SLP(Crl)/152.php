...
<b><i><u>Delivery Mode:
 ...
 <p style="margin: 0px;padding: 0px 0px 0px 2px;clear: both;margin-bottom: 30px"><b><font style="font-size: 13pt"  face= "Times New Roman"  >Ref: No. D. No. <b style="font-size: 13pt"  face= "Times New Roman" ><?php echo substr($dairy_no,0,-4).'/'.substr($dairy_no,-4); ?></b>
/SEC-<b style="font-size: 13pt"  face= "Times New Roman" ><?php echo get_section($dairy_no); ?></b></font> dated </b></p>
     ...
     <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman" >
    The Original Records of the High Court and Trial Court, which have, so far, not been dispatched, may be transmitted to this Registry at the earliest as the matter will be listed before court of Ld. Registrar on <b style="font-size: 13pt"  face= "Times New Roman" ><?php echo $tentative_dt;?></b>.
     </font>
     </p>
<p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
    <font  style="font-size: 13pt"  face= "Times New Roman" ><b>
        The scanned/digitized/photocopy of the original record of the High Court and the Trial Court be sent, instead of the original. The original shall not be weeded out during the pendency of the matter before this Court, till the communication regarding disposal of the matter is received from the registry of this Court.</b>.
    </font>
</p>
