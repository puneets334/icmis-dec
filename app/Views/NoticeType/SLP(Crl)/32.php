 ...
 <!--<p style="margin: 0px;padding: 0px 0px 0px 2px;clear: both;margin-bottom: 20px"><b><font style="font-size: 13pt"  face= "Times New Roman"  >Ref: No.......</font></b></p>-->  
     <p style="margin: 0px;padding: 0px 0px 0px 2px;clear: both"><b><font style="font-size: 13pt"  face= "Times New Roman"  >Sir,</font></b></p>  
      ...
      <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman" >
        I am to inform you that, in the matter above-mentioned, this Hon'ble Court, 
        on <b style="font-size: 13pt"  face= "Times New Roman" ><?php echo $listed_dt; ?></b>, has been pleased to pass the following order:-
  ...
  ?>"
     ...
     <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman" >
    You are, therefore, required to appear before the Co-ordinator, 
    Mediation Centre of <b style="font-size: 13pt"  face= "Times New Roman" ><?php echo $name; ?></b>, at <b style="font-size: 13pt"  face= "Times New Roman" ><?php echo $agency_name; ?></b> on <b style="font-size: 13pt"  face= "Times New Roman" ><?php echo $tentative_dt; ?></b> at 11:00 am.
     </font>
     </p>
      ...
      <div style="color: #000000;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        ...
        <table>
            <tr>
                ...
                <td style="font-size: 13pt"  face= "Times New Roman" >
                   Copy with a certified copy of Record of Proceedings/Order dated <b style="font-size: 13pt"  face= "Times New Roman" ><?php echo $listed_dt; ?></b>, 
 is forwarded herewith for necessary action, if any. The requisite report be furnished, as directed by 
