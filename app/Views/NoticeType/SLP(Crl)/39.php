ss<div  style="padding-left: 2px;padding-right: 2px;margin-left: 48px" width="100%">
   ...
   <div align="center" style="width: 100%;clear: both">
     ...
     <p style="margin: 0px;padding: 0px 0px 0px 2px;clear: both"><b><font style="font-size: 13pt"  face= "Times New Roman"  >Sir,</font></b></p>  
      ...
      <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman" >
        With reference to this Registry's letter dated <b style="font-size: 13pt"  face= "Times New Roman" ><?php echo $listed_dt; ?></b>, having been appointed as amicus curiae in 
        the above mentioned Jail Petition, you are required to collect the documents immediately failing 
        which the matter will be processed for appointment of another amicus curiae disengaging you from 
        the present case. A proposal to delete your name from the panel of amicus curiae may also be placed 
