...
<b><i><u>Delivery Mode:
 ...
 <p style="margin: 0px;padding: 0px 0px 0px 2px;clear: both;margin-bottom: 20px"><b><font style="font-size:13pt" >Ref: No.......</font></b></p>  
     <p style="margin: 0px;padding: 0px 0px 0px 2px;clear: both"><b><font style="font-size:13pt" >Sir,</font></b></p>  
      ...
      $res_no='';
      for ($index2 = 0; $index2 < count($get_respondents); $index2++) {
          if($res_no=='')
              $res_no=$get_respondents[$index2][0];
          else 
               $res_no=$res_no.', '.$get_respondents[$index2][0];
      }
        ?>
   Please find enclosed herewith Notice of Lodgment of Petition of Appeal for effecting service at the 
   fresh address on the sole respondent/Respondent No. <b style="font-size:13pt"><?php echo $res_no; ?></b>  and the service report be sent at the earliest 
   to enable the Registry to place it before the Hon'ble Court.
       </font>
     </p>
    
     <p style="margin-top: 90px;padding: 0px 0px 0px 2px;clear: both"><b><font style="font-size:13pt" >Sir,</font></b></p>  
   
     <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size:13pt">
   I am directed to inform you that the petition above-mentioned filed in Supreme Court has been 
   dismissed for default/dismissed as withdrawn/dismissed for non-prosecution by the Court on <b style="font-size:13pt"><?php echo $listed_dt; ?></b>.
       </font>
     </p>
   <p align="right" style="padding: 16px 2px 0px 0px;margin: 0px"><b><font style="font-size:13pt" >Yours faithfully,</font></b></p>
    ...
    <p style="padding: 4px 0px 0px 2px;margin: 0px;" align="justify"><font style="font-size:13pt" >
    Copy to :-
   </font></p>
 <?php
   if($row['individual_multiple']==1)
