...
// $get_order_date= get_order_date($dairy_no);
           ?>
         <!--<div style="font-size: 13pt;margin-bottom: 10px;text-align: center">(Ref.:-->
       <?php
...
<u><b><font style="font-size: 13pt" face= "Times New Roman">
   ...
   <div align="center" style="width: 100%;clear: both">
     ...
     <p style="margin: 0px;padding: 0px 0px 0px 2px;clear: both"><b><font style="font-size: 13pt"  face= "Times New Roman" >Sir,</font></b></p>  
      ...
      I am directed to forward herewith a certified copy of the Order of this Court dated
         <b style="font-size: 13pt"  face= "Times New Roman"> 
             <?php echo $listed_dt; ?></b> alongwith Memo of parties passed in the matter above mentioned for your information and necessary action.
 ...
 Please acknowledge receipt.
   ...
   <p align="right" style="padding: 16px 2px 0px 0px;margin: 0px"><font style="font-size: 13pt"  face= "Times New Roman" >Yours faithfully,</font></p>
