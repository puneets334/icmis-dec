...
?>
      <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt" face= "Times New Roman">
        I am to inform you that the above named Petitioner is confined in <b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b>, has sent through Jail Superintendent, the above mentioned Special Leave Petition against the Judgement and Order dated

     <b style="font-size: 13pt" face= "Times New Roman"><?php echo $judgement_dt; ?></b> of the <b style="font-size: 13pt" face= "Times New Roman" ><?php echo $agency_name;  ?></b>, <?php echo $lower_court[$index1][1] ?> in
       <?php
       ...
       for ($index2 = 0; $index2 < count($ex_lct_caseno); $index2++) {
           if($index2>0){ echo ',';}
       ?>
       <b style="font-size: 13pt" face= "Times New Roman"> <?php echo $ex_skey[$index2] ?> </b> No. <b style="font-size: 13pt"><?php echo $ex_lct_caseno[$index2]; ?></b> of <b style="font-size: 13pt" face= "Times New Roman"><?php echo $ex_lct_caseyear[$index2]; ?> .</b> <?php  }?>

</font></p>
<p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
    <font  style="font-size: 13pt"  face= "Times New Roman">
        <B style="font-size: 13pt" face= "Times New Roman"><U style="font-size: 13pt" face= "Times New Roman">You are therefore requested to let this Registry know within 03 Days on receipt of this letter,if the above named petitioner(s) has moved the legal services committee and any case has been filed by the Committee on behalf of the above named petitioner(s). Please intimate to this Registry within 03 Days failing which it wil be presumed that the accused has not approached before the Supreme Court Legal Services Committee.</U></B>
    </font>
</p>
...
<p style="text-indent: 40px;padding: 4px 0px 0px 2px;margin: 0px;" align="justify"><font style="font-size: 13pt" face= "Times New Roman" >
    Note: Please quote Diary. No. for Corrospondence.</p><br><br>