...
//     $listed_dt=date('dS F, Y', strtotime($get_last_listed_date));
   ...
   <div align="center" style="width: 100%;clear: both">
     ...
     <p style="margin: 0px;padding: 0px 0px 0px 2px;clear: both"><b><font style="font-size: 13pt"  face= "Times New Roman"  >Sir,</font></b></p>  
      ...
      has, on <b style="font-size: 13pt"  face= "Times New Roman" ><?php echo $last_listed_dts ?></b>, refused to receive the interlocutory application/miscellaneous application 
      in the above-mentioned matter filed by you on <b style="font-size: 13pt"  face= "Times New Roman" ><?php echo $ia_date_fmt ?></b>.  
