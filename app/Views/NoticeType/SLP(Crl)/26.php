   ...
   <div align="center" style="width: 100%;clear: both">
     ...
     <p style="margin: 0px;padding: 0px 0px 0px 2px;clear: both"><b><font style="font-size: 13pt"  face= "Times New Roman"  >Sir,</font></b></p>  
      ...
      <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman" >
        Please find enclosed herewith a certified copy of this Hon'ble Court's Record of 
        Proceedings/order dated <b style="font-size: 13pt"  face= "Times New Roman" ><?php echo $listed_dt ?></b> passed in the matter above-mentioned along 
        with Schedule containing full cause title of the parties.
        </font></p>
        
      <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
         <font  style="font-size: 13pt"  face= "Times New Roman" >
You are requested to send the report of execution of bailable/non-bailable warrants in 
respect of 
<?php
...
<b style="font-size: 13pt"  face= "Times New Roman" ><?php echo  $parties; ?></b>, Respondent Nos. <b style="font-size: 13pt"  face= "Times New Roman" ><?php echo  $party_no; ?></b>  respectively 
immediately/before <b style="font-size: 13pt"  face= "Times New Roman" ><?php echo $tentative_dt; ?></b>.
             </font>
    </p>
         <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman" >
