<div  style="padding-left: 2px;padding-right: 2px;margin-left: 48px" width="100%">
    ...
    <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman">
            ...
            ?>
             <b style="font-size: 13pt"  face= "Times New Roman">&nbsp;&nbsp;&nbsp;&nbsp;</b>
            WHEREAS in the aforementioned petition/appeal it has bbeen ordered that the notice(s) be served upon the respondent no. ......, through the Trial Court concerned and the petitioner has been permitted to take out the notice(s) in Dasti(i.e. by hand).
