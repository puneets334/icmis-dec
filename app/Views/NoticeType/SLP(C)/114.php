<div  style="padding-left: 2px;padding-right: 2px;margin-left: 48px" width="100%">
    ...
    <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman">
        You are requested to file forthwith an Affidavit regarding the valuation of the subject matter in dispute in the appeal above-mentioned, as contemplated under the Supreme Court Rules, 2013. You may file ad <i>valorem </i>  Court Fee in the matter above-mentioned within one week of receipt of this letter failing which action as contemplated under Rules will be initiated.
