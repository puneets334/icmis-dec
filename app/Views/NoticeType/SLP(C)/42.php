<div  style="padding-left: 2px;padding-right: 2px;margin-left: 48px" width="100%">
   ...
   <p align="center" style='margin: 0px;padding: 10px 0px 0px 0px;clear: both' >
    <b><font style="font-size: 13pt"  face= "Times New Roman">
            <u>INTERLOCUTORY APPLICATION NOS. ________</u><br>
(Appln. for permission to appear and argue as Petitioner-in-person)
</font></b>
    </p>
...
<u style="font-size: 13pt"  face= "Times New Roman">IN</u>
  ...
  $first_listed_date=date('dS F, Y', strtotime($get_first_listed_date));
        ?>
With reference to application for Permission to appear and argue as Petitioner-in-person, you are hereby requested  to appear before Ld. Registrar(J-III) on <b style="font-size: 13pt"  face= "Times New Roman"><?php echo $listed_dt; ?></b> at 11.00 A.M. sharp for interaction. Yor are also required to bring Original I.D. Proof for verification.        
</font>
     </p>
