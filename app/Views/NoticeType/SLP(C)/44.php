...
<u style="font-size: 13pt"  face= "Times New Roman">IN</u>
  ...
  $first_listed_date=date('dS F, Y', strtotime($get_first_listed_date));
   $diary_rec_dt=$new_date = date('dS F, Y', strtotime(get_diary_rec_date($dairy_no)));
        ?>
With reference to the <b style="font-size: 13pt"  face= "Times New Roman">D.No. <?php echo substr($dairy_no,0,-4).'/'.  substr($dairy_no,-4); ?></b> filed by you on, <b style="font-size: 13pt"  face= "Times New Roman"><?php echo $diary_rec_dt;?></b>. I am to inform you that the same is defective for the following reason(s):        
</font>
     </p>
             <p align="center" style='margin: 0px;padding: 10px 0px 0px 0px;' >
<u style="font-size: 13pt"  face= "Times New Roman">&nbsp;</u>
...
<u style="font-size: 13pt"  face= "Times New Roman">&nbsp;</u>
      ...
      <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
         <font  style="font-size: 13pt"  face= "Times New Roman">
You are, therefore, requested to cure the above said defects in the <b style="font-size: 13pt"  face= "Times New Roman">D.No. <?php echo substr($dairy_no,0,-4).'/'.  substr($dairy_no,-4); ?></b> so that the matter may be processed further.
             </font>
    </p>
