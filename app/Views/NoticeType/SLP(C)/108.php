 ...
 $lct_caseno=$lower_court[$index1][4];
  ...
  $first_listed_date=date('dS F, Y', strtotime($get_first_listed_date));
   $diary_rec_dt=$new_date = date('dS F, Y', strtotime(get_diary_rec_date($dairy_no)));
        ?>
I am directed to forward herewith due notice along with Paper Books(in duplicate) of  in <font style="font-size: 13pt"  face= "Times New Roman" id="append_data"><?php echo $res_fil_det['casename'] ?> for effecting service on the non-applicant of   Respondent no. <b style="font-size: 13pt"  face= "Times New Roman">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b>  in <font style="font-size: 13pt"  face= "Times New Roman" id="append_data"><?php echo $res_fil_det['casename'] ?> <?php if(strpos($case_range, '-')==true) echo 'No(s)'; else echo 'No.';?> <?php echo $case_range; ?> OF <?php echo $reg_year; ?></font> in accordance with Government's Circular <b style="font-size: 13pt"  face= "Times New Roman">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b> dated <b style="font-size: 13pt"  face= "Times New Roman"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b>. Therefore, notice in duplicate is sent to you for effecting service upon the Respondent no. <b style="font-size: 13pt"  face= "Times New Roman">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b>.

</font>

      <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
         <font  style="font-size: 13pt"  face= "Times New Roman">
You are requested to send the Service Report after effecting service on the non-applicants, indicating the date of service at the earliest.
             </font>
    </p>
 ...
 <br><br>
    <p align="justify" style="padding: 16px 2px 0px 0px;margin: 0px"><b><font style="font-size: 13pt"  face= "Times New Roman" ><u>Encl.  Notice along with Paper Books ( in duplicate) . </u></font></b></p><br>
</div>
