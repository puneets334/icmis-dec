<div  style="padding-left: 2px;padding-right: 2px;margin-left: 48px" width="100%">
    ...
    <p align="center" style='margin: 0px;padding: 10px 0px 0px 0px;clear: both' >
        ...
        if ($case_range==0)
        {
            ...
            $a=substr($dairy_no,0,-4).'/'.  substr($dairy_no,-4);
        }
        else
        {
            $a=$res_fil_det['casename'].'No(s)'.  $case_range. " OF  ". $reg_year;
        }
        ...
        <u><b><font style="font-size: 13pt" face= "Times New Roman" id="append_data"><?php echo $a; ?></font></b></u>
...
?>
    ...
    <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt" face= "Times New Roman">
            ...
            {
                ?>
                I am directed to forward herewith a certified copy of the order of this Court as contained
                in the record of proceeding dated <u><b style="font-size: 13pt" face= "Times New Roman"><?php $disposal_dt= date('dS F, Y', strtotime($dispose_detail));
                    echo $disposal_dt; ?></b></u> passed in the matters above-mentioned
                <?php if($r_nature=='Criminal') { ?> alongwith Schedule containing full cause title of the parties<?php } ?>,
