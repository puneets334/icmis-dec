...
<!--    <div style="width: 40%;border-collapse: collapse;border: 1px solid black;float: left;font-size: 13pt" border="1" >
    ...
    <div style="width: 100%;float: right;font-size: 13pt;text-align: center;font-weight:bold;">
...
<u style="font-size: 13pt"  face= "Times New Roman">IN</u>
  ...
  $first_listed_date=date('dS F, Y', strtotime($get_first_listed_date));
   $diary_rec_dt=$new_date = date('dS F, Y', strtotime(get_diary_rec_date($dairy_no)));
        ?>
With reference to the Petition filed by you on <b style="font-size: 13pt"  face= "Times New Roman"><?php echo $diary_rec_dt;?></b>, I am to point out that the Petition is defective for the following reason(s):        
</font>
     </p>
             <p align="center" style='margin: 0px;padding: 10px 0px 0px 0px;' >
<u style="font-size: 13pt"  face= "Times New Roman">&nbsp;</u>
...
<u style="font-size: 13pt"  face= "Times New Roman">&nbsp;</u>
      ...
      <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
         <font  style="font-size: 13pt"  face= "Times New Roman">
Please take notice that the above said defects should be cured within 28 days failing which the action as contemplated under Order VIII, Rule 6(3) & 6(4) of the Supreme Court Rules, 2013 will be initiated in the matter.
             </font>
    </p>
