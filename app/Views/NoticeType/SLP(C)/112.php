  ...
  $no_of_petitiner='';
   ...
   $doc_names='';
     for ($index22 = 0; $index22 < count($get_application_registration_all); $index22++) {
        ...
        ?>
      WHEREAS the  Arbitration Petition under Section 11 of the Arbitration and Conciliation Act,1996 read with the Appointment of the
      Arbitratiors by the Chief Justice of India Scheme, 1996 alongwith application from exemption from filing Certified Copy of the impugned
      judgement seeking appointment of sole Arbitrator __________________________________________________________________________________________________________________________________________________<br/>______________________________________________________________________________________________________________________(Copy enclosed) filed by <b style="font-size: 13pt" face= "Times New Roman"><?php echo $get_petitioner_advocate; ?></b>
      , Advocate on behalf of the Petitioner above-mentioned was listed for hearing before this Court on the 13th November, 2019 when the court
...
//    echo $get_last_listed_date.'$$'.$get_last_listed_date_lst[1];
    ...
    ?>
        <font  style="font-size: 13pt" face= "Times New Roman">
    NOW, THEREFORE, TAKE NOTICE that the above matter(s)<?php echo $no_of_petitioner; ?>  <?php if($con_nm!='') { ?> along with connected matters <?php echo $con_nm; } ?></b> will be posted for hearing before the Court
in due course when you may appear before this Court either in person or through an advocate-on-record of this Court duly appointed by you in that behalf within thirty days from the date of service of  notice. You may
thereafter show cause to the Court on the day that may subsequently be specified as to why the prayer made be not granted.
</font>
    <?php } ?>
      ...
      <p style="text-indent: 80px;padding: 0px 2px 0px 2px;margin: 5px 60px 0px 60px;" align="justify">
         <b><font  style="font-size: 13pt;line-height: 1" face= "Times New Roman">"<?php echo read_txt_file($fil_nm_lst);?>"
         </font></b>
    </p>
    <?php
       }
    ...
    <!-- <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
<font  style="font-size: 13pt" face= "Times New Roman">
     Therefore, you are hereby informed that the Petition as mentioned above, will be listed before the Hon'ble Court in due course when you may, if you so choose, assist the Hon'ble Court in appointment of the Arbitration, and take such part in the proceedings as you may think fit. You are further informed that in case you fail to appear in due course, the petition will be decided in your absence.
             </font>
    </p> -->
    <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman" >
    You may file your affidavit in opposition to the petition as provided under Rule VI of Order XXII, SCR 2013,
    within thirty days from the date of receipt of notice or not  later than two weeks before the date
    appointed for hearing, whichever be earlier, but shall do so only by setting out the grounds in opposition
    to the questions of law or grounds set out  in the <?php echo $res_fil_det['casename'] ?>  and may produce such pleadings and documents filed
    before the Court against whose order the <?php echo $res_fil_det['casename'] ?>  is filed and shall also set out the grounds for not granting
    interim order or for vacating interim order if already granted.
            </font>
    </p>
    <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman" >
    TAKE FURTHER NOTICE that if you fail to enter appearance, as aforesaid, no further notice shall be given
    to you even after the grant of special leave for hearing of the resultant appeal and the matter
    above mentioned shall be disposed of in your absence.
            </font>
    </p>
      <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
         <font style="font-size: 13pt" face= "Times New Roman" >
   ...
   [Complete set of <?php echo $res_fil_det['casename']  ?> containing Page Nos. ______ to  ______ along with the Notice is enclosed herewith]
              ...
              <tr>
                  <td style="font-size: 13pt;vertical-align: top">
                    ...
                    <td >
                        ...
                        echo ($ex_exp[1]) ?? ''.' '. ucwords(strtolower($ex_exp[0])).' '.(isset($ex_exp[2]) ? ucwords(strtolower($ex_exp[2])) : '');
