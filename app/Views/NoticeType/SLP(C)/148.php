   ...
   <p align="center" style='margin: 0px;padding: 10px 0px 0px 0px;clear: both' >
    ...
    <u><b><font style="font-size: 13pt" face= "Times New Roman" id="append_data"><?php echo $res_fil_det['casename'] ?> <?php if(strpos($case_range, '-')==true) echo 'No(s)'; else echo 'No.';?> <?php echo $case_range; ?> OF <?php echo $reg_year; ?></font></b></u>
     ...
     <p align="justify" style='margin: 5px;padding: 2px 0px 0px 0px;font-size: 13pt' face= "Times New Roman">
       ...
       $get_last_listed_date=date('dS F, Y', strtotime($get_last_listed_date));
...
?>
      <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt" face= "Times New Roman">
            Pursuant to Hon'ble Courts Order dated <b style="font-size: 13pt"  face= "Times New Roman" ><?php echo $listed_dt ?></b> , I am forwarding herewith a complete
            set of Transfer Petition alongwith Hon'ble Court Order dated <b style="font-size: 13pt"  face= "Times New Roman" ><?php echo $listed_dt ?></b> and a copy of the
            Counter Affidavit filed by Respondent for your information and necessary action.

</font></p>
<p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
    <font  style="font-size: 13pt"  face= "Times New Roman">
        You are requested to appoint a counsel from the Panel of Supreme Court Legal Services Committee and inform the Registry.
    </font>
</p>
    ...
    <p align="right" style="padding: 13pt 2px 0px 0px;margin: 0px"><b><font style="font-size: 13pt" face= "Times New Roman">Yours faithfully</font></b></p><br><br>
   ...
   <br><br>
    ...
    <p style="color: #000000;margin: 0px;padding: 0px 2px 0px 42px;width: 50%;" >
         <font style="font-size: 13pt" face= "Times New Roman" >
                Encl: Transfer petition Paper Book
    </p>
    <p style="color: #000000;margin: 0px;padding: 0px 2px 0px 42px;width: 50%;" >
