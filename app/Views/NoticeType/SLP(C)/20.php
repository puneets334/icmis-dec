<div  style="padding-left: 2px;padding-right: 2px;margin-left: 48px" width="100%">
    ...
    <?php } ?>
     <p style="color: #000000;margin: 0px;padding: 0px 2px 0px 42px;width: 50%;float: left;text-transform: uppercase;">
       ...
       <p style="color: #000000;margin: 0px;padding: 0px 2px 0px 42px;width: 50%;text-transform: uppercase;" >
           ...
           <b> <font style="font-size: 13pt"  face= "Times New Roman"  >
                   (Process Id:<?php echo $row['process_id'] ?>/<?php echo $row['rec_dt']; ?>)
           </font> </b>
       </p>
       <p style="color: #000000;margin: 0px;padding: 0px 2px 0px 42px;width: 50%;text-transform: uppercase;" >
           ...
           <font style="font-size: 13pt"  face= "Times New Roman"  >
               ...
               <b>
                   <?php if($case_range!='' || $case_range!=0){?>
   ...
   <p align="center" style='margin: 0px;padding: 10px 0px 0px 0px;clear: both' >
    ...
    <b  > <?php echo $skey ?> </b> No. <b  ><?php echo $lct_caseno; ?></b> of <b ><?php echo $lct_caseyear; ?></b>)</div>
<?php
...
?>
   ...
   <div align="center" style="width: 100%;clear: both">
    ...
    <p style="margin: 0px;padding: 0px 0px 0px 2px;clear: both"><b><font style="font-size: 13pt"  face= "Times New Roman" >Sir,</font></b></b></p>
    <?php
      ...
      <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman">
            ...
            With reference to the <b><?php echo $res_fil_det['short_description']; echo $case_range; ?> / <?php echo $reg_year; ?></b> filed by you on ................, I am to inform you that the same is defective for the reason that:-
            <ol><li></li></ol>
      ...
      <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
         <font  style="font-size: 13pt"  face= "Times New Roman">
        You are therefore, requested to cure defects within 28 days, failing which the action as contemplated under Order VIII, Rule 6(3) and (4) of Supreme Court Rule, 2013 will be initiated.
