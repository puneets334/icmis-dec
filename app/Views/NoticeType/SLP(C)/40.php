...
<u style="font-size: 13pt"  face= "Times New Roman">IN</u>
  ...
  $first_listed_date=date('dS F, Y', strtotime($get_first_listed_date));
        ?>
I am to inform you that the above-mentioned defective Curative Petition was placed before Ld. Registrar (M) and the same was lodged vide Order dated <b style="font-size: 13pt"  face= "Times New Roman"><?php echo $listed_dt; ?></b> under Order VIII Rule 6(3) &(4) of Supreme Court Rules 2013.(Copy of the order dated <b style="font-size: 13pt"  face= "Times New Roman"><?php echo $listed_dt; ?></b> is enclosed herewith)
</font>
     </p>
