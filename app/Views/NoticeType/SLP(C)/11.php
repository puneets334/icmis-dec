...
<div  style="padding-left: 2px;padding-right: 2px;margin-left: 48px" width="100%">
    <div style="width: 40%;border-collapse: collapse;border: 1px solid black;float: left;font-size: 13pt; padding: 5px" border="1"  face= "Times New Roman" >
 ...
 $lct_caseno=$lower_court[$index1][4];
  $lct_caseyear=$lower_court[$index1][5];
           ?>
          (From the Judgment and Order dated  <b style="font-size: 13pt"><?php echo $judgement_dt; ?></b> 
   ...
   <div align="center" style="width: 100%;clear: both">
      ...
      <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 20px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt" face= "Times New Roman">
     The matter above mentioned was listed before the Hon'ble Court on <b style="font-size: 13pt"><?php echo $listed_dt ?></b>, 
