<div  style="padding-left: 2px;padding-right: 2px;margin-left: 48px" width="100%">
    ...
    <div style="width: 48%;float: right;font-size: 13pt;text-align: center" face= "Times New Roman">
        <b><i><u>Delivery Mode:
                    <?php
   ...
   <?php } ?>
      ...
      <div style="margin: 0px;padding: 0px 0px 0px 2px;clear: both;"><b><font style="font-size: 13pt"  face= "Times New Roman">From:</font></b></div>
 ...
 $lct_caseno=$lower_court[$index1][4];
  $lct_caseyear=$lower_court[$index1][5];
           ?>
     <div style="margin-bottom: 10px;font-size: 13pt">(From the Judgment and Order dated <b style="font-size: 13pt"><?php echo $judgement_dt; ?></b> 
       of the <b style="font-size: 13pt"><?php echo $agency_name;  ?></b>
             <!-- ,-->  <?php //echo $lower_court[$index1][1] ?>
       in 
   ...
   <div align="center" style="width: 100%;clear: both">
    ...
    <?php
      ...
      <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        ...
        I am directed to forward herewith for your information and necessary action a certified copy of 
        Record of Proceedings dated  <b style="font-size: 13pt"><?php echo $listed_dt; ?></b> of this Court in the matter above mentioned.
