...
<u style="font-size: 13pt"  face= "Times New Roman">IN</u>
   ...
   <div align="center" style="width: 80%;clear: both">
  ...
  $first_listed_date=date('dS F, Y', strtotime($get_first_listed_date));
   $diary_rec_dt=$new_date = date('dS F, Y', strtotime(get_diary_rec_date($dairy_no)));
        ?>
With reference to the <b style="font-size: 13pt"  face= "Times New Roman">D.No. <?php echo substr($dairy_no,0,-4).'/'.  substr($dairy_no,-4); ?></b> filed by you on, <b style="font-size: 13pt"  face= "Times New Roman"><?php echo $diary_rec_dt;?></b>. I am to inform you that the same has been lodged by Ld. Registrar vide order dated <b> <?php $disposal_dt= date('dS F, Y', strtotime($dispose_detail));
                echo $disposal_dt; ?></b> under Order VIII,Rule 6(3) &(4) of the Supreme Court Rules, 2013, the complete order of Ld. Registrar is enclosed herewith for ready reference.
</font>
     </p>
