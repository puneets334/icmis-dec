<div  style="padding-left: 2px;padding-right: 2px;margin-left: 48px" width="100%" >
    ...
    <p align="justify" style='margin: 0px;padding: 2px 0px 0px 0px;font-size: 13pt  face= "Times New Roman'>
        ...
        $last_listed= last_listed_date($dairy_no);
        $listed_dt1=date('dS F, Y', strtotime($last_listed[0]));
...
?>
    ...
    <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman" >
           In continuation of this Registry's letter dated the .............. in the matter above mentioned,
            I am to inform you as per Court's Order dated <b><?php echo $listed_dt1; ?></b></php> that Mediation was held on .............. but the final
            Mediation Report has not been received so far.
        </font>
    </p>

    <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman" >
            You are, therefore, requested to send the Mediation Report forthwith so that matter can be placed before the Court. Next
            date of listing before <b><?php echo $last_listed[3].' ';?></b> is <b><?php echo $tentative_dt; ?></b>.
        </font>
    </p>
