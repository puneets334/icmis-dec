...
<p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
    <font  style="font-size:13pt">
       With reference to the petition forwarded by you vide letter Memo No.......... dated........., this is  to inform you that the petition forwarded is
        not accompanied with the following document:-
<ol>
    <li>Custody Certificate (in English).</li>
...
<p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
    <font  style="font-size:13pt">
        In order to process this Jail Petition, you are requested to provide above said documents to this Registry within 10 days on receipt of this letter
    </font>
</p>
<p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="center">
    <font  style="font-size:13pt">
        <b><u> This may be treated as Most Urgent. </u></b>
    </font>
</p>
...
{
?>
<p style="text-indent: 40px;padding: 4px 0px 0px 2px;margin: 0px;" align="justify"><font style="font-size:13pt;text-transform: uppercase;" >
