...
<!--    <p align="center" style='margin: 0px;padding: 2px 0px 0px 0px;'>
  ...
  <p align="center" style='margin: 0px;padding: 2px 0px 0px 0px;'>
    ...
    <u><b><font style="font-size: 13pt" face= "Times New Roman" ><?php echo $res_fil_det['casename'] ?> <?php if(strpos($case_range, '-')==true) echo 'No(s)'; else echo 'No.';?> <?php echo $case_range; ?> OF <?php echo $reg_year; ?></font></b></u>
          ...
          ?>
          <p align="center" style='margin: 0px;padding: 10px 0px 0px 0px;' >
      <b><font style="font-size: 13pt" face= "Times New Roman">WITH</font></b></p>
               <?php
               $s_no=0;
  ...
  $no_of_petitiner='';
   ...
   $doc_names='';
     for ($index22 = 0; $index22 < count($get_application_registration_all); $index22++) {
        ...
        ?>
        WHEREAS the Petition under Section 25 of the Code of Civil Procedure, 1908, above-mentioned, <?php
if($doc_names!='') { ?> along with an application for   <b style="font-size: 13pt"  face= "Times New Roman"><?php echo $doc_names; ?></b><?php } ?>
 seeking transfer of  <b style="font-size: 13pt"  face= "Times New Roman"> <?php echo $skey ?> </b> No. <b style="font-size: 13pt"  face= "Times New Roman"><?php echo $lct_caseno; ?></b> of <b style="font-size: 13pt"  face= "Times New Roman"><?php echo $lct_caseyear; ?> </b>
      titled as "<?php
         echo $res_fil_det['res_name']; ?> Vs.  <?php echo $res_fil_det['pet_name']; ?>", pending before the Family Court <?php echo $agency_name;?>, <?php echo  $state; ?>, under the jurisdiction of High Court of
<?php echo  $state; ?>, to the Family Court/Competent Court at <?php
...
<p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
       <font  style="font-size: 13pt" face= "Times New Roman">
    NOW, THEREFORE, TAKE NOTICE that the above petition along with application for stay will be
    taken up by this Court in due course and you may enter appearance before this Court either in-person
    or through an Advocate-on-Record of this Court duly appointed by you in that behalf within thirty days
    from the date of service of notice. You may thereafter show cause to the Court on the day that
    may subsequently be specified as to why the prayer made in the transfer petition and application for stay may
    not be allowed/granted to the petitioner above named.

       </font>
   </p>
    <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
        <font  style="font-size: 13pt" face= "Times New Roman">
            You may file your affidavit in opposition to the petition as provided under Rule 3 Order XLI, S.C.R. 2013,
            not later than one week before the date appointed for hearing of the petition.
        </font>
    </p>
    <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
        <font  style="font-size: 13pt" face= "Times New Roman">
            TAKE FURTHER NOTICE that if you fail to enter appearance, as aforesaid, no further notice shall
            be given to you and the matter above mentioned shall be disposed of in your absence.
        </font>
    </p>
