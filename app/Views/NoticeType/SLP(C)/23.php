<div  style="padding-left: 2px;padding-right: 2px;margin-left: 48px" width="100%">
    <div style="width: 40%;border-collapse: collapse;border: 1px solid black;float: left;font-size: 14.5px;padding: 5px" border="1" >
...
<u style="font-size: 14.5px">IN</u>
 ...
 $lct_casenos=$lower_courts[$index2][4];
  ...
  ?>
    <div style="margin-bottom: 10px;font-size: 14.5px"> (From the Judgment and Order dated  <b style="font-size: 14.5px"><?php echo $judgement_dts; ?></b> 
       of the <b style="font-size: 14.5px"><?php echo $agency_names;  ?></b>, <?php echo $lower_courts[$index1][1] ?> in 
       <b style="font-size: 14.5px"> <?php echo $skeys ?> </b> No. <b style="font-size: 14.5px"><?php echo $lct_casenos; ?></b> of <b style="font-size: 14.5px"><?php echo $lct_caseyears; ?></b>)</div>
    <?php
                    }
             }
       }
   ...
   <div align="center" style="width: 100%;clear: both">
     ...
     <p style="margin: 0px;padding: 0px 0px 0px 2px;clear: both"><b><font style="font-size: 14.5px" >Sir,</font></b></p>  
      ...
      I am directed to inform you that above mentioned Curative Petition was circulated before 
      the <b style="font-size: 14.5px"><?php echo $get_last_listed_dates[3] ?></b> on 
<b style="font-size: 14.5px"><?php echo $last_listed_dts ?></b> , when the following order was passed :-
</font>
     </p>
      <?php
 ...
 This is for your information please.
   ...
   <p align="right" style="padding: 16px 2px 0px 0px;margin: 0px"><b><font style="font-size: 14.5px" >Yours faithfully,</font></b></p>
    ...
    <p style="padding: 4px 0px 0px 2px;margin: 0px;" align="justify"><font style="font-size: 14.5px" >
    Copy to :-
   </font></p>
 <?php
