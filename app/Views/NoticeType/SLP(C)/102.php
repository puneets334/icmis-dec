<div  style="padding-left: 2px;padding-right: 2px;margin-left: 48px" width="100%" >
    ...
    else if($row['individual_multiple']==2)
    {
        echo $tot_records;
         ...
         $ap = get_application_registration($dairy_no);
   $ianame= $ap[0][0];
   $ia_no =$ap[0][1];
   ...
   <p align="center" style='margin: 0px;padding: 10px 0px 0px 0px;clear: both' >
    ...
    </br><u><b><font style="font-size: 13pt"  face= "Times New Roman" id="append_data"><?php echo "IA No. ".$ia_no; ?> - <?php echo $ianame; ?></font></b></u>
   ...
   <div align="center" style="width: 100%;clear: both">
     ...
     <p style="margin: 0px;padding: 0px 0px 0px 2px;clear: both"><b><font style="font-size: 13pt"  face= "Times New Roman" >Sir,</font></b></p>  
      ...
      <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
       ...
       I am directed to forward herewith for your information and necessary action a copy of
the Record of Proceeding dated <b style="font-size: 13pt"  face= "Times New Roman"><?php echo $last_listed_dts ?></b> along with memo of parties in the matter above
mentioned. 
  </font>
     </p>
   ...
   <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
         <font  style="font-size: 13pt"  face= "Times New Roman">
The Office-in-charge, Mediation Centre is requested to send the Mediation Report within four weeks from the date of appearance of the parties, as directed by Hon'ble Court.
             </font>
    </p>
      <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
         <font  style="font-size: 13pt"  face= "Times New Roman">
