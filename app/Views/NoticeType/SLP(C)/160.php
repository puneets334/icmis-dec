...
<?php } ?>
    ...
    <div align="center" style="width: 100%;clear: both">
        <table cellpadding="10" cellspacing="10" style="width: 50%" >
            <tr>
 ...
 <!--<p style="margin: 0px;padding: 0px 0px 0px 2px;clear: both;margin-bottom: 20px"><b><font style="font-size: 13pt"  face= "Times New Roman"  >Ref: No.......</font></b></p>-->  
     <p style="margin: 0px;padding: 0px 0px 0px 2px;clear: both"><b><font style="font-size: 13pt"  face= "Times New Roman"  >Sir,</font></b></p>  
      ...
      <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman" >
       In continuation to this Registry's letter dated ____ and _____ forwarding therewith copy of show cause notice (in duplicate) alongwith copy of the petition for effecting service on the sole respondent in the matter above mentioned, I am to inform you that no service report has been received from your side till date.
     </font>
     </p>
     <?php
    ...
    ?>
     <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman" >
  You are, therefore, requested to send a service report (particularly in English language) after effecting service of notice on the sole respondent namely __________.</font>
     </p>
