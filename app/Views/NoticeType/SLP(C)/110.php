...
<div  style="padding-left: 2px;padding-right: 2px;margin-left: 48px" width="100%">
    ...
    <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 40px 0px 20px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman">
            ...
            ?>
            WHEREAS the Arbitration Petition filed in the
            Registry by <b style="font-size: 13pt"  face= "Times New Roman"><?php echo $get_petitioner_advocate; ?></b>, Advocate on behalf of the Petitioner
            above-named (Copy enclosed) was listed for hearing before this Court on <?php echo $listed_dt ?></b>, when the Hon'ble Court was
    ...
    <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman">
            ...
            ?>
           Therefore, you are hereby informed that the Petition as mentioned above, will be listed before the Hon'ble Court on
            <b style="font-size: 13pt"  face= "Times New Roman"><?php echo $tentative_dt;?></b> when you may, if you so choose,
            assist the Hon'ble Court in appointment of the Arbitrator, and take such part in the proceedings as you may think fit.
            You are further informed that in case you fail to appear in due course the petition will be decided in your absence.
