   ...
   <div align="center" style="width: 100%;clear: both">
     ...
     <p style="margin: 0px;padding: 0px 0px 0px 2px;clear: both"><b><font style="font-size: 13pt"  face= "Times New Roman" >Sir,</font></b></p>  
      ...
      <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman">
   I am directed to enclose herewith copy/copies of Notice for effecting Dasti service on the  
   <b><?php
...
?></b>   as per Hon'ble Court's Order dated <b><?php echo $listed_dt; ?> </b>. You are, therefore, requested to serve the notice on the Respondent/Respondent Nos.<b><?php echo "Respondent No. ". $respondents; ?> </b>  and file affidavit with proof of service well before &nbsp; &nbsp; at the earliest.
