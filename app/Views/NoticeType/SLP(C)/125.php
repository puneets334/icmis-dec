<div  style="padding-left: 2px;padding-right: 2px;margin-left: 48px" width="100%">
 ...
 <div style="font-size: 13pt;margin-bottom: 10px" face= "Times New Roman" ><center>(Ref.No.
    ...
    <?php
     ...
     $dispose_detail=dispose_detail($dairy_no);
      ...
      <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0gn="justify">
        ...
        {
           ?>
        The Transfer Petition above -mentioned was listed before the Hon'ble Court on
         <u><b style="font-size: 13pt" face= "Times New Roman"><?php $disposal_dt= date('dS F, Y', strtotime($dispose_detail));
          echo $disposal_dt; ?></b></u>, When the Court was pleased to pass the following Order:
            <?php
            $diary_no= substr($dairy_no,0,-4);
            $diary_year= substr($dairy_no,-4);

          //  echo " last listed date=". $disposal_dt;

            //$disposal_dt1=date('dS F, Y', strtotime( $get_last_listed_date));

            if( $dispose_detail!='')
            {
                $fil_nm= get_text_pdf($dairy_no, $dispose_detail);
                //echo " the content is ".$fil_nm;
  ...
  You are hereby directed to appear before the transferee court on .
</font>
     </p>
   ...
   <p align="right" style="padding: 16px 2px 0px 0px;margin: 0px" face= "Times New Roman"><b><font style="font-size: 13pt" face= "Times New Roman" >Yours faithfully,</font></b></p>
    <p align="right" style="padding: 50px 2px 0px 0px;margin: 0px"><b><font style="font-size: 13pt" face= "Times New Roman" ></font></b></p>
    <font style="font-size: 13pt" face= "Times New Roman" ></font>
