<div  style="padding-left: 2px;padding-right: 2px;margin-left: 48px" width="100%" >
    ...
    <p align="center" style='margin: 0px;padding: 10px 0px 0px 0px;clear: both' >
        ...
        <u><b><font style="font-size: 13pt"  face= "Times New Roman"  id="append_data"><?php echo $res_fil_det['casename'] ?> No. <?php echo $case_range; ?> OF <?php echo $reg_year; ?></font></b></u>
...
?>
    ...
    <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman" >
           I am directed to forward herewith, a certified copy of the order of this Court, as contained in the record of proceeding dated
            <b><font style="font-size: 13pt"  face= "Times New Roman" ><?php echo $listed_dt; ?></font></b>
            passed by this Hon'ble Court in the matter above-mentioned for your information, necessary action and compliance.
        </font>
    </p>
    <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman" >
