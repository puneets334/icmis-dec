<div  style="padding-left: 2px;padding-right: 2px;margin-left: 48px" width="100%">
   ...
   <p align="center" style='margin: 0px;padding: 10px 0px 0px 0px;clear: both' >
    <b><font style="font-size: 13pt"  face= "Times New Roman">
            <u>INTERLOCUTORY APPLICATION D NO. ________</u><br>
(Application for Special Case Under Order XIX Rule 25, SCR, 2013)
</font></b>
    </p>
...
<u style="font-size: 13pt"  face= "Times New Roman">IN</u>
  ...
  $first_listed_date=date('dS F, Y', strtotime($get_first_listed_date));
        ?>
With reference to application for Special Case Under Order XIX Rule 25, SCR, 2013 above mentioned filed by you on <b style="font-size: 13pt"  face= "Times New Roman"><?php echo $listed_dt; ?></b>, I am to inform you that the same was placed before Ld. Registrar (J-IV) and declined to be registered and be lodged vide Order dated <b style="font-size: 13pt"  face= "Times New Roman"><?php echo $listed_dt; ?></b> under Order XV Rule 5 of Supreme Court Rules 2013.(Copy of order is enclosed herewith)
</font>
     </p>
