 ...
 <!--<p style="margin: 0px;padding: 0px 0px 0px 2px;clear: both;margin-bottom: 20px"><b><font style="font-size: 13pt"  face= "Times New Roman"  >Ref: No.......</font></b></p>-->  
     <p style="margin: 0px;padding: 0px 0px 0px 2px;clear: both"><b><font style="font-size: 13pt"  face= "Times New Roman"  >Sir,</font></b></p>  
      ...
      <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman" >
            In pursuance of Order XI, Rule 3, S.C.R.2013, I am directed to forward herewith for your information and necessary action and certified copy of this Court's proceedings dated <b><?php  echo $listed_dt; ?></b> in the matters above-mentioned and to request you to transmit to this Court forthwith the report regarding the stage at which case as referred to above stand in the High Court or disposed of.   </font>
     </p>
     <?php
    ...
    ?>
     <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman" >
 I am to forward herewith notice in due course before the Hon'ble Court and request you to have it served on the respondent(s) and transmit to this Court a certificate as to the date or dates on which it has been served on the respondents(s) as soon as service is complete. </font>
     </p>

    <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman" >
  Please acknowledge the receipt.  </p>
