...
<!--    <p align="center" style='margin: 0px;padding: 2px 0px 0px 0px;'>
  ...
  <p align="center" style='margin: 0px;padding: 2px 0px 0px 0px;'>
    ...
    <u><b><font style="font-size: 13pt"  face= "Times New Roman" > Petition for Special Leave to Appeal (Civil) <?php if(strpos($case_range, '-')==true) echo 'No(s)'; else echo 'No.';?> <?php echo $case_range; ?> OF <?php echo $reg_year; ?></font></b></u>
...
<!--   </p>-->
   ...
   $cnt_con_case=0;
    for ($index3 = 0; $index3 < count($connected_cases); $index3++) {
      ...
      of the Petitioner above named was listed for hearing before this Court on <b style="font-size: 13pt"  face= "Times New Roman"><?php echo $listed_dt ?></b> <?php if($cnt_con_case>0) { ?> along with the connected 
  ...
  ?>"
      ...
      <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
         ...
         ?>
NOW, THEREFORE, TAKE NOTICE that the above petition <?php   if($conn_cases!='') { ?> along with <?php } ?> <b style="font-size: 13pt"  face= "Times New Roman"><?php echo $con_nm; ?></b> 
 will be posted for hearing before this Court on <b style="font-size: 13pt"  face= "Times New Roman"><?php echo $tentative_dt;?></b> at 10.30 O' Clock in the forenoon or so soon thereafter as may be
 convenient to the Court <?php if($res_fil_det['casename']=='Diary') { ?> and show cause to the court as to why condonation of delay in filing be not condoned <?php ;} else { ?> when you may appear before the court either in person or through Counsel and 
 show cause to the Court  as to why <?php if($res_fil_det['casename']=='CIVIL APPEAL') {} else { ?> Special Leave and <?php } ?> interim relief as prayed for  be not granted <?php ; } ?> and the 
 resultant appeal be not allowed. 
      ...
      <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
         <font  style="font-size: 13pt"  face= "Times New Roman">
     Take Further Notice that this Court has passed an interim order pending for disposal 
     of SLP after notice as quoted above.  
             </font>
    </p>
    
     <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
         <font  style="font-size: 13pt"  face= "Times New Roman">
     Take Further Notice that the prayer for interim relief after notice will also be listed before 
     the Court on the aforesaid date. 
             </font>
    </p>
       <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
         <font  style="font-size: 13pt"  face= "Times New Roman">
    You may file your affidavit in opposition to the petition as provided under Rule 14(1) of 
    Order XXI, S.C.R.2013 within 30 days from the date of receipt of notice or not later than 2 
    weeks before the date appointed for hearing, whichever be earlier, but shall do so only by setting 
    out the grounds in opposition to the questions of law or grounds set out in the
   <?php if($res_fil_det['casename']=='CIVIL APPEAL') { echo $res_fil_det['casename']; } else { ?> SLPs <?php ; } ?> 
    and may produce 
    such pleadings and documents filed before the Court/Tribunal against whose order the 
   <?php if($res_fil_det['casename']=='CIVIL APPEAL') { echo $res_fil_det['casename']; } else { ?> SLP <?php ;} ?> is filed and 
    shall also set out the grounds for not granting interim order or for vacating interim order if already 
    granted.
             </font>
    </p>
     <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
    ...
    given to you even after the grant of special leave for hearing of the resultant appeal and the 
    matter above mentioned shall be disposed of in your absence.
             </font>
    </p>
