<div  style="padding-left: 2px;padding-right: 2px;margin-left: 48px" width="100%">
 ...
 $lct_caseno=$lower_court[$index1][4];
  $lct_caseyear=$lower_court[$index1][5];
           ...
           ?>
 <div style="font-size: 13pt;margin-bottom: 10px" face= "Times New Roman" ><center>(Ref.No.
       <?php
    ...
    <?php
     ...
     $dispose_detail=dispose_detail($dairy_no);
      ...
      <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0gn="justify">
        ...
        {
           ?>
        In continuation of this Registry's letter dated &nbsp; &nbsp; I am directed to inform you that Transfer Petition above mentioned has been allowed by this Hon'ble Court in terms of the signed Order dated
   ...
   <p align="right" style="padding: 16px 2px 0px 0px;margin: 0px" face= "Times New Roman"><b><font style="font-size: 13pt" face= "Times New Roman" >Yours faithfully,</font></b></p>
    ...
    <font style="font-size: 13pt" face= "Times New Roman" >Copy with a Certified copy of Order dated <b style="font-size: 13pt" face= "Times New Roman"><?php $disposal_dt= date('dS F, Y', strtotime($dispose_detail));
          echo $disposal_dt; ?></b>  forwarded to:-
    <ol> <li>The Registrar,<br>
        High Court of</li>
<li>
    The Registrar,<br>
    High Court of</li> </ol>
