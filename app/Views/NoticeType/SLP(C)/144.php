    ...
    <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 40px 0px 20px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt" face= "Times New Roman">
           ...
           /* $doc_name='';
            ...
            above mentioned filed in the Registry <b style="font-size: 13pt" face= "Times New Roman">on <?php echo  $iadate;?> by <?php echo $get_petitioner_advocate; ?> </b>, Counsel for the petitioner
            above mentioned was listed before the Hon'ble Court on <b style="font-size: 13pt" face= "Times New Roman"><?php echo $listed_dt ?></b>, when  the Court was pleased to pass the following order:-
        </font>
    </p>
...
/*
    ...
    <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
        <font  style="font-size: 13pt" face= "Times New Roman">
            NOW, THEREFORE, TAKE NOTICE that the applications above mentioned in the above petition will be posted for hearing before this Court
            in due course and you may enter appearance before this Court either in person or through an advocate on record of this Court duly
            appointed by you in that behalf within 30 days from the date of service of this notice. You may thereafter show cause to the Court on
            the day that may subsequently be specified as to _____________________________________.
    ...
    <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
        <font  style="font-size: 13pt" face= "Times New Roman">
            ...
            to you and the application above mentioned shall be disposed of in your absence.
        </font>
    </p>
