...
<p align="justify" style='margin: 0px;padding: 2px 0px 0px 0px;font-size: 13pt"  face= "Times New Roman'>
    ...
    ?>
    <div style="margin-bottom: 10px;font-size: 13pt"  face= "Times New Roman" >(Petition under Article 136 of the Constitution of India for Special leave to Appeal from the Judgment and Order dated the <b style="font-size: 13pt"  face= "Times New Roman" ><?php echo $judgement_dt; ?></b>
...
<p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
    <font  style="font-size: 13pt"  face= "Times New Roman" >
        ...
        In continuation of this Registry's letter of even number dated  in the matter above-mentioned. I am to inform you that the petitioner herein has on  filed the requisite undertaking as directed by this Court by its Order dated  <b><?php echo date("d.m.y", strtotime($get_last_listed_date) );  ?></b> in the matter. The said undertaking is within time and the same is not in conformity with Court's order (copy enclosed).
