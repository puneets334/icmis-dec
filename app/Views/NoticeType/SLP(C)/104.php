   ...
   <div align="center" style="width: 100%;clear: both">
    ...
    <?php
     ...
     $dispose_detail=dispose_detail($dairy_no);
      ...
      <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0gn=justify" >The interim stay granted vide this Court's Order dated &nbsp; &nbsp;  stands vacated. </p> 
