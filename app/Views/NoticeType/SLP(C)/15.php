  ...
  ?>
   ...
   <div align="center" style="width: 100%;clear: both">
     ...
     <p style="margin: 0px;padding: 0px 0px 0px 2px;clear: both"><b><font style="font-size: 13pt"  face= "Times New Roman" >Sir,</font></b></p>  
      ...
      the <b style="font-size: 13pt"  face= "Times New Roman"><?php echo $get_last_listed_dates[3] ?></b> on 
<b style="font-size: 13pt"  face= "Times New Roman"><?php echo $last_listed_dts ?></b> , when the following order was passed :-
</font>
     </p>
      <?php
