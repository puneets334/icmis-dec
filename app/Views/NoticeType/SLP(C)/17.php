<div  style="padding-left: 2px;padding-right: 2px;margin-left: 48px" width="100%">
    ...
    <div style="width: 40%;float: right;font-size: 13pt;text-align: center" face= "Times New Roman">
        <b><i><u>Delivery Mode:
                    <?php
   ...
   <?php } ?>
      <p style="margin: 0px;padding: 0px 0px 0px 2px;clear: both"><b><font style="font-size: 13pt"  face= "Times New Roman" face= "Times New Roman" >From:</font></b></p>
   ...
   ?>  
      <p style="color: #000000;margin: 0px;padding: 0px 2px 0px 42px;width: 50%;text-transform: uppercase;" >
        ...
        <b> <font style="font-size: 13pt"  face= "Times New Roman" face= "Times New Roman" >
            <?php
              echo $tw_sn_to; ?></b>, 
    </p>
    <?php if($address_m!='') { ?>
 ...
 $lct_caseno=$lower_court[$index1][4];
  $lct_caseyear=$lower_court[$index1][5];
           ?>
     <div style="margin-bottom: 10px;font-size: 13pt">(Appeal by Special Leave granted by this Court's Order dated the <b style="font-size: 13pt"  face= "Times New Roman"><?php echo $listed_dt; ?></b> in Petition for 
   ...
   <div align="center" style="width: 100%;clear: both">
    ...
    <?php
      ...
      <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman">
        In pursuance of Order XII, Rule 6, SCR, 2013, I am directed to transmit herewith a Certified copy 
        of the Signed Order dated <b style="font-size: 13pt"  face= "Times New Roman"><?php echo $listed_dt; ?></b> 
        in the appeal above mentioned. The certified copy of the decree made 
        in the aforesaid appeal will be sent later on.
</font>
     </p>
