<div  style="padding-left: 2px;padding-right: 2px;margin-left: 48px" width="100%" l>
   ...
   <?php } ?>
      <p style="margin: 0px;padding: 0px 0px 5px 2px;clear: both"><b><font style="font-size: 13pt" face= "Times New Roman" >From:</font></b></p>
   ...
   <div align="center" style="width: 100%;clear: both">
    ...
    <?php
     ...
     $dispose_detail=dispose_detail($dairy_no);
      ...
      <p style="color: #000000; text-indent: 40px; padding: 0px 2px 0px 2px; margin: 10px 0px 0px 0;" align="justify">
        <font  style="font-size: 13pt" face= "Times New Roman">
        <?php
        ...
        {
           ?>
        In continuation of this Registry's letter dated &nbsp; &nbsp; I am directed to inform you that Transfer Petition above mentioned has been dismissed by this Hon'ble Court in terms of the signed Order dated 
         <u><b style="font-size: 13pt" face= "Times New Roman"><?php $disposal_dt= date('dS F, Y', strtotime($dispose_detail));
          echo $disposal_dt; ?></b></u> . A Certified Copy of the said Order in the matter is being forwarded herewith for your information and necessary compliance under intimation to this Registry.
              <?php if($r_nature=='Criminal') { ?> <?php } ?>
      <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0gn=justify" >The stay granted vide this Court's Order dated &nbsp; &nbsp;  stands vacated. </p> 
