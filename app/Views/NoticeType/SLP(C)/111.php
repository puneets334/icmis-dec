<div  style="padding-left: 2px;padding-right: 2px;margin-left: 48px" width="100%">
    <div style="width: 30%;border-collapse: collapse;border: 1px solid black;float: left;font-size: 13pt" border="1" >
        <?php echo get_text_msg();?>
    </div>
    <div style="width: 50%;float: right;font-size: 13pt;text-align: center">
        <b><i><u>Delivery Mode:
                    <?php
        ...
        <div align='center' style="width: 100%;border-collapse: collapse;font-size: 16px;clear: both" border="1" >
            <u style='font-size: 16px;'>REMINDER</u>
        </div>
    ...
    ?>
    <br>
    <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align=center"">
        <font  style="font-size: 13pt"  face= "Times New Roman">
            <b><u>SUB: Issue of Notice to Respondents in <?php echo $res_fil_det['casename']?> <?php if(strpos($case_range, '-')==true) echo 'No(s)'; else echo 'No.';?> <?php echo $case_range; ?> OF <?php echo $reg_year; ?></font></b></u>
        </font>
    </p>
    <br>
    ...
    <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
        <font style="font-size: 13pt" face= "Times New Roman">
            In continuation of this Registry's Letter dated<b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b> forwarding therewith copy of show cause notice
            alongwith paper books of Arbitration Petition and subsequent reminders dated <b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b> for effecting service
            on the respondents in the matter above mentioned. I am to inform you that no service report has been received from your side till date.

        </font>
    </p>
    <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman">
            You are therefore requested to send service report indicating the date of service after effecting service on the Respondents viz.
            <b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b>, indicating the date of service well before the next hearing.
        </font>
    </p>
