...
<div  style="padding-left: 2px;padding-right: 2px;margin-left: 48px" width="100%">
    ...
    {*/
        ...
        <font  style="font-size: 13pt;" face= "Times New Roman">
            ...
            NOW, THEREFORE, TAKE NOTICE, that the petition above-mentioned <?php   if($conn_cases!='') { ?> along with <?php } ?> <b style="font-size: 13pt"  face= "Times New Roman"><?php echo $con_nm; ?></b> will be posted for hearing before this Court in due course
            when you may appear before this Court either in person or through an Advocate-on-Record of this Court duly appointed by you in that behalf within thirty days
            from the date of service of notice. You may, thereafter, show cause to the Court on the day that may subsequently be specified as to why the prayer(s) made in
    ...
    <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 40px 0px 20px 0px;clear: both" align="justify">
        ...
        <font  style="font-size: 13pt"  face= "Times New Roman" >
            You may file your affidavit in opposition to the petition within thirty days from the date of receipt of notice or not later than two weeks before the date
            appointed for hearing, whichever is earlier, but shall do so only by setting
