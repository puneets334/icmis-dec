...
<div  style="padding-left: 2px;padding-right: 2px;margin-left: 48px" width="100%">
    ...
    <p style="margin: 0px;padding: 0px 0px 0px 2px;clear: both"><b><font style="font-size: 13pt"  face= "Times New Roman" >Sir,</font></b></p>
        ...
        <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 40px 0px 20px 0px;clear: both" align="justify">
           ...
           I am directd to forward herewith show cause notice with paperbooks (in duplicate) of Arbitration Petition alongwith&nbsp;&nbsp;&nbsp;&nbsp; demand drafts of USD 95 for effecting service on the Respondents viz.
    ...
    <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman">
           ...
           /* if($conn_cases!='')
            ...
            ?>
            You are requested to send the service report after effecting service on the Respondents, indicating the date of service at the earliest.
