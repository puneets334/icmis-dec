<div  style="padding-left: 2px;padding-right: 2px;margin-left: 48px" width="100%">
 ...
 <?php
   ...
   <p align="center" style='margin: 0px;padding: 10px 0px 0px 0px;clear: both' >
    ...
    <br><u><b><font style="font-size: 13pt" face= "Times New Roman" id="append_data"><?php echo "( ".$get_misc_re[0]." " .$get_misc_re[1]." of ".$get_misc_re[2]." )"; ?></font></b></u>
 ...
 $lct_caseno=$lower_court[$index1][4];
  $lct_caseyear=$lower_court[$index1][5];
           ...
           ?>
         <div style="font-size: 13pt;margin-bottom: 10px" face= "Times New Roman"> 
    ...
    <?php
     ...
     $dispose_detail=dispose_detail($dairy_no);
      ...
      <p style="color: #000000; text-indent: 40px; padding: 0px 2px; margin: 10px 0 0 0; text-align: justify;">
        ...
        {
           ?>
        I am directed to inform you that Civil Appeal(s) above mentioned has been disposed of by this Hon'ble Court in terms of Reportable Judgment dated 
         <u><b style="font-size: 13pt" face= "Times New Roman"><?php $disposal_dt= date('dS F, Y', strtotime($dispose_detail));
          echo $disposal_dt; ?></b></u> .I am further directed to forward herewith under Rule 5 of Order XII of the Supreme Court Rules,2013, a Certified Copy of the Reportable Judgment of this Court dated  <u><b style="font-size: 13pt" face= "Times New Roman"><?php $disposal_dt= date('dS F, Y', strtotime($dispose_detail)); echo $disposal_dt; ?></b></u>
        in the appeal(s) above mentioned. Certified Copy of the Decree in the aforesaid matters will be sent in due course.
