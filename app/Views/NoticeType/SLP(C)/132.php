...
<div  style="padding-left: 2px;padding-right: 2px;margin-left: 48px" width="100%">
    ...
    <div align="right" style='margin-top: 10px;padding: 2px 0px 0px 0px;'>
        <b>        Dated : <u style="font-size: 13pt"  face= "Times New Roman" ><?php echo $listed_dt_lst; ?></u></b>&nbsp;&nbsp;&nbsp;
    ...
    <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 40px 0px 20px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt" face= "Times New Roman">
            ...
            ?><br><br>
            WHEREAS the Petitioner above-named filed in this Court the Writ
            Petition above-mentioned under Article 32 of the Constitution of India for issue of
            a Writ/Order/Direction etc. in terms of the prayer set out therein. (Copy of Writ
            Petition enclosed).
        </font>
    </p>
    ...
    if(strtotime($get_last_listed_date)!=strtotime($get_last_listed_date_lst[1]))
    {
        ...
        <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 20px 0px;font-size: 13pt" align="justify" face= "Times New Roman">
            <font  style="font-size: 13pt" face= "Times New Roman">
                AND WHEREAS the Writ Petition above-mentioned was listed before this Court on <b style="font-size: 13pt" face= "Times New Roman"><?php echo $listed_dt_lst; ?></b>, UPON perusing the said
                Petition and the documents annexed thereto AND UPON hearing Counsel for the
                appearing parties herein, THIS COURT DOTH pass the following ORDER:-
    ...
    <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
        <font  style="font-size: 13pt" face= "Times New Roman">
            NOW, THEREFORE, TAKE NOTICE that the Writ Petition  <?php //if($doc_names!='') { ?>
               <?php //} ?> above-mentioned will be fixed for hearing and orders before this Court in
            due course and will be taken up by the Court on the day that may subsequently be specified.
        </font>
    </p>
    ...
    <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
        <font  style="font-size: 13pt" face= "Times New Roman">
            TAKE FURTHER NOTICE THAT you may appear before this Court either in person or through Advocate
            on Record duly appointed by you and show cause as to why a writ/order/direction, as sought by the
            petitioner should not be issued. You are further required to file your affidavit in opposition to the
            Writ Petition, as required by Rule 11(2) of ORDER XXXVIII of the Supreme Court Rules, 2013.
        </font>
    </p>
    <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
        <font  style="font-size: 13pt" face= "Times New Roman">
            LASTLY, TAKE Notice that in default of your appearance and non-filing of the affidavit in opposition,
            the matter will be proceeded with and determined in your absence
        </font>
    </p>
    <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman" >
            ...
            dated this the <b style="font-size: 13pt"  face= "Times New Roman" ><?php echo $listed_dt_lst; ?></b>.
        </font>
    </p>
    <?php // } ?>
    <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
