 ...
 <p style="margin: 0px;padding: 0px 0px 0px 2px;clear: both;margin-bottom: 20px"><b><font style="font-size: 13pt"  face= "Times New Roman " >Ref: No.......</font></b></p>  
     <p style="margin: 0px;padding: 0px 0px 0px 2px;clear: both"><b><font style="font-size: 13pt"  face= "Times New Roman " >Sir,</font></b></p>  
      ...
      <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman ">
  I am directed to forward herewith a certified copy of this Court's Order dated <b style="font-size: 13pt"  face= "Times New Roman "><?php echo $listed_dt; ?></b>, allowing the Transfer Petition above mentioned, for your information and necessary action. As such , you are required to send the entire Original Records of   in the matter above mentioned to this Hon'ble Court for being registered as Transferred Case.
       </font>
     </p>
    
     <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman ">
 As reuired by Order XL Rule 5(7) of the Supreme Court Rules, 2013, you are requested to get prepared and printed/photocopy one side only in accordance with the First Schedule of the Supreme Court Rules, 2013, sufficient number for copies of the record of Transferred Case as per rules, for the use of this Hon'ble Court, One of which shall be duly Index authenticated by you and transmit the same to this Hon'ble Court forthwith.
     </font>
     </p>

<p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
    <font  style="font-size: 13pt"  face= "Times New Roman ">
   If however, the record has been printed for the purpose of the case before the High Court and sufficient number of copies of the said printed record are available, the same be sent to this Hon'ble Court and such additional papers, as may be required. <U>Initially, at least five copies of the record be sent forthwith for the use of the Hon'ble Court.</U>
    </font>
</p>
<p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
    <font  style="font-size: 13pt"  face= "Times New Roman ">
As required by Order XL Rule 5(6) of the Supreme Court Rules, 2013, you are required to give notice to the parties regarding the transmission of the printed record and send the certificate of service to this Hon'ble Court forthwith, simultaneously with such transmission of printed record.
    </font>
</p>
