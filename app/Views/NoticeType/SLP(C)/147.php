...
?>
    ...
    <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman" >
            This is to inform you that Show Cause Notice issued to ...............- respondent No. ............. has been received back unserved in the Registry with the postal remarks
            "  ...............". You are, therefore, requested to take fresh steps for completion of service/ for bringing on record the LRs of the deceased etc within 28 days from the
            receipt of a copy of this letter failing which default will be reported to the Hon'ble Court.
        </font>
    </p>

    <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        <font  style="font-size: 13pt"  face= "Times New Roman" >
        You are also requested to collect the spare copies of the petition etc., which are received back unserved, from the Section within 28 days from the receipt of this letter
            failing which the same shall be destroyed without any further notice to you in this regard.
        </font>
    </p>
