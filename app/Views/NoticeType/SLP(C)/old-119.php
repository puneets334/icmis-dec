...
<!--   </p>-->
   ...
   <p align="left" style="margin: 0px;padding: 0px 0px 0px 2px;width: 50%;float: left" ><b><font  style="font-size: 13pt">Process Id: <?php echo $row['process_id'] ?>/<?php echo $row['rec_dt']; ?>(<?php echo 'Sec '. get_section($dairy_no); ?>)</font></b></p>
  ...
  $no_of_petitiner='';
   ...
   $doc_names='';
     for ($index22 = 0; $index22 < count($get_application_registration_all); $index22++) {
        ...
        ?>
            WHEREAS the <?php echo $res_fil_det['casename']  ?> under Section 25 of the Code of
      ...
      behalf of the above-named Petitioner(s). (Copy Enclosed) <br>
         ...
         AND WHEREAS the said petition along with an application for ex-parte Stay being called on for Preliminary hearing before this Court on the <b style="font-size: 13pt" face= "Times New Roman"><?php echo $listed_dt ?></b>, when the Court was pleased
...
<font  style="font-size: 13pt" face= "Times New Roman">
    ...
    <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
        <font  style="font-size: 13pt" face= "Times New Roman">
            You may file your affidavit in opposition to the petition as provided under Rule 3 Order XLI, S.C.R. 2013 by one week before date of listing.
        </font>
    </p>
    <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
        <font  style="font-size: 13pt" face= "Times New Roman">
