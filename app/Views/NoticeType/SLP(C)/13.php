...
<!--     <div style="font-size: 13pt;margin-bottom: 10px">
          (Appeal by Special Leave granted by this Court's Order dated the <b style="font-size: 13pt"><?php echo $listed_dt; ?></b> in Petition for 
       <b style="font-size: 13pt"><?php echo $get_misc_re[0] ?></b> <b style="font-size: 13pt"><?php echo $get_misc_re[1] ?></b> of <b style="font-size: 13pt"><?php echo $get_misc_re[2] ?></b> from the Judgment and Order dated the <b style="font-size: 13pt"><?php echo $judgement_dt; ?></b> 
   ...
   <div align="center" style="width: 100%;clear: both">
    ...
    <?php
      ...
      <p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
        ...
        <b style="font-size: 13pt" face= "Times New Roman"><?php echo $listed_dt; ?></b> when the Court directed issue of notice. 
