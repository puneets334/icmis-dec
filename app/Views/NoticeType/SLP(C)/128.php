...
<!--   </p>-->
   ...
   $cnt_con_case=0;
    for ($index3 = 0; $index3 < count($connected_cases); $index3++) {
        ...
        ?>
       The matter above-mentioned was listed for hearing before this Court on <b style="font-size: 13pt"  face= "Times New Roman"><?php echo $listed_dt ?></b> <?php if($cnt_con_case>0) { ?> along with the connected
  ...
  ?>"
     ...
     <p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
         <font  style="font-size: 13pt"  face= "Times New Roman">
    Take Notice that you are required to appear before the Co-ordinator, Supreme court Mediation Center at 110, Lawyer's Chamber (R.K.Jain Block) Supreme Court Compound, Tilak Marg, New Delhi-110001 on  as directed by the Order of this Hon'ble Court dated <b style="font-size: 13pt"  face= "Times New Roman"><?php echo $listed_dt ;?>.
...
<p style="text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px" align="justify">
    <font  style="font-size: 13pt"  face= "Times New Roman">
      (You are required to intimate the parties to appear before the Co-ordinator, Supreme Court Mediation Center at 110, Lawyer's Chamber ( R.K. Jain Block) Supreme Court Compound, Tilak Marg, New Delhi - 110001 on  ).
