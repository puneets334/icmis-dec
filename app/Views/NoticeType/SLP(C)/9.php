...
<u style="font-size: 13pt">IN</u>
  ...
  $first_listed_date=date('dS F, Y', strtotime($get_first_listed_date));
        ?>
     The matter above mentioned was listed before the Hon'ble Court on <b style="font-size: 13pt" face= "Times New Roman"><?php echo $first_listed_date ?></b> when the Court directed issue of notice. 
</font>
     </p>
