...
<p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
    <font  style="font-size: 13pt"  face= "Times New Roman ">
        The matter above mentioned after notice was listed before the Ld. Registrar  Court on <b style="font-size: 13pt"  face= "Times New Roman "><?php echo $listed_dt; ?></b>, with the service position when the following order was passed:
    </font>
</p>
<?php
...
<p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
    <font  style="font-size: 13pt"  face= "Times New Roman ">
       WHEREAS in the aforementioned petition it has been ordered that the notice be served upon the unserved Respondent through the Concerned Trial Court. Therefore,
        notice(in duplicate) is being sent to you for effecting service on the unserved Respondent.
    </font>
</p>

<p style="color: #000000;text-indent: 40px;padding: 0px 2px 0px 2px;margin: 10px 0px 0px 0px;clear: both" align="justify">
    <font  style="font-size: 13pt"  face= "Times New Roman ">t
       You are requested to kindly get the notice served in accordance with the law and submit the service report (Particularly in English Language) to this Hon'ble Court
        without delay.
    </font>
</p>
