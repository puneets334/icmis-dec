     ...
     $('#component_search').on('submit', function ()
            {
                ...
                if ($('#component_search').valid()) {
                    ...
                    if(validateFlag){
                        ...
                        $.ajax({
                            type: "POST",
                            url: "<?php echo base_url('Listing/VacationAdvanceList/get_addCase_details/'); ?>",
                            data: form_data,
                            beforeSend: function () {
...
$(document).on('click','#savebutton',function(e) {
   ...
   // var dataString = 'fil_no='+diary_no+'&usercode='+usercode;
    ...
    var CSRF_TOKEN_VALUE = $('[name="CSRF_TOKEN"]').val();
    $.ajax({
        data: {diary_no:diary_no,usercode:usercode,CSRF_TOKEN: CSRF_TOKEN_VALUE},
        type: "post",
        
        url: "<?php echo base_url('Listing/VacationAdvanceList/save_case_in_vacation_list/'); ?>",
        success: function(data){
            updateCSRFToken();
            alert("Vacation List: " + data);
        }
    });
});
    </script>
