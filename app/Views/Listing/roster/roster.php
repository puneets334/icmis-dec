...
<script type="text/javascript">
    ...
    <div id="dv_fixedFor_P" style="position: fixed;top:0;display: none;	left:0;	width:100%;	height:100%;z-index: 105; padding-right: 25px; padding-left: 15px;">
        <div id="sp_close" style="text-align: right;cursor: pointer;width: 40px;float: right" onclick="closeData()" ><b><img src="../../assets/images/close_btn.png" style="width:30px;height:30px"/></b></div>
