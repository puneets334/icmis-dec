            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header heading">
                        <div class="row">
                            <div class="col-sm-10">
                                <h3 class="card-title">CASES AVAILABLE IN POOL</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <form method="post">
                        ...
                        <div id="dv_content1">
                            <div class="">
                                        ...
                                        <td colspan="2">
                                            ...
                                            <fieldset>
                                                ...
                                                <select class="ele" name="kword[]" id="kword" multiple="multiple" size="8">
                                                    <option value="all" selected="selected">-ALL-</option>
                                                    <?php foreach ($f_keyword as $keyword): ?>
                                ...
                                <input type="hidden" id="md_name" name="md_name" value="pool" />
                                <input type="checkbox" name="forFixedDate" value="forFixedDate">Excess Matters after Allocation<br>
...
function get_record_t(){
    ...
    $.ajax({
        ...
        url: "<?php echo base_url('Listing/Pool/get_records/'); ?>",
