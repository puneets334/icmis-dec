            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header heading">
                        <div class="row">
                            <div class="col-sm-10">
                                <h3 class="card-title"> FINAL ELIMINATION LIST PRINT MODULE </h3>
                            </div>
                        </div>
                    </div>
                    <!-- Main content start -->
                                    ...
                                    <div id="dv_content1">
                                        <div class="form-row justify-content-center">
                                            <div class="form-group col-md-3">
                                                <label for="listing_dts">Final Elimination Dates</label>
...
function get_cl_1() {
    ...
    $.ajax({
        url: "<?php echo base_url('Listing/Elimination/get_cause_list_final_elimination'); ?>",
        cache: false,
        async: true,
        data: {
...
$(document).on("click", "#ebublish", function() {
    ...
    var CSRF_TOKEN_VALUE = $('[name="CSRF_TOKEN"]').val();
    $.ajax({
        url: "<?php echo base_url('Listing/Elimination/cl_print_save_final_elimination'); ?>",
        cache: false,
        async: true,
        data: {
            list_dt: listing_dts,
