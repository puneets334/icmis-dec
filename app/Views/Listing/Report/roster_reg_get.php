...
if (!empty($res)) {
?>
    <table width="100%" id="example" class="display" cellspacing="0" border ="1" style="font-family: verdana; font-size:12px;">
        <tr>
            ...
            <?php for ($i = 1; $i <= 15; $i++) { ?>
                <td width="3%" style="text-align: center; font-weight: bold; color: #dce38d;background: #918788;"></td>
            <?php } ?>
            <?php
        ...
        <tr>
            ...
            <td colspan="15" align="center">Note :
                ...
                (4) Pendency: <?php echo $ros['count']; ?></td>
