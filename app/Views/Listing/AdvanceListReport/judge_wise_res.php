            ...
            if(isset($date_result) && sizeof($date_result)>0 ){
                ...
                <div id="printable">
                    <table class="table table-striped table-hover ">
                        <thead>
                        <tr align="center"><h1 align="center"><?php echo $date_result[0]['jname'];?> </h1></tr>
                        <tr><h4 align="center">Report generated on <?php echo date('d-m-Y H:m:s A' );?></h4></tr>
                        <tr>
                            <th><b>#</b></th>
                            <th><b>CL Date</b></th>
                        ...
                        {$i++;
                            ...
                            <tr>
                                ...
                                <td style="font-weight:bold;"><?php echo $result['fd_not_list']+$result['frs_adj_not_list']+$result['inperson_not_list']
                                    +$result['bail_not_list']+$result['aw_not_list']+$result['imp_ia_not_list']
                                    +$result['nradj_not_list']+$result['notice_not_list']+$result['fdisp_not_list']
                                    +$result['oth_not_list'];?></td></tr>
                        ...
                        ?>
                        <tr style="font-weight: bold;"><td colspan="2"><b>Total</b></td><td><b><?php echo $total_fd;?></b></td>
                            <td><b><?php echo $total_frs;?></b></td><td><b><?php echo $total_inperson;?></b></td>
                            <td><b><?php echo $total_bail;?></b></td><td><b><?php echo $total_aw;?></b></td>
                            <td><b><?php echo $total_ia;?></b></td><td><b><?php echo $total_ntu;?></b></td>
                            <td><b><?php echo $total_notice;?></b></td><td><b><?php echo $total_fdsp;?></b></td>
                            <td><b><?php echo $total_misc;?></b></td><td><b><?php echo $total;?></td></b></tr>
