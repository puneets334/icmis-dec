...
<tr>
    <td>
        <input type="checkbox" name="chk_id<?php echo $sno; ?>" class="" id="chk_id<?php echo $sno; ?>" style="background-color:  black" <?php if ($ck_en_nt == '1') {  ?> checked="checked" <?php } else if ($ck_en_nt == '0') {  ?> checked="checked" <?php } ?> />
    </td>
    <td style="width: 23%;" id="td_cell_s<?php echo $sno; ?>">
        <textarea id="sp_nm<?php echo $sno; ?>" style="resize:none;width: 80%" class="form-control" onfocus="clear_data(this.id)"><?php if ($ck_en_nt == '1') { echo !empty($row_office) ? $row_office['name'] : ''; } ?></textarea>
        <input type="hidden" name="hd_sr_no<?php echo $sno; ?>" id="hd_sr_no<?php echo $sno; ?>" value="<?php if ($ck_en_nt == '1') { echo !empty($row_office) ? $row_office['sr_no'] : ''; } ?>" />
        <input type="hidden" name="hd_pet_res<?php echo $sno; ?>" id="hd_pet_res<?php echo $sno; ?>" class="form-control" value="<?php if ($ck_en_nt == '1') { echo !empty($row_office) ? $row_office['pet_res'] : ''; } ?>" />
    </td>
    <td style="width: 23%;">
        <textarea id="sp_add<?php echo $sno; ?>" style="resize:none;width: 80%" class="form-control" onfocus="clear_data(this.id)"><?php if ($ck_en_nt == '1') { echo !empty($row_office) ? $row_office['address'] : ''; } ?></textarea>
    </td>
    <td style="width: 9%;">
        <div>
            <select name="ddlState<?php echo $sno; ?>" id="ddlState<?php echo $sno; ?>" class="form-control" onchange="getCity(this.value,this.id,'0')" style="width: 120px" onfocus="clear_data(this.id)">
        ...
        <div style="margin-top: 10px">
            <select name="ddlCity<?php echo $sno; ?>" id="ddlCity<?php echo $sno; ?>" class="form-control" style="width: 100%" onfocus="clear_data(this.id)">
                <option value="">Select</option>
                <?php
                if ($ck_en_nt == '1') {
                    $get_districts =  !empty($row_office) ? get_citys($row_office['state']) : '';
                    if(!empty($get_districts)){
                    foreach ($get_districts as $k2) {
                        $key2 =  explode('^', $k2);
                ?>
                        <option value="<?php echo $key2[0]; ?>" <?php if ($key2[0] == $row_office['city']) { ?> selected="selected" <?php }  ?>><?php echo $key2[1]; ?></option>
                    <?php
                    }
                }
                    if (($row1['city'] == NULL || $row1['city'] == 0) && $ck_en_nt == '1') {
                    ?>
                        <option value="0" selected="selected">None</option>
                    <?php
                    }
    ...
    <td style="width: 30%;">
        <select name="ddl_nt<?php echo $sno; ?>" id="ddl_nt<?php echo $sno; ?>" class="form-control" style="width: 100%;" onfocus="clear_data(this.id)" <?php if ($ck_en_nt == '1' && preg_match('/,/', $ck_en_nt_x['nt_type'])) {  ?> multiple="multiple" <?php } ?> onchange="get_wh_p_r(this.value,this.id)">
            <option value="">Select</option>
            <?php
            foreach ($c_case as $k) {
                $key =  explode('^', $k);
            ?>
                <option value="<?php echo $key[0]; ?>" <?php if ( !empty($row_office)  && ($key[0] == $row_office['nt_type'])) { ?> selected="selected" <?php } ?>><?php echo $key[1]; ?></option>
            <?php
            }
            ?>
    ...
    <td style="width: 6%;">
        <input type="text" size="9" name="txtAmount<?php echo $sno; ?>"
            id="txtAmount<?php echo $sno; ?>" class="form-control"
                ...
                <tr style="border: 0px;border-color: white">
                    <td>
                        <input class="cl_del_mod<?php echo $sno; ?>" value="<?php echo $sht_nm; ?>" title="<?php echo $del_mode; ?>" type="checkbox"
                            ...
                            onclick="show_hd(this.id)" <?php if ($ck_en_nt == 1) echo $ck_not; ?> <?php if ($ck_en_nt == 0 && $sht_nm == 'O') { ?> checked="checked" <?php } ?> />&nbsp;
                    ...
                    <td>
                        ...
                        <div class="row">
                        <div class="col-3">
                        <select name="ddl_send_type<?php echo $mode . $sno; ?>" id="ddl_send_type<?php echo $mode . $sno; ?>" onchange="get_send_to_type(this.id,this.value,'1','<?php echo $mode; ?>')" class="form-control">
                            <option value="">Select</option>
                        ...
                        <div class="col-3">
                        <select name="ddlSendTo_<?php echo $mode . $sno; ?>" id="ddlSendTo_<?php echo $mode . $sno; ?>" onfocus="clear_data(this.id)" onchange="get_nms(this.value,this.id)" style="width: 130px" class="form-control">
                            <option value="">Select</option>
                            <?php
                        ...
                        if ($ck_en_nt == '0' && $mode == 'o') {
                            ...
                            if ($row_crt_adv['ct_code'] != '3') {
                                ...
                                if ($dist_court->getNumRows() > 0) {
                                    $district_code = $dist_court->getRow()->id_no;
                                }
                            } else {
                        ...
                        ?>
                        <select name="ddl_sndto_state_<?php echo $mode . $sno; ?>" id="ddl_sndto_state_<?php echo $mode . $sno; ?>" style="width: 100px" onchange="getCity(this.value,this.id,'1','<?php echo $mode; ?>')" class="form-control">
                            <option value="">Select</option>
                            <?php
                            foreach ($get_states as $k2) {
                                $key2 =  explode('^', $k2);
                        ...
                        <div class="col-3">
                        <select name="ddl_sndto_dst_<?php echo $mode . $sno; ?>" id="ddl_sndto_dst_<?php echo $mode . $sno; ?>" style="width: 100px" class="form-control">
                            <option value="">Select</option>
                            <?php
                    ...
                    <td>
                        ...
                        <div class="row">
                        <div class="col-3">
                            <select name="ddl_send_copy_type<?php echo $mode . $sno; ?>" id="ddl_send_copy_type<?php echo $mode . $sno; ?>" onchange="get_send_to_type(this.id,this.value,'2','<?php echo $mode; ?>')" class="form-control">
                                <option value="">Select</option>
                        ...
                        <div class="col-3">
                            <select name="ddlSendCopyTo_<?php echo $mode . $sno; ?>" id="ddlSendCopyTo_<?php echo $mode . $sno; ?>" onfocus="clear_data(this.id)" style="width: 130px" class="form-control">
                                <option value="">Select</option>
                                <?php
                                if ($ck_en_nt == '1' || $ck_en_nt == '0') {
                                    $s_to_d = '';
                        ...
                        <div class="col-3">
                            <select name="ddl_cpsndto_state_<?php echo $mode . $sno; ?>" id="ddl_cpsndto_state_<?php echo $mode . $sno; ?>" style="width: 100px" onchange="getCity(this.value,this.id,'2','<?php echo $mode; ?>')" class="form-control">
                                <option value="">Select</option>
                                <?php
                                foreach ($get_states as $k2) {
                                    $key2 =  explode('^', $k2);
                        ...
                        <div class="col-3">
                            <select name="ddl_cpsndto_dst_<?php echo $mode . $sno; ?>" id="ddl_cpsndto_dst_<?php echo $mode . $sno; ?>" style="width: 100px" class="form-control">
                                <option value="">Select</option>
                                <?php
                            ...
                            <div id="dv_ext_cst<?php echo $mode . $sno; ?>">
                                ...
                                ?>
                                            ...
                                            <div class="row">
                                            <div class="col-3">
                                                <select name="ddl_send_copy_type<?php echo $mode . $sno; ?>_<?php echo $index4; ?>" id="ddl_send_copy_type<?php echo $mode . $sno; ?>_<?php echo $index4; ?>" class="form-control">
                                                    <option value="">Select</option>
                                                    <option value="2" <?php if ($c_sendto_type == 2 && $ck_en_nt == '1') { ?> selected="selected" <?php } ?>>Other</option>
                                            ...
                                            <div class="col-3">
                                                <select name="ddlSendCopyTo_<?php echo $mode . $sno; ?>_<?php echo $index4; ?>" id="ddlSendCopyTo_<?php echo $mode . $sno; ?>_<?php echo $index4; ?>" onfocus="clear_data(this.id)" style="width: 130px;" class="form-control">
                                                    <option value="">Select</option>
                                                    <?php
                                                    if ($ck_en_nt == '1') {
                                                        $s_to_d = '';
                                            ...
                                            <div class="col-3">
                                                <select name="ddl_cpsndto_state_<?php echo $mode . $sno; ?>_<?php echo $index4; ?>" id="ddl_cpsndto_state_<?php echo $mode . $sno; ?>_<?php echo $index4; ?>" style="width: 100px" onchange="getCity(this.value,this.id,'3','r')" class="form-control">
                                                    <option value="">Select</option>
                                                    <?php
                                                    foreach ($get_states as $k2) {
                                                        $key2 =  explode('^', $k2);
                                            ...
                                            <div class="col-3">
                                                <select name="ddl_cpsndto_dst_<?php echo $mode . $sno; ?>_<?php echo $index4; ?>" id="ddl_cpsndto_dst_<?php echo $mode . $sno; ?>_<?php echo $index4; ?>" style="width: 100px" class="form-control">
                                                    <option value="">Select</option>
                                                    <?php
                                                    if ($c_sendto_district != '') {
                                                        $get_districts = get_citys($c_sendto_state);
                                    ...
                                    for ($index4 = 1; $index4 < $t_sno; $index4++) {
                                        ...
                                        <div class="row">
                                        <div class="col-3">
                                            <select name="ddl_send_copy_type<?php echo $mode . $sno; ?>_<?php echo $indexx; ?>" id="ddl_send_copy_type<?php echo $mode . $sno; ?>_<?php echo $indexx; ?>" class="form-control">
                                                <option value="">Select</option>
                                        ...
                                        <div class="col-3">
                                            <select name="ddlSendCopyTo_<?php echo $mode . $sno; ?>_<?php echo $indexx; ?>" id="ddlSendCopyTo_<?php echo $mode . $sno; ?>_<?php echo $indexx; ?>" onfocus="clear_data(this.id)" style="width: 130px;" class="form-control">
                                                <option value="">Select</option>
                                                <?php
                                                if ($ck_en_nt == '0') {
                                                    $s_to_d = '';
                                        ...
                                        <div class="col-3">
                                            <select name="ddl_cpsndto_state_<?php echo $mode . $sno; ?>_<?php echo $indexx; ?>" id="ddl_cpsndto_state_<?php echo $mode . $sno; ?>_<?php echo $indexx; ?>" style="width: 100px" onchange="getCity(this.value,this.id,'3','r')" class="form-control">
                                                <option value="">Select</option>
                                                <?php
                                                foreach ($get_states as $k2) {
                                                    $key2 =  explode('^', $k2);
                                        ...
                                        <div class="col-3">
                                            <select name="ddl_cpsndto_dst_<?php echo $mode . $sno; ?>_<?php echo $indexx; ?>" id="ddl_cpsndto_dst_<?php echo $mode . $sno; ?>_<?php echo $indexx; ?>" style="width: 100px" class="form-control">
                                                <option value="">Select</option>
                                                <?php
                                                $get_districts = get_citys('490506');
                                                foreach ($get_districts as $k2) {
                            ...
                            <input type="hidden" name="hd_Sendcopyto_<?php echo $mode . $sno; ?>" id="hd_Sendcopyto_<?php echo $mode . $sno; ?>" value="<?php echo $ini_val; ?>" class="form-control" />
                        </div>
                    </td>
                </tr>
            <?php } ?>
        </table>
        <input type="hidden" name="hd_new_upd<?php echo $sno; ?>" id="hd_new_upd<?php echo $sno; ?>" value="<?php echo 0; ?>" />
        <input type="hidden" name="hd_mn_id<?php echo $sno; ?>" id="hd_mn_id<?php echo $sno; ?>" value="<?php if ($ck_en_nt == '1') { echo $row_office['id']; } ?>" />
    </td>
</tr>