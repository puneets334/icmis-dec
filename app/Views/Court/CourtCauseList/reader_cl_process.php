        ...
        $cntr += 1; {
            ...
            if ($mf == "F") {
                ...
                if (!empty($row1_s)) {
                    ...
                    if (isset($row1_s["stagecode4"]) && $row1_s["stagecode4"] > 0)
                        $t_stage = $row1_s["grp_name"] . " - " . $row1_s["grp_name1"] . " - " . $row1_s["grp_name2"] . " - " . $row1_s["stagename"];
                    elseif (isset($row1_s["stagecode3"]) && $row1_s["stagecode3"] > 0)
                        $t_stage = $row1_s["grp_name"] . " - " . $row1_s["grp_name1"] . " - " . $row1_s["stagename"];
                    elseif (isset($row1_s["stagecode2"]) && $row1_s["stagecode2"] > 0)
                        $t_stage = $row1_s["grp_name"] . " - " . $row1_s["stagename"];
                    elseif (isset($row1_s["stagecode1"]) && $row1_s["stagecode1"] > 0)
