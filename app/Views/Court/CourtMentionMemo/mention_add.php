                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-5">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" class="form-control dtp" name="mmPresentedDate" id="mmPresentedDate" placeholder="dd-mm-yyyy" required autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-5">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" class="form-control dtp" name="mmDecidedDate" id="mmDecidedDate" placeholder="dd-mm-yyyy" required="required" autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-5">
