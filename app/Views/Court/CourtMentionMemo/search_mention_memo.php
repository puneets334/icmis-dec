            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                       ...
                       echo form_open(base_url('Court/CourtMentionMemoController/mention_memo_search'), $attribute);
                        ?>
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" id="diary_number" name="diary_number" value="" placeholder="Enter Diary No" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        ...
                                        <select name="diary_year" id="diary_year" class="custom-select" required>
                                            <?php for ($x = $current_year; $x >= $year; $x--) { if ((!empty($diary_year) &&  $x==$diary_year)) {  $sel = 'selected=selected';  }else{$sel='';} ?>
