...
<div class="tab-content" id="pills-tabContent">
	...
	<div id="datewise_matters">
		<?php
//echo "AYAY";
//		 echo "<pre>";
//		 print_r($datewise_matters);die;
		if (isset($datewise_matters) && sizeof($datewise_matters) > 0) {
		...
		?>
			...
			<table id="example1" class="table table-striped table-bordered custom-table" style="width:100%">
				...
				<tbody>
					...
					foreach ($datewise_matters as $result) {
					?>
						<tr id="<?= $result['efiling_no'] ?>">
							<td><?php echo $i++; ?></td>
							<td onclick="efiling_number('<?php echo $result['efiling_no']; ?>')"><u><b><?php echo $result['efiling_no']; ?></u></b></td>
							...
							<td><?php echo empty($result['processed_by'])?'<span style="color:red;">In process</span>':'<span style="color:#4EA405;">Completed</span>'  ?></td>
