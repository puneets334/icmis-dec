                            ...
                            <div id="show_fil">
                                ...
                                <div class="card-body">
                                            ...
                                            <div class="row ">
                                                <div class="col-md-4">
                                                    <div class="form-group row">
                                                        <label  class="col-form-label">Court Type<span class="text-red">*</span> :</label>
                                                        <div class="">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group row">
                                                        <label  class=" col-form-label">Court Bench <span class="text-red">*</span> :</label>
                                                        <div class=" ">
                                            ...
                                            <div class="row ">
                                                <div class="col-md-4">
                                                    <div class="form-group row">
                                                        <label class=" col-form-label">Case Type <span class="text-red">*</span> :</label>
                                                        <div class=" ">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group row">
                                                        <label for="inputEmail3" class=" col-form-label">Section <span class="text-red">*</span></label>
                                                        <div class=" ">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group row">
                                                        <label for="inputEmail3" class=" col-form-label">Special Type</label>
                                                        <div class=" ">
                                                ...
                                                <div class="col-md-4 sp_doc_signed" id="sp_doc_signed" style="display: none;">
                                                    <div class="form-group row">
                                                        <label class=" col-form-label">Date of document signed by jailer <span class="text-red">*</span> :</label>
                                                        <div class=" ">
                                            ...
                                            <div class="row align-items-end">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <label class=" col-form-label">
                                                            <input type="radio" name ="sel" id="c" onclick="check(this.id)" checked="checked">Case Type
                                                        </label>
                                                        </div>
                                                        <div class=" ">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <div class="row row-mx-0">
                                                            <div class="col-sm-12">
                                                            <label class=" col-form-label">OR   <input type="radio" name ="sel" id="d" onclick="check(this.id)"> Diary No. </label>
                                                            </div>
                                                            <div class="col-sm-12 col-md-6 col-lg-6 pl-0">
                                                            <label class=" col-form-label">Diary No.</label>
                                            ...
                                            <div class="row justify-content-center mb-3">
                                                <div class="col-md-1">
                                                        ...
                                                        <button type="button" class="btn btn-success" value="Search" onclick="f1()" id="sbtn">Search</button>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    <label class=" col-form-label text-red">Extreme Priority Category</label>
                                                    <div class=" ">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    <label class=" col-form-label">Total No. of Pages in File</label>
                                                    <div class=" ">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    <label for="inputEmail3" class=" col-form-label">IF SCLSC</label>
                                                    <div class="col-sm-7">
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                            ...
                                                            <input type="text" class="form-control" name="txt_sclsc_no" id="txt_sclsc_no" disabled size="4" onkeypress="return onlynumbers(event)" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');" value="<?=!empty($sclsc) ? $sclsc['sclsc_diary_no'] : ''; ?>" placeholder="Enter No.">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4 sp_no_yr" id="sp_no_yr" style="display: none">
                                                <div class="form-group row">
                                                    <label for="inputEmail3" class=" col-form-label">SCLSC Year <span class="text-red">*</span> :</label>
                                                    <div class=" ">
...
<hr/>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group row">
                                                        <label for="inputEmail3" class=" col-form-label">Party Type <span class="text-red">*</span> :</label>
                                                        <div class=" ">
                                            ...
                                            <div id="for_I_p">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            <label for="name" class=" col-form-label">Name <span class="text-red">*</span> :</label>
                                                            <div class=" ">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            <label for="name" class=" col-form-label">Father/Husband :</label>
                                                            <div class=" ">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            <label for="Relation" class=" col-form-label">Gender :</label>
                                                            <div class=" ">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            <label for="petitioner_age" class=" col-form-label">Age :</label>
                                                            <div class=" ">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            <label for="Occupation/Department" class=" col-form-label">Occupation/Department :</label>
                                                            <div class=" ">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            <label for="Country" class=" col-form-label">Country <span class="text-red">*</span> :</label>
                                                            <div class=" ">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            <label for="Occupation/Department" class=" col-form-label">Address<span class="text-red">*</span> :</label>
                                                            <div class=" ">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            <label for="Occupation/Department" class=" col-form-label">Pin Code :</label>
                                                            <div class=" ">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            <label for="Occupation/Department" class=" col-form-label">Tehsil/City<span class="text-red">*</span> :</label>
                                                            <div class=" ">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            <label for="Country" class=" col-form-label">State<span class="text-red">*</span> :</label>
                                                            <div class=" ">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            <label for="Country" class=" col-form-label">District<span class="text-red">*</span> :</label>
                                                            <div class=" ">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            <label for="petitioner_email" class=" col-form-label">Phone/Mobile :</label>
                                                            <div class=" ">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            <label for="petitioner_email" class=" col-form-label">Email Id:</label>
                                                            <div class=" ">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            <label for="inputEmail3" class=" col-form-label">Total Petitioner(s) :</label>
                                                            <div class=" ">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group row clearfix">
                                                            <label for="State" class=" col-form-label" id='for_D_p_sn1'><div class="icheck-primary d-inline">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group row clearfix">
                                                            <label for="State" class=" col-form-label"><div class="icheck-primary d-inline">
                                ...
                                <hr/>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group row">
                                                        <label for="Party-Type" class=" col-form-label">Party Type<span class="text-red">*</span> :</label>
                                                        <div class=" ">
                                                ...
                                                <div class="form-group clearfix">
                                                    <div class="icheck-primary d-inline">
                                                        ...
                                                        <input type="checkbox" name="copy_add" id="copy" onclick="copy_address()">
                                                        <label for="copy"> Address same as above</label>
                                                    </div>
                                                </div>
                                            ...
                                            <div  id="for_I_r">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            <label for="inputEmail3" class=" col-form-label">Name<span class="text-red">*</span> :</label>
                                                            <div class=" ">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            <label for="Party-Type" class=" col-form-label">Relation :</label>
                                                            <div class=" ">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            <label for="inputEmail3" class=" col-form-label">Father/Husband :</label>
                                                            <div class=" ">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            <label for="Party-Type" class=" col-form-label">Gender :</label>
                                                            <div class=" ">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            <label  class=" col-form-label">Occupation/Department :</label>
                                                            <div class=" ">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            <label  class=" col-form-label">Phone/Mobile :</label>
                                                            <div class=" ">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            <label for="inputEmail3" class=" col-form-label">Total Respondent(s) :</label>
                                                            <div class=" ">
                                            ...
                                            <div id="for_D_r" style="display: none">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            <label for="State" class=" col-form-label" id='for_D_r_sn1'>
                                                                <div class="icheck-primary d-inline">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            <label for="respondent_causetitle3" class=" col-form-label"><div class="icheck-primary d-inline">
                                ...
                                <hr/>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    <label for="inputEmail3" class=" col-form-label">Main Pet. Adv. <span class="text-red">*</span> :</label>
                                                    <div class=" ">
                                            ...
                                            <div class="col-md-4" id="padv_state">
                                                <div class="form-group row">
                                                    <label  class=" col-form-label">Enrol State <span class="text-red">*</span> :</label>
                                                    <div class=" ">
                                            ...
                                            <div class="col-md-4" id="padvno_">
                                                <div class="form-group row">
                                                    <label for="inputEmail3" class=" col-form-label">AOR-Code/Enrol.<span class="text-red">*</span> :</label>
                                                    <div class=" ">
                                                        <input type="text" class="form-control" id="padvno" size="25" onblur="getAdvocate_for_main(this.id,'P')"  placeholder="AOR code/Name:/Enrol No">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4" id="padvyr_">
                                                <div class="form-group row">
                                                    <label for="inputEmail3" class=" col-form-label">Year <span class="text-red">*</span> :</label>
                                                    <div class=" ">
                                            ...
                                            <div class="col-md-4" id="padvemail_">
                                                <div class="form-group row">
                                                    <label for="inputEmail3" class=" col-form-label">Email Id</label>
                                                    <div class=" ">
                                       ...
                                       <!-- <hr/>-->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    <label for="inputEmail3" class=" col-form-label">Main Res. Adv. <span class="text-red">*</span> :</label>
                                                    <div class=" ">
                                            ...
                                            <div class="col-md-4" id="radvno_">
                                                <div class="form-group row">
                                                    <label for="inputEmail3" class=" col-form-label">AOR code/Name:/Enrol No <span class="text-red">*</span> :</label>
                                                    <div class=" ">
                                                        <input type="text" class="form-control" id="radvno" size="25"  onblur="getAdvocate_for_main(this.id,'R')"  placeholder="Enrol No.(Non-AOR)">
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <center>
                                <button type="button" id="reset_btn" class="quick-btn mt-26">Reset</button>
                ...
                $.ajax({
                    ...
                    success: function (resData)
                    {
                        if(resData){
                            ...
                            if(singleObj){
                                $('#selrdisd').val('');
                                $('#selrdisd').val(singleObj.id).select2().trigger("change");
                            }
                            else{
                                $('#selrdisd').val('');
                            }
    ...
    <script>
        function check(browser) {
            ...
            if(browser=='c')   // case type is selected
            {
                ...
                document.getElementById('diary_no').disablecall_save_maind=true;
