                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ((!empty($row['scheduler_datetime']) && !empty($row['endpoint_transaction_id']))) { ?>
                                <a class="text-danger" href="https://www.shcileservices.com/OnlineE-Payment/sEpsPaymentChallan?userid=dlsupcourt&shcilrefno=<?= $row['endpoint_transaction_id']; ?>" target="_blank">Download</a>
                        </td>
