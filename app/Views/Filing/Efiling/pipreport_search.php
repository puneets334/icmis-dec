                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php }else{?>
                                        <br/>
                                    <?php }?>
                                   <h5 class="box-title  pl-4">FILING/REFILING/ADDITIONAL DOCUMENT REPORT RELATED TO IN - PERSONS MATTERS </h5>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-2">
                                            <label>&nbsp;</label>
                                            <button type="submit" id="btn-shift-assign" class="btn btn-block  btn-flat pull-right btn btn-primary mt-4"><i class="fa fa-save"></i> Search </button>
                                            </button>
                                        </div>
