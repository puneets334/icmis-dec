                        ...
                        <div id="dv_content1">
                            ...
                            <div id="show_fil">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <input type="hidden" id="t_h_cyt" name="t_h_cyt" maxlength="4" size="4" value="<?php if ($filing_details) {
                                                                                                                        echo substr($filing_details['diary_no'], -4);
                                                                                                                    } else {
                                                                                                                        echo date('Y');
                                                                                                                    }  ?>" />
                                    <div class="row ">
                                                    ...
                                                    <select name="ddl_st_agncy" id="ddl_st_agncy" class="form-control" <?php if (($fetch_rw['casetype_id'] == 9 || $fetch_rw['casetype_id'] == 10 || $fetch_rw['casetype_id'] == 25 || $fetch_rw['casetype_id'] == 26 || $fetch_rw['casetype_id'] == 19 || $fetch_rw['casetype_id'] == 20 || $fetch_rw['casetype_id'] == 39)  && $sec == 19 && $utype <> 4 && $allow_user != 1) { ?> disabled="true" <?php } ?>>
                                                        ...
                                                        foreach ($state as $row) {
                                                            if (isset($row['cmis_state_id'])) {
                                                                if ($fetch_rw['ref_agency_state_id'] == $row['cmis_state_id']) {
                                                                    $sel = 'selected=selected';
                                                                } else {
                                                                    $sel = '';
                                                                }
                                                ...
                                                <div class="col-sm-7">
                                                    <select name="ddl_bench" id="ddl_bench" class="form-control">
                                                        ...
                                                        foreach ($hc_benches as $row) {
                                                           ...
                                                           // if (isset($row['cmis_state_id'])) {
                                                                if ($fetch_rw['ref_agency_code_id'] == $row['id']) {
                                                                    $sel = 'selected=selected';
                                                                } else {
                                                                    $sel = '';
                                                                }
                                    ...
                                    <div class="row ">
                                        <div class="col-md-4">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <select name="ddl_nature" id="ddl_nature" class="form-control" <?php if (($fetch_rw['casetype_id'] == 9 || $fetch_rw['casetype_id'] == 10 || $fetch_rw['casetype_id'] == 25 || $fetch_rw['casetype_id'] == 26 || $fetch_rw['casetype_id'] == 19 || $fetch_rw['casetype_id'] == 20 || $fetch_rw['casetype_id'] == 39)  && $sec == 19 && $utype <> 4 && $allow_user != 1) {
                                                                                                                        echo " in loop"; ?> disabled="true" <?php } ?>>
                                                        <option value="">Select case type</option>
                                                        <?php $sel = '';
                                                        foreach ($casetype as $row) {
                                                            if ($fetch_rw['casetype_id'] == $row['casecode']) {
                                                                $sel = 'selected=selected';
                                                            } else {
                                                                $sel = '';
                                                            }
                                    ...
                                    <div class="row" id="lct_casetype" style="display: none;">
                                        ...
                                        <div class="col-md-1">
                                            ...
                                            <div class="btn btn-success" value="Search" onclick="f1()" id="sbtn" />Search
                                        </div>
                                    </div>
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                            <input type="checkbox" name="if_sclsc" id="if_sclsc" onchange="is_if_sclsc(this.value)" <?php if (!empty($fetch_rw) && $fetch_rw["if_sclsc"] == 1) {
                                                                                                                                                        echo "checked";
                                                                                                                                                    } ?>>
                                                        </span>
                                                    </div>
                                                    <input type="text" class="form-control" name="txt_sclsc_no" id="txt_sclsc_no" size="4" onkeypress="return onlynumbers(event)" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');"
                                                    <?php if ($fetch_rw["if_sclsc"] == 0 || $fetch_rw["if_sclsc"] == '') { ?> disabled <?php } ?> value="<?= !empty($sclsc) ? $sclsc['sclsc_diary_no'] : ''; ?>" placeholder="Enter No.">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                            <input type="checkbox" name="if_efil" id="if_efil" onchange="is_if_efil(this.value)" <?php if ($fetch_rw["ack_id"] != 1 && $fetch_rw["ack_id"] != '' && $fetch_rw["ack_id"] != 0) {
                                                                                                                                                        echo "checked";
                                                                                                                                                    } ?>>
                                                        </span>
                                                    </div>
                                                    <input type="text" class="form-control" name="txt_efil_no" id="txt_efil_no" size="4" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');" 
                                                    <?php if ($fetch_rw["ack_id"] == 0 || $fetch_rw["ack_id"] == '') { ?> disabled <?php } ?> value="<?= (!empty($fetch_rw) && $fetch_rw['ack_id'] > 0  ) ? $fetch_rw['ack_id'] : ''; ?>" placeholder="Enter No.">
                                ...
                                <div id="for_I_p">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <select id="selprel" name="selprel" onchange="setSex(this.value,this.id)" class="form-control" disabled>
                                                        <option value="">Select</option>
                                                        <option value="S" <?= !empty($pet_rw['sonof']) && (trim($pet_rw['sonof']) == 'S') ? 'selected="selected"' : ''; ?>>Son of</option>
                                                        <option value="D" <?= !empty($pet_rw['sonof']) && (trim($pet_rw['sonof']) == 'D') ? 'selected="selected"' : ''; ?>>Daughter of</option>
                                                        <option value="W" <?= !empty($pet_rw['sonof']) && (trim($pet_rw['sonof']) == 'W') ? 'selected="selected"' : ''; ?>>Wife of</option>
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="col-sm-7">
                                                    <select id="p_conti" name="p_conti" onchange="setCountry_state_dis(this.id,this.value)" class="form-control" disabled>
                                                        ...
                                                        foreach ($country as $row) { ?>
                                                            <option value="<?php echo $row['id']; ?>" <?php if (!empty($pet_rw['country']) && $pet_rw['country'] == $row['id']) {
                                                                                                            echo "Selected";
                                                                                                        } else {
                                                                                                            if ($row['id'] == '96') {
                                                                                                                echo "Selected";
                                                ...
                                                <div class="col-sm-7">
                                                    <select id="selpsti" name="selpsti" onchange="getDistrict('P',this.id,this.value)" class="form-control" <?php if (@$pet_rw['country'] != '96') echo "disabled"; ?> disabled>
                                                        ...
                                                        foreach ($state_list as $row) {
                                                            if (isset($row['cmis_state_id'])) {
                                                                if ($row['cmis_state_id'] == @$pet_rw['state']) {
                                                                    $sel = 'selected=selected';
                                                                } else {
                                                                    $sel = '';
                                                                }
                                                    ...
                                                    <select id="selpdisi" name="selpdisi" class="form-control" <?php if (@$pet_rw['country'] != '96') echo "disabled"; ?>disabled>
                                                        ...
                                                        if (!empty($pet_dist_list)) {
                                                            foreach ($pet_dist_list as $row) {
                                                                if ($pet_rw['city'] == 0) {
                                                                    echo '<option  value="' . sanitize((@$pet_rw['city'])) . '" selected>Not Mention</option>';
                                                                }

                                                                if ($row['id_no'] == @$pet_rw['city']) {
                                                                    $sel = 'selected=selected';
                                                                } else {
                                                                    $sel = '';
                                                                }
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group row">
                                                <label for="petitioner_email" class="col-sm-5 col-form-label">Phone/Mobile :</label>
                                                <div class="col-sm-7">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group row clearfix">
                                                    <label for="State" class="col-sm-5 col-form-label" id='for_D_p_sn1'>
                                ...
                                <div class="col-md-12 mt-5mb-3">
                                    ...
                                    <?php $p_sno = 0;
                                    if (!empty($additional_address_p)) {
                                        foreach ($additional_address_p as $row) {
                                            $p_sno++;
                                        }
                                    } ?>
                                ...
                                if (!empty($res_rw['pflag']) &&  $res_rw['pflag'] != 'P') { ?>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <select id="selrrel" name="selrrel" onchange="setSex(this.value,this.id)" class="form-control" disabled>
                                                        <option value="">Select</option>
                                                        <option value="S" <?= !empty($res_rw['sonof']) && (trim($res_rw['sonof']) == 'S') ? 'selected="selected"' : ''; ?>>Son of</option>
                                                        <option value="D" <?= !empty($res_rw['sonof']) && (trim($res_rw['sonof']) == 'D') ? 'selected="selected"' : ''; ?>>Daughter of</option>
                                                        <option value="W" <?= !empty($res_rw['sonof']) && (trim($res_rw['sonof']) == 'W') ? 'selected="selected"' : ''; ?>>Wife of</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <select id="r_conti" name="r_conti" class="form-control" onchange="setCountry_state_dis(this.id,this.value)" disabled>
                                                        ...
                                                        <?php
                                                        foreach ($country as $row) { ?>
                                                            <option value="<?php echo $row['id']; ?>" <?php if (!empty($res_rw['country']) && $res_rw['country'] == $row['id']) {
                                                                                                            echo "Selected";
                                                                                                        } else {
                                                                                                            if ($row['id'] == '96') {
                                                                                                                echo "Selected";
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <select id="selrsti" name="selrsti" class="form-control" onchange="getDistrict('R',this.id,this.value)" disabled>
                                                        ...
                                                        foreach ($state_list as $row) {
                                                            if (isset($row['cmis_state_id'])) {
                                                                if (!empty($res_rw['state']) && $res_rw['state'] == $row['cmis_state_id']) {
                                                                    $sel = 'selected=selected';
                                                                } else {
                                                                    $sel = '';
                                                                }
                                                    ...
                                                    <select id="selrdisi" name="selrdisi" class="form-control" disabled>
                                                        ...
                                                        if (!empty($res_dist_list)) {
                                                            foreach ($res_dist_list as $row) {
                                                                if ($res_rw['city'] == 0) {
                                                                    echo '<option  value="' . sanitize(($res_rw['city'])) . '" selected>Not Mention</option>';
                                                                }

                                                                if ($row['id_no'] == $res_rw['city']) {
                                                                    $sel = 'selected=selected';
                                                                } else {
                                                                    $sel = '';
                                                                }
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" class="form-control" id="r_noi" name="r_noi" value="<?php echo $fetch_rw['rno'] ?? '' ?>" size="3" maxlength="4" onkeypress="return onlynumbers(event)" value="1" placeholder="Enter Total Respondent(s)">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div id="for_D_r" style="display: none">
                                    <?php if (!empty($res_rw['ind_dep']) && $res_rw['ind_dep'] == 'I') {  ?>
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    <label for="respondent_causetitle3" class="col-sm-5 col-form-label">
                                                        <div class="icheck-primary d-inline">
                                    ...
                                    <?php } else { ?>
                                        ...
                                        if (!empty($res_rw['ind_dep']) && $res_rw['ind_dep'] == 'D3') {
                                            $disply1st_res = 'none';
                                        } else {
                                            $disply1st_res = 'block';
                                        }
                                ...
                                <div class="col-md-12 mt-5mb-3">
                                    ...
                                    <?php $r_sno = 0;
                                    if (!empty($additional_address_r)) {
                                        foreach ($additional_address_r as $row) {
                                            $r_sno++;
                                        }
                                    } ?>
                                ...
                                <hr />
                                <!--start Advocate-->
                                <h4 class="basic_heading">Petitioner Advocate Details </h4>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <select id="padvt" name="padvt" onchange="changeAdvocate(this.id,this.value)" class="form-control">
                                                    <option value="A" <?php if ((!empty($petadv_info_rw['aor_state'])) && $petadv_info_rw['aor_state'] == 'A') echo "selected"; ?>>AOR</option>
                                                    <option value="N" <?php if ((!empty($petadv_info_rw['aor_state'])) && $petadv_info_rw['aor_state'] == 'N') echo "selected"; ?>>Non-AOR</option>
                                                    <option value="S" <?php if ((!empty($petadv_info_rw['aor_state'])) && $petadv_info_rw['aor_state'] == 'S') echo "selected"; ?>>State</option>
                                                    <option value="SS" <?php if ((!empty($petadv_info_rw['aor_state'])) && $petadv_info_rw['aor_state'] == 'SS') echo "selected"; ?>>Petitioner In Person</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4" id="padv_is_ac">
                                        <div class="form-group clearfix single-check-mt">
                                            <div class="icheck-primary d-inline">
                                                <input type="checkbox" id="is_ac" name="is_ac" <?php if ((!empty($petadv_info_rw['aor_state'])) && $petadv_info_rw['is_ac'] == 'Y') echo "checked"; ?>>
                                            ...
                                            <div class="col-sm-7">
                                                ...
                                                <select name="ddl_pet_adv_state" id="ddl_pet_adv_state" class="form-control" <?php if ($fetch_rw['padvt'] != 'S' && $fetch_rw['padvt'] != 'N') echo "disabled"; ?>>
                                                    ...
                                                    foreach ($state_list as $row) {
                                                        ...
                                                        if (isset($row['cmis_state_id'])) {
                                                            if (((!empty($petadv_info_rw['state_id'])) && ($petadv_info_rw['state_id'])  == $row['cmis_state_id'])) {
                                                                $sel = 'selected=selected';
                                                            } else {
                                                                $sel = '';
                                                            }
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" id="padvno" size="25" 
                                                    ...
                                                    onblur="getAdvocate_for_main(this.id,'P')"
                                                    value="<?php if (!empty($petadv_info_rw['aor_state']) && ($petadv_info_rw['aor_state'] == 'A' || $petadv_info_rw['aor_state'] == '')) { echo $petadv_info_rw['aor_code'] ?? ''; } else { echo $petadv_info_rw['enroll_no'] ?? ''; }?>"
                                                    <?= ((!empty($petadv_info_rw['aor_state']) && ($petadv_info_rw['aor_state'] == 'A' || $petadv_info_rw['aor_state'] == '')) && (!empty($fetch_rw['padvt']) && $fetch_rw['padvt'] == 'C')) ? 'disabled="true"' : ''; ?>
                                                    placeholder="AOR code/Name:/Enrol No">

                                            </div>
                                        </div>
                                    </div>
                                    
                                    <div class="col-md-4" id="padvyr_"  style="display: <?= (isset($petadv_info_rw['aor_state']) && $petadv_info_rw['aor_state'] == 'A') ? 'none' : 'block'; ?>;">
                                        <div class="form-group row">
                                            <label for="inputEmail3" class="col-sm-5 col-form-label">Year <span class="text-red">*</span> :</label>
                                            <?php $disabled = ($fetch_rw['padvt'] != 'S' && $fetch_rw['padvt'] != 'N') ? "disabled" : ""; ?>
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" id="padvyr" size="4" maxlength="4" onblur="getAdvocate_for_main(this.id,'P')" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');" value="<?php echo $petadv_info_rw['enroll_date'] ?? '' ?>"  <?= $disabled ?>/>
                                            </div>
                                            <!--<div class="col-sm-7">
                                                <input type="text" class="form-control" id="padvyr" size="4" maxlength="4" onblur="getAdvocate_for_main(this.id,'P')" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');" value="<?php echo $petadv_info_rw['enroll_date'] ?? '' ?>" <?= (!empty($petadv_info_rw['aor_state']) && ($petadv_info_rw['aor_state'] == 'A' || $petadv_info_rw['aor_state'] == '')) && (!empty($fetch_rw['padvt']) && $fetch_rw['padvt'] == 'C') ? 'disabled="true"' : ''; ?> />
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" placeholder="Enter name" id="padvname" size="30"
                                                    value="<?=
                                                            (is_array($petadv_info_rw) && !empty($petadv_info_rw['aor_state']) &&
                                                                ($petadv_info_rw['aor_state'] == 'A' || $petadv_info_rw['aor_state'] == ''))
                                                                ? $petadv_info_rw['name']
                                                                : (isset($pet_rw['partyname']) ? $pet_rw['partyname'] : '') . ' (SELF)'; ?>"
                                                    disabled>
                                    ...
                                    <div class="col-md-4" id="padvmob_">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" placeholder="Enter mobile number" id="padvmob" size="10" value="<?php echo $petadv_info_rw['mobile'] ?? '' ?>" maxlength="10" onkeypress="return onlynumbers(event)" <?= ((!empty($petadv_info_rw['aor_state']) && $petadv_info_rw['aor_state'] == 'SS')) ? '' : 'readonly=""'; ?>>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4" id="padvemail_">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" id="padvemail" name="padvemail" size="30" value="<?php echo $petadv_info_rw['email'] ?? '' ?>" placeholder="Enter email id" <?= ((!empty($petadv_info_rw['aor_state']) && $petadv_info_rw['aor_state'] == 'SS')) ? '' : 'readonly=""'; ?>>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <h4 class="basic_heading">Respondent Advocate Details </h4>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <select id="radvt" onchange="changeAdvocate(this.id,this.value)" class="form-control">
                                                    ...
                                                    <option value="SS" <?php if (!empty($resadv_info_rw) && $resadv_info_rw['aor_state'] == 'SS') echo "selected"; ?>>Respondent In Person</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <?php $disabled_res = (!empty($resadv_info_rw) && isset($resadv_info_rw['radvt']) && ($resadv_info_rw['radvt'] == 'S' && $resadv_info_rw['radvt'] == 'N')) ? false : 'disabled'; ?>
                                    <div class="col-md-4" id="radv_state">
                                        <div class="form-group row">
                                            <label class="col-sm-5 col-form-label">Enrol State <span class="text-red">*</span> :</label>
                                            <div class="col-sm-7">
                                                <select name="ddl_res_adv_state" id="ddl_res_adv_state" class="form-control" <?= $disabled_res ?>>
                                                    <option value="">Select</option>
                                                    <?php
                                                    foreach ($state_list as $row) {
                                                        if (isset($row['cmis_state_id'])) {
                                                            if (!empty($resadv_info_rw) && $row['cmis_state_id'] == $resadv_info_rw['state_id']) {
                                                                $sel = 'selected=selected';
                                                            } else {
                                                                $sel = '';
                                                            }
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" id="radvno" size="25" onblur="getAdvocate_for_main(this.id,'R')" value="<?php if (!empty($resadv_info_rw) && ($resadv_info_rw['aor_state'] == 'A' || $resadv_info_rw['aor_state'] == '')) {
                                                                                                                                                                        ...
                                                                                                                                                                        echo (!empty($resadv_info_rw)) ? $resadv_info_rw['enroll_no'] : '';
                                                                                                                                                                    } ?>" <?php if (!empty($resadv_info_rw) && ($resadv_info_rw['aor_state'] == 'SS') && ($fetch_rw['radvt'] == 'C')) {
                                                                                                                                                                                                                                                                                                                                                                                                        echo 'disabled="true"';
                                                                                                                                                                                                                                                                                                                                                                                                    } ?> placeholder="AOR code/Name:/Enrol No">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4" id="radvyr_"  style="display: <?= (isset($petadv_info_rw['aor_state']) && $petadv_info_rw['aor_state'] == 'A') ? 'none' : 'block'; ?>;">
                                        <div class="form-group row">
                                            <label for="inputEmail3" class="col-sm-5 col-form-label">Year <span class="text-red">*</span> :</label>
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" id="radvyr" size="4" maxlength="4" onblur="getAdvocate_for_main(this.id,'R')" onkeypress="return onlynumbers(event)" value="<?= (!empty($resadv_info_rw)) ? $resadv_info_rw['enroll_date'] : ''; ?>" 
                                                <?= $disabled_res; ?>>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" placeholder="Enter name" id="radvname" disabled size="30" value="<?php if (!empty($resadv_info_rw) && ($resadv_info_rw['aor_state'] == 'SS')) {
                                                                                                                                                    echo $res_rw['partyname'] . ' (SELF)';
                                                                                                                                                } else {
                                                                                                                                                    if (!empty($resadv_info_rw)) {
                                                                                                                                                        echo $resadv_info_rw['name'];
                                                                                                                                                    }
                                                                                                                                                }; ?>" <?= (!empty($resadv_info_rw) && ($resadv_info_rw['aor_state'] == 'A' || $resadv_info_rw['aor_state'] == '') && ($fetch_rw['radvt'] == 'C')) ? 'disabled' : ''; ?>>
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    function is_if_sclsc(if_sclsc) {
        if ($('input[name="if_sclsc"]').is(':checked')) {
            $('#txt_sclsc_no').prop('disabled',false);
            $('.sp_no_yr').css('display', 'inline');
        } else {
            $('.sp_no_yr').css('display', 'none');
            $('#txt_sclsc_no').prop('disabled',true);
        }
        $('#txt_sclsc_no').val('');
        $('#ddl_sclsc_yr').val('');
    }
    ...
    function is_if_efil(if_efil) {
        if ($('input[name="if_efil"]').is(':checked')) {
            ...
            $('#txt_efil_no').prop('disabled',false);
        } else {
...
<script>
    ...
    var aorState = '<?php echo $petadv_info_rw['aor_state'] ?? ''; ?>';
    if (aorState === 'A') {
