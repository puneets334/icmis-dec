            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header heading">
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <h3 class="card-title">Filing >> Report >> Weeding Caveat List</h3>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header p-2" style="background-color: #fff; border-bottom:none;">
                                    <h4 class="basic_heading">List of Caveats Filed And Expired(>90 days old)</h4>
                                </div>
                                <div class="card-body">
...
<script type="text/javascript">
    ...
    $("#btnGetDiaryList").click(function() {
        ...
        $.ajax({
            url: base_url + '/Filing/CaveatReport/caveat_ninedays_report',
            type: "POST",
            data: {
                dateFrom: dateFrom,
                dateTo: dateTo,
