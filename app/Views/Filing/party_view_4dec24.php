                            ...
                            <div class="card">
                                <div class="card-header p-2" style="background-color: #fff;">
                                    <ul class="nav nav-pills inner-comn-tabs">
                                        ...
                                        <li class="nav-item"><a class="nav-link" href="#multi_party_dispose_tab_panel" data-toggle="tab">Multi Party Dispose</a></li>
                                        <li class="nav-item"><a class="nav-link" href="#multi_party_restore_tab_panel" data-toggle="tab">Restore</a></li>
                                ...
                                <div class="">
                                    <div class="tab-content">
                                        ...
                                        <div class="active tab-pane" id="add_party_tab_panel">
                                            ...
                                            <div class="form-div">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                                                        <div class="form-group row clearfix">
                                                            <label class="col-form-label">Tehsil/Place/City:</label>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                                                        <div class="form-group row clearfix">
                                                            <label class="col-form-label">Lower Court Case:</label>
										...
										<div class="tab-pane" id="multi_party_dispose_tab_panel">
												...
												?>
													...
													<table align="center" width="100%" id="table_causetitle" cellpadding="10">
														<tr align="center" style="color:blue"><th><?php
                                                                 ...
                                                                 if (!empty($casetype['fil_no_fh'])) {
                                                                     ...
                                                                     if ($r_case && isset($r_case['short_description'])) {
                                                                         echo ',[R]' . $r_case['short_description'] . substr($casetype['fil_no_fh'], 3) . '/' . $casetype['f_year'];
                                                                     } else {
                                                                         // Handle the case where $r_case is false or does not contain 'short_description'
                                                                         echo ',[R] Unknown Case Type';
                                                                     }
                                                                 }
 
                                                                 if (isset($_REQUEST['dno']) && !empty($_REQUEST['dno'])) {
                                                                     echo ", Diary No: " . substr($_REQUEST['dno'], 0, -4) . '/' . substr($_REQUEST['dno'], -4);
                                                                 }?></th></tr>
													...
													<?php
														  ...
														  <div class="col-12 col-sm-12 col-md-4 col-lg-4">
															...
															<div class="col-md-12 mb-3 mt-5 text-center">
																<button type="button" id="btn-update" onclick="disposeParty();"> Submit </button>
															</div>
															<?php
										...
										<div class="tab-pane" id="multi_party_restore_tab_panel">
											<div class="row mt-5 mb-3">
												...
												?>
												<input type='hidden' value="<?php echo $hdfil;?>" id='hdfno_restore'>
												<table align="center" width="100%" id="table_causetitle" cellpadding="10">
													<tr align="center" style="color:blue"><th><?php
															echo "Case No.-";
											...
											<div class="row">
												  <div class="col-12 col-sm-12 col-md-6 col-lg-6">
														<div class="form-group row clearfix">
															<label class="col-form-label"><strong>Select Disposed Party</strong></label>
															 <Select id="restoredispparty" name="dispparty" style="width: 300px;" class="form-control">
																<option value="">----SELECT----</option>
																<?php foreach($disp_party as $row){ ?>
																		<option value="<?php echo $row['auto_generated_id'];?>"><?php
																			echo $row['pet_res'].$row['sr_no_show'].' - '.$row['partyname'];
																			?></option>
																<?php }?>
															</Select>
														</div>
													...
													<div class="col-12 col-sm-12 col-md-6 col-lg-6">
														<div class="form-group row clearfix">
															<label class="col-form-label"><strong>Remarks</strong></label>
															<input class="form-control" type="text" id="restoreremark" name="resremark" >
														</div>
													</div>
														<div class="col-md-12 mb-3 mt-5 text-center">
															<button type="button" id="btn-update"  onclick="restoreParty();"> Restore </button>
														</div>	 
													 </div>
										...
										<div class="tab-pane" id="multi_party_update_tab_panel">
											<div class="row mt-5 mb-3" id="multi_party_update">
												
											</div>
											<div id="result1" class="col-md-12 text-center"></div>
										</div>
...
function restoreParty(){
    ...
    if( $("#restoredispparty").val()==''){
        alert("Please Select Party");
        $("#restoredispparty").focus();
        return false;
    }
    if( $("#restoreremark").val()==''){
        alert("Please enter remarks");
        $("#restoreremark").focus();
        return false;
    }
    var partyid = $("#restoredispparty").val();
    var hdfno = $("#hdfno_restore").val();
    var resremark = $("#restoreremark").val();
	
    var CSRF_TOKEN = 'CSRF_TOKEN';
	var CSRF_TOKEN_VALUE = $('[name="CSRF_TOKEN"]').val();
    $.ajax({
        type: 'POST',
        url:base_url+"/Filing/Party/restore_dispose_party",
        data:{CSRF_TOKEN: CSRF_TOKEN_VALUE,partyid:partyid,diaryno: hdfno,restremark: resremark}
    })
        .done(function(msg){
			updateCSRFToken();
			$('#restoredispparty').val('');			 
			$('#restoreremark').val('');
            alert(msg);
            call_fetch_infoAgain(document.getElementById('hdfno_restore').value);
            call_fetch_causetitle(document.getElementById('hdfno_restore').value);
...
function getPartyUpdate()
{
	var CSRF_TOKEN = 'CSRF_TOKEN';
	var CSRF_TOKEN_VALUE = $('[name="CSRF_TOKEN"]').val();
    $.ajax({
        type: 'POST',
        url:base_url+"/Filing/Party/update_dispose_party",
