                        ...
                        <br><br>
                            ...
                            ?>
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-3 mb-3" id="divReturnReason">
                                    ...
                                    <div class="col-sm-12 col-md-3 mb-3" id="divSection">
                                    ...
                                    <div class="col-sm-12 col-md-3 mb-3" id="divOfficer">
                                    ...
                                    <div class="col-sm-12 col-md-3 mb-3">
                                        ...
                                        <button type="button" id="btnReceiveForSection" name="btnReceiveForSection" class="quick-btn mt-26" onclick="return doReceiveForSection();"><i class="fa fa-fw fa-download"></i>&nbsp;Save/Send</button>
                                    </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($forwardedCase['is_forwarded'] == 'f') {
                                                        echo $forwardedCase['dispatched_by'];
                                                        echo "&nbsp;On&nbsp;";
                                                        echo date("d-m-Y h:i:s A", strtotime($forwardedCase['dispatched_on']));
                                                    } ?>
                                                </td>
                                                <td>
                                                    <?php if ($forwardedCase['is_forwarded'] == 't') {
                                                        echo $forwardedCase['dispatched_by'];
                                                        echo "&nbsp;On&nbsp;";
                                                        echo date("d-m-Y h:i:s A", strtotime($forwardedCase['dispatched_on']));
                                                    } ?>
                                    ...
                                    if (!empty($forReceiveInSection)) {
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($case['is_forwarded'] == 'f') {
                                                        echo $case['dispatched_by'];
                                                        echo "&nbsp;On&nbsp;";
                                                        echo date("d-m-Y h:i:s A", strtotime($case['dispatched_on']));
                                                    } ?>
                                                </td>
                                                <td>
                                                    <?php if ($case['is_forwarded'] == 't') {
                                                        echo $case['dispatched_by'];
                                                        echo "&nbsp;On&nbsp;";
                                                        echo date("d-m-Y h:i:s A", strtotime($case['dispatched_on']));
                                                    } ?>
    ...
    function setOfficersOfSection(dealingSection) {
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                ...
                alert("Error while fetching officers. Please try again later.");
            }
        });
