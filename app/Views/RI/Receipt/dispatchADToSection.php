                                    ...
                                    <div class="form-group row " >
                                        ...
                                        <div class="col-sm-7">
                                            <div class="input-group date" id="fromDate" data-target-input="nearest">
                                                <input type="date" id="fromDate" name="fromDate" class="form-control "  name="fromDate" data-target="#fromDate" value="<?php //= !empty($fromDate)?$fromDate:null; ?>" />
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="input-group date" id="toDate" data-target-input="nearest">
                                                <input type="date" id="toDate" name="toDate" class="form-control "  name="toDate" data-target="#toDate" value="<?php //= !empty($toDate)?$toDate:null; ?>" />
