            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="container-fluid">
                        ...
                        <h2 class="page-header">Datewise Action Taken in Section</h2>
                                <form id="dispatchedFromSection"  method="post" action = "<?php  echo base_url() ?>index.php/RIController/dateWiseReceived" >
                                    <div class="row">
                                         <?= csrf_field(); ?>  
