...
<?php
                if (isset($queryRecords) && sizeof($queryRecords) > 0) {
                    ?>
                    <table id="reportTable1" style="width: 95%" class="table table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <th width="10%">Last Action Taken By</th>
                            <th width="5%">Last Action Taken On</th>
                        ...
                        <?php
                        $s_no = 1;
                        foreach ($queryRecords as $case) {//case in
                            ?>
                            <tr>
                                <td></td>
