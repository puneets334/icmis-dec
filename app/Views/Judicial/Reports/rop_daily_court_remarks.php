...
<script type="text/javascript" src="<?= base_url() ?>/judicial/rop_daily_court_remarks.js"></script>
<!-- Main content -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header heading">
                        <div class="row">
                            <div class="col-sm-10">
                                <h3 class="card-title">Judicial / Report / Verify >> ROP Verification</h3>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                                                ...
                                                <div id="rightcontainer" align="center">
                                                    <div id="s_box" align="center">
                                                        <table border="0" height="35" width="100%">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <select name="courtno" id="courtno" style="max-width:-moz-available;width: 150px;" onchange="check_select(1);">
                                                                ...
                                                                <td>
                                                                    <input type="date" value="<?php print $dtd; ?>" name="dtd" id="dtd">
                                                                </td>
                                                                <td hidden>
                                                                    Verification Status
                                                                    <select class="ele" name="vstats" id="vstats">
                                                                ...
                                                                <td><input type="button" name="bt11" value="Submit" onclick='fsubmit();'></td>
                                                            </tr>
