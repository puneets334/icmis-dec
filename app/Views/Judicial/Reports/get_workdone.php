<?php if(!empty($results)) { ?>
    ...
    <table id="listingTable" style="margin-left: auto;margin-right: auto;border-collapse: collapse;margin-top: 10px;" border="1" cellspacing="2" cellpadding="4">
        <thead>
        <tr>
            <th rowspan="2">SNo.</th>
...
$(function() {
        ...
        }).buttons().container().appendTo('#listingTable .col-md-6:eq(0)');
    });
</script>