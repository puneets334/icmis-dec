                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header p-2" style="background-color: #fff; border-bottom:none;">
                                    <h4 class="basic_heading">SMS - R&I</h4>
                                </div>
                                <div class="card-body">
                                            ...
                                            <form method="POST">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-3 mb-3">
                                                        <button type="submit" id="sendSMS" class="quick-btn mt-26">Send R&I SMS</button>
                                                    </div>
                                                </div>
                                            </form>
...
<script>
    $("#sendSMS").click(function (e) {
        ...
        $.ajax({
            url: "<?php echo base_url('PaperBook/PaperBooksSMS/sms_ri'); ?>",
            type: "POST",
            beforeSend: function() {
