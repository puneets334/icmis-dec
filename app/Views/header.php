...
<!-- date-range-picker -->
<!-- <script src="<?php //echo base_url('assets/vendor/daterangepicker/daterangepicker.js'); 
                    ?>"></script> -->
...
// or via CommonJS
    ...
    // To get the token syncroniously 
    async function updateCSRFTokenSync() {
...
<style>
    ...
    #whole_page_loader {position: fixed;top: 0;left: 0;width: 100%;height: 100%;z-index: 1000;background-color: #f5f5f6c7;background-image: url('<?php echo base_url('/supreme-court-logo.png'); ?>');background-repeat: no-repeat;background-position: center;background-size: 104px;background-position: 51% 51%;display:none;}
    #main-loader {display: block;position: relative;left: 50%;top: 50%;width: 170px;height: 170px;margin: -75px 0 0 -75px;border-radius: 50%;border: 3px solid transparent;border-top-color: #3498db;animation: spin 2s linear infinite;}
    #main-loader:before {content: "";position: absolute;top: 5px;left:5px;right:5px;bottom:5px;border-radius:50%;border:3px solid transparent;border-top-color:#e74c3c;animation: spin 3s linear infinite;}
    #main-loader:after {content: "";position: absolute;top: 15px;left: 15px;right: 15px;bottom: 15px;border-radius: 50%;border: 3px solid transparent;border-top-color: #f9c922;animation: spin 1.5s linear infinite;}

    #page_loader {position: fixed;top: 0;left: 0;width: 100%;height: 100%;z-index: 1000;background-color: #f5f5f6c7;background-image: url('<?php echo base_url('/images/load.gif'); ?>');background-repeat: no-repeat;background-position: center;background-size: 104px;background-position: 51% 51%;display:none;}
    #main-loaders {display: block;position: relative;left: 50%;top: 50%;width: 170px;height: 170px;margin: -75px 0 0 -75px;border-radius: 50%;border: 3px solid transparent;border-top-color: #3498db;animation: spin 2s linear infinite;}
    #main-loaders:before {content: "";position: absolute;top: 5px;left:5px;right:5px;bottom:5px;border-radius:50%;border:3px solid transparent;border-top-color:#e74c3c;animation: spin 3s linear infinite;}
    #main-loaders:after {content: "";position: absolute;top: 15px;left: 15px;right: 15px;bottom: 15px;border-radius: 50%;border: 3px solid transparent;border-top-color: #f9c922;animation: spin 1.5s linear infinite;}

    @keyframes colorFade {
        0% {color:#3498db;opacity: 0.3;}
        50% {color:#bb0000;opacity: 1;}
        100% {color:#e74c3c;opacity:0.5;}
    }

    #loader-text {position: absolute;top: 64%;left: 50%;transform: translateX(-50%);font-size: 20px;animation: colorFade 3s linear infinite;}
    #loader-texts {position: absolute;top: 64%;left: 50%;transform: translateX(-50%);font-size: 20px;animation: colorFade 3s linear infinite;}

    @media screen and (max-width: 767px) {
        #loader-text {position: absolute;top: 75%;left: 50%;transform: translateX(-50%);font-size: 20px;color: #c80000;}
        #loader-texts {position: absolute;top: 75%;left: 50%;transform: translateX(-50%);font-size: 20px;color: #c80000;}
    }
