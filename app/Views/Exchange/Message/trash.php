...
<script>
    function showrpt(str)
    {
        ...
        $.ajax({
            url: "<?php echo base_url('Exchange/Message/trashPro'); ?>?q="+str+"&dtp="+dtp,
            type: "GET",
            beforeSend: function()
            {
    ...
    function savethis(str)
    {
        ...
        ajaxRequest.onreadystatechange = function()
        {
            if(ajaxRequest.readyState == 4)
            {
                ...
                // alert(document.getElementById("hint").innerHTML);
                    if(document.getElementById('result').value=='P')
                    {
                        showrpt('P');
                    }
                    else if(document.getElementById('result').value=='all')
                    {
                        showrpt('all');
                    }
            }
