                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <!-- <input class="form-control" type="button" value="On Date" onclick="showrpt('P')"/> -->
                                    <button type="button" value="On Date" onclick="showrpt('P')" class="btn btn-primary">On Date</button>
                                </div>
                                <div class="col-md-2">
                                    <label for="causelistDate">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                    <!-- <input class="form-control" type="button" value="All Messages" onclick="showrpt('all')"/> -->
                                    <button type="button" value="On Date" onclick="showrpt('all')" class="btn btn-primary">All Messages</button>
                                </div>
                            </div>
                            <br>
                            <?= form_close()?>
...
<script>
    // var hd_ipadd = document.getElementById('hd_ipadd').value;
    // show_nw_msg();
    ...
    function showrpt(str)
    {
        ...
        $.ajax({
            url: "<?php echo base_url('Exchange/Message/inboxPro'); ?>",
            type: "POST",
            data:
            {
    ...
    function seen(str)
    {
        var url = "<?php echo base_url('Exchange/Message/markAsSeen'); ?>?id=" + str;
    ...
    {
        var url = "<?php echo base_url('Exchange/Message/deleteMessage'); ?>?id=" + str;
    ...
    function replythis(str)
    {
        popup('popUpDiv', str);
        document.getElementById("replytext").focus();
    }

    function popup(windowname, str)
    {
        blanket_size(windowname);
        window_pos(windowname);
        toggle('blanket');
        toggle(windowname, str);
    }
    ...
    function toggle(div_id, str)
    {
        document.getElementById("reply_str").innerHTML = str;
    ...
    {
        var reply_str = document.getElementById("reply_str").innerHTML;
        var replytext = encodeURIComponent(document.getElementById("replytext").value);
        if (replytext == '')
        {
            if (replytext == '')
            {
        ...
        {
            var url = "<?php echo base_url('Exchange/Message/replyMessage'); ?>?reply_str=" + reply_str + "&replytext=" + replytext;
