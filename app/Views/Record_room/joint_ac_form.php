...
<head>
    ...
    <title>SCRR-Joint Advocate-Clerk Registration</title>
    <link rel="stylesheet" href="<?= base_url('css/bootstrap.min.css') ?>">
    <link rel="stylesheet" href="<?= base_url('css/jquery-ui.css') ?>">
    <link rel="stylesheet" href="<?= base_url('css/main.css') ?>">
    <link rel="stylesheet" href="<?= base_url('css/menu_styles.css') ?>">
    <link rel="stylesheet" href="<?= base_url('css/half-slider.css') ?>">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $("#search").click(function() {
                ...
                // Validation to check if cein and crd have values
                // if (!cein || !crd) {
                //     alert("Please Enter Mandatory Values");
                //     return false;
                // }
    ...
    <div class="container">
        <div class="panel panel-info">
            <div class="panel-heading">
                <h4><strong><span class="glyphicon glyphicon-search glyphicon-lg"></span>&nbsp; Joint Registration >>&nbsp; Advocate Clerk (Joint)</strong></h4>
            </div>
                ...
                <form class="form-horizontal" role="form" name="form1" autocomplete="off">
                    ...
                    <div id="data">
                        <div class="form-group">
                            ...
                            <div class="col-sm-1"><input class="form-control" name="aorc" type="text" id="aorc" placeholder="Code"
                                    disabled></div>
                            <div class="col-sm-6"><input class="form-control" name="aorn" type="text" id="aorn" placeholder="Name"
                                    disabled></div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-3"> <input class="form-control " name="cpob" type="text" id="cpob"
                        ...
                        <div class="form-group ">
                            <label class="control-label col-sm-2" for="anumber">Moible No.</label>
                            <div class="col-sm-2">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-2"><input class="form-control " name="cx" type="text" id="cx" placeholder="X" disabled>
                            </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-2">
                                <input class="form-control " name="crd" type="text" id="crd" placeholder="Registration Date" disabled>
                            </div>
                        </div>
