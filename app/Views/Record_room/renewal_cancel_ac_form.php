...
<head>
    ...
    <title>SCRR-RENEW/CANCEL-Clerk Registration</title>
        ...
        $(document).ready(function() {
            ...
            $("#register").click(function() 
            {
                ...
                if (action > 0) {
                    $.ajax({
                        type: "post",
                        url: "<?= site_url('Record_room/Record/RenewalRegister') ?>",
                        data: { 
                            tvap: tvap,
                        ...
                        cache: false,
                        success: function(result) {
                            $('#rslt1').html("<img src='img/loading.gif' width='50px' height='50px'/>");
                            $('#rslt1').html(result);
                            $('#cein').val("");
                            $('#cein').focus();
                            $('#register').hide();
    ...
    <div class="container">
        <div class="panel panel-info">
            <div class="panel-heading">
                <h4><strong><span class="glyphicon glyphicon-search glyphicon-lg"></span>&nbsp; RENEW / CANCEL >>&nbsp; Advocate Clerk Registration</strong></h4>
            </div>
                ...
                <form class="form-horizontal" role="form" name="form1" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2" id="sbtn">
                            <button type="button" class="btn btn-warning" name="submit" id="search">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2" id="sbtn1">
                            <button type="button" class="btn btn-warning" name="submit" id="search1">
                                <span class="glyphicon glyphicon-plus"></span> Search
                            </button>
                        </div>
                    </div>
