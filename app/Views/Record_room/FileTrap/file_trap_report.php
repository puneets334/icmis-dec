                ...
                <div class="card">
                    ...
                    ?>
                        ...
                        <h4 class="text-center">
                            <?= isset($string1) ? $string1 : ''; ?>
                            <strong><?= $param[5]; ?>(<?= $param[2]; ?>)</strong> BETWEEN &nbsp;
                            ...
                            <table id="reportTable1" class="table table-striped table-hover box box-primary table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Dispatch By</th>
                                        <th>Dispatch To</th>
                                        <th>Dispatch(Consignment) Date</th>
                                        <th>Remarks</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    $s_no = 1;
                                    if (!empty($receiveDispatchReports)) {
                                        foreach ($receiveDispatchReports as $result) {
                                    ?>
                                            <tr>
                                                <td><?= $s_no; ?></td>
                                                <td>
                                                <a href="#" class="" onclick="showModale(<?= $result['diary_no']; ?>)" id="<?= $result['diary_no']; ?>">
                                                    ...
                                                    <?php if (!empty($result['consignment_remark'])) { ?>
                                                        <br><span class="text-danger">Consignment Remark: <?= $result['consignment_remark']; ?></span>
                                                    <?php } ?>
                                                </td>
                                                <td>
                                                    <?= $result['dispathby']; ?><br>
