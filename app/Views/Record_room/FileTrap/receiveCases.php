<?php
        if(is_array($disposedCasesList))
        {
            ...
            <div id="printable" class="box box-danger">
                ...
                <?php if($param[1]==110) { ?>
                <div class=" col-sm-12">
                    <button type="submit" id="btnAcceptAndDispatch" name="btnAcceptAndDispatch" class="btn btn-success btn-block pull-right generateROP" onclick="receiveAndAutoDispatch();" ><i class="fa fa-check"></i>&nbsp;Received Cases and Dispatch to Segregation DA / Record Keeper</button>
                </div>
                <?php } ?>

                <?php if($param[1]==111) { ?>
                    <div class=" col-sm-12">
                        <button type="submit" id="btnAcceptAndDispatch" name="btnAcceptAndDispatch" class="btn btn-success btn-block pull-right generateROP" onclick="receiveAndAutoDispatch();" ><i class="fa fa-check"></i>&nbsp;Received Cases and Dispatch to Scanning</button>
                    </div>
                <?php } ?>

                <?php if($param[1]==58) { ?>
                    <div class=" col-sm-12">
                        <button type="submit" id="btnAcceptAndDispatch" name="btnAcceptAndDispatch" class="btn btn-success btn-block pull-right generateROP" onclick="receiveAndAutoDispatch();" ><i class="fa fa-check"></i>&nbsp;Received Cases and Dispatch to RecordRoom DA</button>
                    </div>
                <?php } ?>

                <?php if($param[1]==112) { ?>
                    <div class=" col-sm-12">
                        <button type="submit" id="btnAcceptAndDispatch" name="btnAcceptAndDispatch" class="btn btn-success btn-block pull-right generateROP" onclick="receiveAndAutoDispatch();" ><i class="fa fa-check"></i>&nbsp;Received Cases</button>
                    </div>
                <?php } ?>
                <br>
                <?php
