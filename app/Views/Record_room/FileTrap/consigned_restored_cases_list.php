            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header heading">
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <h3 class="card-title">RECORD ROOM >> File Movement >> Re-Consign Restored Cases</h3>
                            </div>
                            <div class="col-sm-2">
                    ...
                    <form class="form-horizontal" id="push-form" method="post" action="<?= base_url(); ?>/Record_room/FileTrap/getAlreadyConsignedRestoredCaseList">
                    ...
                    ?>
                        ...
                        <div class="card-body row table-responsive">
                            <table id="reportTable1" class="table table-striped table-hover box box-primary table-bordered">
                                ...
                                <tbody>
                                    <?php $s_no = 1; ?>
                                    <?php foreach ($alreadyConsignedRestoredCasesList as $result): ?>
                                        <tr>
                                            <td><?= $s_no; ?></td>
                                            <td>
                                                ...
                                                <?php if (!empty($result['consignment_remark'])): ?>
                                                    <br><span style="color: darkred;">Consignment Remark: <?= $result['consignment_remark']; ?></span>
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <?= $result['dispathby']; ?><br>
                                            ...
                                            <td>
                                                <p style="cursor: pointer; color: #026D9F;" id="<?= $result['diary_no']; ?>">
                                                    <?php if (!empty($result['dispatchdate'])): ?>
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <span class="modal-title">File Trap Timelines</span>
                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                    </div>
                                    <div class="modal-body">
                                        <div id="divCaseTimeline">
                                            <ul class="timeline">
...
<script>
    $(document).ready(function() {
        function confirmBeforeAdd() {
            var choice = confirm('Do you really want to Update the Consignment date to Today....?');
            if (choice === true) {
                return true;
            }
            return false;
        ...
        $(function() {
            ...
            $("#orderDateFrom").datepicker("setDate", '01-01-2019');
        ...
        $('p').click(function() {
            if (confirmBeforeAdd() == true) {
                var id = $(this).attr('id');

                $.ajax({
                        type: 'GET',
                        url: "<?= base_url() ?>/Record_room/FileTrap/updateConsignmentDate",
