 ...
 <?= view('header') ?>
    ...
    <div class="card">
        ...
        <div class="row">
                ...
                <!--<button type="button" name="generateLetter" id="generate-btn" class="btn btn-flat bg-blue btn-block" onclick="downloadReport();">-->
               <!-- <button type="button" name="generateLetter" id="generate-btn" class="btn btn-flat bg-blue btn-block" <a href="<?/*= base_url() */?>index.php/PilController/downloadFormatReport/1/<?/*=$ecPilGroupId*/?>/<?php /*echo $_SESSION["dcmis_user_idd"]; */?>" target="_blank"></a>;">
                Generate Letter</button>-->
                <!--<a href="<?/*= base_url() */?>index.php/PilController/downloadGeneratedReport/<?/*=$reportType*/?>/<?/*=$ecPilId*/?>/<?php /*echo $_SESSION["dcmis_user_idd"]; */?>" target="_blank" class="btn btn-flat bg-blue btn-block" onclick="downloadReport();">Generate Report</a>-->

                <!--<button type="button" name="generate" id="generate-btn" class="btn btn-flat bg-blue btn-block" onclick='location.href="<?/*= base_url() */?>index.php/PilController/downloadGeneratedReport/<?/*=$reportType*/?>/<?/*=$ecPilId*/?>/<?/*=$textFilled*/?>/<?php /*echo $_SESSION["dcmis_user_idd"]; */?>";downloadReport();'>
