    ...
    <div class="card-body" >
        ...
        <script>
            ...
            $(document).ready(function() {
                    var title_html = `<?php echo $judges_data['jname']; ?><br><?php echo $heading; ?> Date Wise Cases Ready to list`; 
                    var title_text = `<?php echo $judges_data['jname']; ?>\n<?php echo $heading; ?> Date Wise Cases Ready to list`; // Replace <br> with \n
                ...
                $('#reportTable1').DataTable({
                    ...
                    buttons: [{
                            extend: 'print',
                            text: 'Print',
                            title: title_html, // Ensuring no unwanted title appears
