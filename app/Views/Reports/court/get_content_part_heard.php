            ...
            <?php if (!empty($dataPartHeard)): ?>
                ...
                <h3>
                    <center>
                        ...
                        $Jname = '';
                        if ($judge == 0) {
                            $title =  'List of ' . $report_type_head . '_' . $mh . ' cases by Honble Judges as on ' . date("d-m-Y h:i:s A");
                        } else {
                            $title =  'List of ' . $report_type_head . '_' . $mh . ' cases by ' . $Jname . ' as on ' . date("d-m-Y h:i:s A");
                        }
                        echo $title;
                        ?>
                    </center>
