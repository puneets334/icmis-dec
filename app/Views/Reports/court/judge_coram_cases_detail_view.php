...
<?= view('header') ?>
            ...
            <div id="query_builder_wrapper" class="dataTables_wrapper dt-bootstrap4">
                <?php
                 if(isset($judge_coram_result) && sizeof($judge_coram_result)>0 ):
                    ?>
                    <table  id="reportTable1" class="table table-bordered table-striped custom-table">
                        <thead>
    ...
    <script>
        ...
        $(document).ready(function() {
                    var title_text = `<?php echo $title;?>`; // Replace <br> with \n
                ...
                $('#reportTable1').DataTable({
                    ...
                    buttons: [{
                            extend: 'print',
                            text: 'Print',
                            title: title_text, // Ensuring no unwanted title appears
