<div class="card">
    <div class="card-body" >
            <?php
            if($judge!= '0') {
               // echo '<h3 align="center">List of CAV matters proposed to be listed before ' . $name . ' as on ' . date("d-m-Y h:i:s A") . '<h3/>';
                echo '<h2 align="center">List of CAV matters proposed to be listed before ' . $name . ' as on ' . date("d-m-Y h:i:s A") .'</h2>';
            }
            else
            {
                echo '<h2 align="center">List of CAV matters proposed to be listed before Honble Judges as on ' . date("d-m-Y h:i:s A") .'</h2>';
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                var jcode = "<?php echo $judge;?>";
                if(jcode!='0') {
                    var filename = "<?php echo 'CAV matters HMJ ' . $name . ' as on ' . date("d-m-Y h:i:sa");?>";
                    var title = "<?php echo 'List of CAV matters proposed to be listed before ' . $name . ' as on ' . date("d-m-Y h:i:sa");?>";
                }
                else
                {
                    var filename = "<?php echo 'CAV matters of Hon\'ble Judges as on ' . date("d-m-Y h:i:sa");?>";
                    var title = "<?php echo 'List of CAV matters proposed to be listed before Hon\'ble Judges as on ' . date("d-m-Y h:i:sa");?>";
                }
                ...
                $('#reportTable1').DataTable({
                    ...
                    buttons: [{
                            extend: 'print',
                            text: 'Print',
                            title: title, // Ensuring no unwanted title appears
