                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <!-- <a target="_blank" href="<?php //echo base_url() ?>index.php/Reports/pendency_reports/3?jcode=<?php //echo $row['jcode']; ?>">
                                                        <?php //echo $row['jname']; ?>
                                                    </a> -->
                                                    <?php echo $row['jname']; ?>
                        ...
                        if ($app_name == 'CategoryWise') {
                            ...
                            ?>
                                <div id="printable">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-10">
                                            <h3 class="card-title">Subject Category Wise Pendency as on <?php echo date("d-m-Y"); ?></h3>
                                        </div>
                                    </div>
                                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <!-- <a target="_blank" href="<?php //echo base_url() ?>index.php/Reports/pendency_reports/4?categoryCode=<?php //echo $row['category_sc_old']; ?>">
                                                    ...
                                                    <td>
                                                        <?php
                                                        echo $row['misc_not_ready'];
                                                        ?>
                                                    </td>
                                                    <td>
                                                        <?php
                                                        echo $row['regular_ready'];
                                                        ?>
                                                    </td>
                                                    <td>
                                                        <?php
                                                        echo $row['regular_not_ready'];
                                                        ?>
                                                    </td>
                                                </tr>
                                            <?php
