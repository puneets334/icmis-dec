                ...
                <div class="card">
                    ...
                    ?>
                            <div class="card-header heading">
                                <div class="row">
                                    <div class="col-sm-10">
                                        <h3 class="card-title">Management Report >> Pending >> Judges Wise Pendency as on <?php echo date("d-m-Y"); ?></h3>
                                    </div>
                                </div>
                            </div>
                            <div id="printable" class="card-body table-responsive">
                        ...
                        ?>
                            <div class="card-header heading">
                                <div class="row">
                                    <div class="col-sm-10">
                                        <h3 class="card-title">Management Report >> Pending >> PENDING CASES IN WHICH <?= $jname ?>(<?= $jcode ?>)<br />
                        ...
                        ?>
                          <div class="card-header heading">
                                <div class="row">
                                    <div class="col-sm-10">
                                        <h3 class="card-title">Management Report >> Pending >>  PENDING CASES IN WHICH <strong>[Sub Category:<?= $categoryCode ?>-<?= $SubCategory ?>][Main Category:<?= $mainCatgeory ?>]</strong><br />
