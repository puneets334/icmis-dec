                                ...
                                <section class="content">
                                    <div id="printable" class="box box-danger">
                                        <caption>
                                            ...
                                            {
                                                ?>
                                                <h3 style="text-align: center;">Total Un-registered Diary No. matters disposed between <?php echo date('d-m-Y', strtotime($param[0])); ?> and <?php echo date('d-m-Y', strtotime($param[1])); ?></h3>
                                            <?php
                                            }
                                            elseif($param[2]=='5')
                                            {
                                                ?>
                                                <h3 style="text-align: center;">Total Disposed matters between <?php echo date('d-m-Y', strtotime($param[0])); ?> and <?php echo date('d-m-Y', strtotime($param[1])); ?></h3>
                                            <?php
                                            }
                                            ?>
                                        </caption>
                                        ...
                                        <?php
                                        if($app_name=='Un-registered Diary No. disposal')
                                        {
                                            if(is_array($case_result))
                                            {
                                                //var_dump($param);
                                                //var_dump($case_result);
                                             ?>
                                                <table id="reportTable1" class="table table-striped table-hover">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th width="15%">Registration <br> No</th>
                                                    ...
                                                    foreach ($case_result as $result)
                                                    {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php
                                                                if (!empty($result['fil_dt']))
                                                                {
                                                                    echo date('d-m-Y', strtotime($result['fil_dt']));
                                                                }
                                                                else
                                                                {
                                                                    echo '';
                                                            ...
                                                            <td>
                                                                <?php
                                                                if (!empty($result['disp_dt']))
                                                                {
                                                                    echo date('d-m-Y', strtotime($result['disp_dt']));
                                                                }
                                                                else
                                                                {
                                                                    echo '';
                                                            ...
                                                            <td>
                                                                <?php
                                                                if (!empty($result['ent_dt']))
                                                                {
                                                                    echo date('d-m-Y', strtotime($result['ent_dt']));
                                                                }
                                                                else
                                                                {
                                                                    echo '';
