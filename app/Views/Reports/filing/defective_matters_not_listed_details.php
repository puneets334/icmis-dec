...
$(function () {
    $("#ReportFileTrap").DataTable({
            ...
            "buttons": [
                {
                    extend: "csv",
                    title: "Defective Matters Not Listed"
                },
                {
                    extend: "excel",
                    title: "Defective Matters Not Listed"
