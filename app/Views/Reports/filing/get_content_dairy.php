        <div id="query_builder_wrapper" class="query_builder_wrapper dataTables_wrapper dt-bootstrap4">
            ...
            if(!empty($ReportsofDiary)):?>

            <h1 style="color: blue;font-size: 1.2em;text-align: center">Total Diary:<?php echo count($ReportsofDiary) ?></h1>

            <h2 style="text-align: center;text-transform: capitalize;color: blue;"> Diary Received between <?php echo $_POST['from_date'] ?> and <?php echo $_POST['to_date'] ?><br><?//=$msg?> </h2>
        ...
        <script>
            ...
            $("#query_builder_report").DataTable({
                ...
                "buttons": [
                    {
                        extend: "csv",
                        title: "Diary Received between <?php echo $_POST['from_date'] ?> and <?php echo $_POST['to_date'] ?>"
                    },
                    {
                        extend: "excel",
                        title: "Diary Received between <?php echo $_POST['from_date'] ?> and <?php echo $_POST['to_date'] ?>"
