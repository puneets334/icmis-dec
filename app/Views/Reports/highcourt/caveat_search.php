  			...
  			<div class="col-12">
  				<div class="card">
  					...
  					<form method="post" action="<?= site_url(uri_string()) ?>">
  						...
  						<div style="text-align: center;color: red">Enter Caveat Details to match lower court details</div>
  						<div id="dv_content1">
  							<div class="box-body">
  								<div class="row">

  									<div class="col-sm-12 col-md-3 mb-3">
  										<label for="ddl_court">Court</label><span style="color: red">*</span>
  										<?php
  									...
  									<div class="col-sm-12 col-md-3 mb-3">
  										<label for="ddl_st_agncy">State</label><span style="color: red">*</span>
  										<?php
  									...
  									<div class="col-sm-12 col-md-3 mb-3">
  										<label for="txt_ref_caseno">Year</label><span style="color: red">*</span>
  									...
  									<div class="col-sm-12 col-md-3 mb-3">
  										...
  										<input type="text" name="txt_order_date" id="txt_order_date" class="dtp" maxlength="10" size="9" />
  									</div>
  ...
  <script type="text/javascript" src="<?php echo base_url() ?>/reports/caveat_search.js"></script>
  <script>
