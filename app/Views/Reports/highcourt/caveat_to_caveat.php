			...
			<div class="col-12">
				<div class="card">
					...
					<form method="post" action="<?= site_url(uri_string()) ?>">
						<?= csrf_field() ?>
						<div style="text-align: center;color: red">List of Caveat filed against a particular High Court No.</div>
						...
						<div id="dv_content1">
							<div class="box-body">
								<div class="row">
									...
									<div class="col-sm-12 col-md-3 mb-3">
										<label for="ddl_ref_caseyr">Order Date</label>
										<input type="text" name="txt_order_date" id="txt_order_date" class="dtp form-control" />
									</div>
...
<script type="text/javascript" src="<?php echo base_url() ?>/reports/caveat_to_caveat.js"></script>
<script>
