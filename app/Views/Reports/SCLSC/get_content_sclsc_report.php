    ...
    <div class="card-body" >
        <div id="query_builder_wrapper" class="dataTables_wrapper dt-bootstrap4">
            ...
            <?php if(isset($case_result) && sizeof($case_result)>0 && is_array($case_result)){
                ...
                <table  id="ReportCaveat" class="table table-bordered table-striped custom-table">
                    <thead>
                    <tr>
                    ...
                    foreach ($case_result as $result)
                    {
                        ...
                        <tr>
                            ...
                            <td><?php echo $result['case_no'];?>
                                ...
                                <br>Pending or Disposed:<strong><?=(!empty($result['c_status'] && trim($result['c_status'])=='P')) ? 'Pending':'Disposed';?></strong>
                            </td>
...
$(function () {
    $("#ReportCaveat").DataTable({
        ...
        "buttons": [
            {
                extend: "csv",
                title: "SCLSC <?=$string1;?> Report as on <?php echo date('d-m-Y h:i:s A')?>"
            },
            {
                extend: "excel",
                title: "SCLSC <?=$string1;?> Report as on <?php echo date('d-m-Y h:i:s A')?>"
