...
class PrintOfficeReportReg extends BaseController
{
    ...
    public function index(){
        ...
        return view('ManagementReport/Listing/cl_print_office_report_reg', $data);
    }
    

    public function get_cause_list_or(){
        $this->db = \Config\Database::connect();
        $data['db'] = $this->db;
        return view('ManagementReport/Listing/get_cause_list_or', $data);
    }
