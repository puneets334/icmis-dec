...
class PartyModel extends Model
{
    ...
    public function copy_party_details($dataset)
    {
        ...
        if (!empty($rs)) {
           ...
           $sql = "insert into party(pet_res,sr_no,sr_no_show,ind_dep,partysuff,partyname,sonof,authcode,state_in_name,prfhname,age,sex,caste,addr1,addr2,state,city,pin,email,contact,dstname,deptcode,pan_card,adhar_card,country,education,occ_code,edu_code,lowercase_id,remark_lrs,remark_del,cont_pro_info,partyname_hindi,is_masked, hindi_timestamp,  pflag, ent_dt, diary_no, usercode,last_dt,last_usercode) select pet_res,sr_no,sr_no_show,ind_dep,partysuff,partyname,sonof,authcode,state_in_name,prfhname,age,sex,caste,addr1,addr2,state,city,pin,email,contact,dstname,deptcode,pan_card,adhar_card,country,education,occ_code,edu_code,lowercase_id,remark_lrs,remark_del,cont_pro_info,partyname_hindi,is_masked, now(), 'Z', now(),'$tdno', '$ucode',now(),'$ucode' from party where diary_no='$fdno' and sr_no != 1 and sr_no!=0 and sr_no_show !='1' and pflag!='T'";
