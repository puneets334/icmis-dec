...
$(document).on('click','#savebutton',function(e) {
    ...
    $.ajax({
        data: {fil_no:diary_no,usercode:usercode,CSRF_TOKEN: CSRF_TOKEN_VALUE},
        type: "post",
        //url: "Listing/VacationAdvanceList/save_case_in_vacation_list",
        url: base_url+'/Listing/VacationAdvanceList/save_case_in_vacation_list',
        success: function(data){
            updateCSRFToken();
            alert("Vacation List: " + data.message);
        }
    });
});
