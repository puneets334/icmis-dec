...
function getAdvocate_for_main(flag)
{
    ...
    if (flag == 'P')
    {
        ...
        var url = base_url+"/Caveat/Generation/get_adv_name?advno=" + document.getElementById('padvno').value + "&advyr=" +
    ...
    else if (flag == 'R')
    {
        ...
        var url = base_url+"/Caveat/Generation/get_adv_name" + "?advno=" + document.getElementById('radvno').value + "&advyr=" +
...
//            ddl_doc_u+"&ddl_pet_adv_state="+ddl_pet_adv_state+"&ddl_res_adv_state="+ddl_res_adv_state;
    ...
    var url = base_url+"/Caveat/Modify/save_caveat?controller=U&d_no="+d_no+"&d_yr="+d_yr+ "&case_doc=" + case_doc+
        "&ddl_st_agncy="+ddl_st_agncy+"&ddl_bench="+ddl_bench+"&hd_mn="+hd_mn+"&cs_tp="+cs_tp+"&txtFNo="+txtFNo+"&txtYear="+txtYear+
...
//    }
    ...
    var url = base_url+"save_new_filing?controller=I" + '&txt_p_no=' + txt_p_no + '&txt_yr=' + txt_yr + "&st_status=" + st_status;
...
$(document).ready(function() {
    ...
    $(document).on('change', '#ddl_bench', function() {
        ...
        $.ajax({
            url: base_url+'/filing/get_case_strc.php',
            cache: false,
            async: true,
