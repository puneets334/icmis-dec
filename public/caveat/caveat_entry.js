...
$(function() {
    $("#pet_post").autocomplete({
        source: base_url+"/Common/Ajaxcalls/new_filing_autocomp_post",
        width: 450,
        matchContains: true,
        minChars: 1,
        selectFirst: false,
...
$(function() {
    $("#pet_statename").autocomplete({
        source: base_url+"/Common/Ajaxcalls/get_only_state_name",
        width: 450,
        matchContains: true,
        minChars: 1,
        selectFirst: false,
...
$(document).on("focus","#pet_deptt",function(){
    $("#pet_deptt").autocomplete({
        source: base_url+"/Common/Ajaxcalls/new_filing_autocomp_deptt?type="+$("#selpt").val(),
        width: 450,
        matchContains: true,
        minChars: 1,
        selectFirst: false,
...
$(document).on("focus","#res_deptt",function(){
    $("#res_deptt").autocomplete({
        source: base_url+"/Common/Ajaxcalls/new_filing_autocomp_deptt?type="+$("#selrt").val(),
        width: 450,
        matchContains: true,
        minChars: 1,
        selectFirst: false,
    ...
    if (confirm('Do you want to save data?')) 
        ...
        //    }
            ...
            /* if(document.getElementById(pmobi).value.length != 0) {
                ...
                if (pet_add.value == '')
                {
                    alert('Please Enter Caveator Address');
                    pet_add.focus();
                    return false;
                }
                if (pcity.value == '')
                {
                    alert('Please Enter Caveator City');
                    pcity.focus();
                    return false;
                }
                if(pcont.value=='96'){
                    if (pst.value == '')
                    {
                        alert('Please Select Caveator State');
                        pst.focus();
                        return false;
                    }
                    if (pdis.value == '')
                    {
                        alert('Please Select Caveator District');
                        pdis.focus();
                        return false;
                    }
                }
                if(pcont.value=="")
                {
                    alert('Please Enter Caveator Country');pcont.focus();return false;
                }
            ...
            if (pet_type != "I")
            {
                ...
                if (pet_post.value == '')
                {
                    alert('Please Enter Caveator Post');
                    pet_post.focus();
                    return false;
                }
                if (pet_deptt.value == '')
                {
                    alert('Please Enter Caveator Department');
                    pet_deptt.focus();
                    return false;
                }
                if (pet_add.value == '')
            ...
            if (res_type == "I")
            {
                ...
                if (res_name.value == '')
                {
                    alert('Please Enter Caveatee Name');
                    res_name.focus();
                    return false;
                }
                /*if (res_rel.value == '')
        ...
        //        }
                if (res_add.value == '')
                {
                    alert('Please Enter Caveatee Address');
                    res_add.focus();
                    return false;
                }
                if (rcity.value == '')
                {
                    alert('Please Enter Caveatee City');
                    rcity.focus();
                    return false;
                }
                if(rcont.value=='96'){
                    if (rst.value == '')
                    {
                        alert('Please Select Caveatee State');
                        rst.focus();
                        return false;
                    }
                    if (rdis.value == '')
                    {
                        alert('Please Select Caveatee District');
                        rdis.focus();
                        return false;
                    }
                }
                if(rcont.value=="")
                {
                    alert('Please Enter Caveatee Country');rcont.focus();return false;
                }
            ...
            if (res_type != "I")
            {
                ...
                if (res_post.value == '')
                {
                    alert('Please Enter Caveatee Post');
                    res_post.focus();
                    return false;
                }
                if (res_deptt.value == '')
                {
                    alert('Please Enter Caveatee Department');
                    res_deptt.focus();
                    return false;
                }
                if (res_add.value == '')
        ...
        //            ddl_doc_u+"&ddl_pet_adv_state="+ddl_pet_adv_state+"&ddl_res_adv_state="+ddl_res_adv_state;
            ...
            var url = base_url+"/Caveat/Generation/save_caveat?controller=I"  + "&st_status=" + st_status+
                "&ddl_st_agncy="+ddl_st_agncy+"&ddl_bench="+ddl_bench+"&hd_mn="+hd_mn+"&cs_tp="+cs_tp+"&txtFNo="+txtFNo+"&txtYear="+txtYear+
...
function getDistrict(side, id, val,hd_city) { //return true;//SCI
    ...
    xmlhttp.open("GET", base_url+"/Common/Ajaxcalls/get_districts?state_id=" + val, true);
    xmlhttp.send(null);
}
...
function  get_casetype(){
    ...
    $.ajax({
        ...
        url: base_url+'/Common/Ajaxcalls/get_casetype',
        cache: false,
        async: true,
...
function get_benches(str)
{
    ...
    if(ddl_st_agncy!='' && ddl_court!='')
    {
        ...
        $.ajax({
            url: base_url+'/Common/Ajaxcalls/get_bench',
            cache: false,
            async: true,
