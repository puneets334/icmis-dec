...
$(document).ready(function () {
    ...
    $(document).on('click', '#btn_submit', function () {
        ...
        var ddl_court_nm = $('#ddl_court option:selected').html();
        var ddl_st_agncy_nm = $('#ddl_st_agncy option:selected').html();
        var ddl_bench_nm = $('#ddl_bench option:selected').html();
        if (ddl_bench_nm == 'Select')
            ddl_bench_nm = '';
        var ddl_ref_case_type_nm = $('#ddl_ref_case_type option:selected').html();
        if (ddl_ref_case_type_nm == 'Select')
            ddl_ref_case_type_nm = '';
        var txt_ref_caseno_nm = $('#txt_ref_caseno').val();
        var ddl_ref_caseyr_nm = $('#ddl_ref_caseyr option:selected').html();
        ...
        $.ajax({
            url: base_url + '/Reports/Filing/Highcourt/get_diary_diary',
            cache: false,
            async: true,
            data: {
                ...
                txt_order_date: txt_order_date, ddl_court_nm: ddl_court_nm, ddl_st_agncy_nm: ddl_st_agncy_nm,
                ddl_bench_nm: ddl_bench_nm, ddl_ref_case_type_nm: ddl_ref_case_type_nm, txt_ref_caseno_nm: txt_ref_caseno_nm,
    ...
    $(document).on('click', '#btn_left', function () {
        ...
        $.ajax({
            url: base_url + '/Reports/Filing/Highcourt/include_diary_diary',
            type: "GET",
            cache: false,
            async: true,
            beforeSend: function () {
