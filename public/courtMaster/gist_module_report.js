$(document).ready(function() {
    ...
    $(document).on('change', '#ddl_ord_date', function() {
        get_gist();
    });
    $(document).on('change', '#t_h_cno', function() {
        get_gist();
    });
...
function get_gist(){
    ...
    $.ajax({
        url: base_url +'/Court/CourtCauseGist/gist_get',
        cache: false,
        async: true,
        beforeSend: function() {
...
function get_report() {
    ...
    $.ajax({
        url: base_url +'/Court/CourtCauseGist/gist_module_upload_report',
        cache: false,
        async: true,
        beforeSend: function() {
            $('#div_result').html('<div style="margin:0 auto;margin-top:20px;width:15%"><img src="' + base_url + '/images/load.gif"/></div>');
