   ...
   var t_h_cyt=$('#t_h_cyt').val();
     ...
     var xmlhttp;
               ...
               // xmlhttp.open("GET","getReport51-II.php?seljudgename="+seljudgename+"&frm="+frm+"&toDate="+toDate,true);
                 xmlhttp.open("GET","get_data_upd.php?d_no="+t_h_cno+"&d_yr="+t_h_cyt,true);
               xmlhttp.send(null);
}    
 ...
 function UpdateData(str)
 {
   ...
   var t_h_cyt=$('#t_h_cyt').val();
     ...
     var hd_id=document.getElementById('hd_id'+str1[1]).value;
      ...
      var txtRem_mul=document.getElementById('txtRem_mul'+str1[1]).value;
       var hd_obj_id=document.getElementById('hd_obj_id'+str1[1]).value;
    var xmlhttp;
                if (window.XMLHttpRequest)
                {// code for IE7+, Firefox, Chrome, Opera, Safari
                    xmlhttp=new XMLHttpRequest();
               ...
               // xmlhttp.open("GET","getReport51-II.php?seljudgename="+seljudgename+"&frm="+frm+"&toDate="+toDate,true);
                 xmlhttp.open("GET","upd_obj.php?hd_id="+hd_id+"&sp_remark="+sp_remark+"&d_no="+t_h_cno+"&d_yr="+t_h_cyt+"&txtRem_mul="+txtRem_mul+"&hd_obj_id="+hd_obj_id,true);
               xmlhttp.send(null);
 }
