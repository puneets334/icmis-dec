...
$(".maxlength6").attr('maxlength', 6);

$(".maxlength10").attr('maxlength', 10);
$(".maxlength12").attr('maxlength', 12);
$(".maxlength14").attr('maxlength', 14);
$(".maxlength15").attr('maxlength', 15);
$(".maxlength20").attr('maxlength', 20);
$(".maxlength30").attr('maxlength', 30);
$(".maxlength50").attr('maxlength', 50);
$(".maxlength40").attr('maxlength', 40);
$(".maxlength150").attr('maxlength', 150);
$(".maxlength100").attr('maxlength', 100);
$(".maxlength250").attr('maxlength', 250);
$(".maxlength350").attr('maxlength', 350);
$(".maxlength300").attr('maxlength', 300);
$(".maxlength400").attr('maxlength', 400);
$(".maxlength500").attr('maxlength', 500);

jQuery(".onlynum").keypress(function (e) {
    var keyCode = e.which;
...
jQuery(".onlychar").keypress(function(e){
   var keyCode = e.which;
...
function randomString(length, chars) {
 ...
 jQuery(".noscript").keypress(function(event){
 ...
 jQuery(".alphanumeric").keypress(function(event) {
  var regex = new RegExp("^[a-zA-Z0-9 ]+$");
  var key = String.fromCharCode(!event.charCode ? event.which : event.charCode);
  if (!regex.test(key)) {
    event.preventDefault();
